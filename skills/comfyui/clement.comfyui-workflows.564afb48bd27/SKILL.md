...
description: "Designs, implements, tests, documents, and operates solutions using Comfyui Workflows, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Comfyui Workflows."
---
...
## Activation
- Use when the user explicitly asks for comfyui workflows.
- Use when a task would materially benefit from the methods, standards, or operating style associated with comfyui workflows.
...
- Primary capability: Comfyui Workflows.
- Primary domain: design media creative.
- Use Comfyui Workflows only after confirming environment and version compatibility.
