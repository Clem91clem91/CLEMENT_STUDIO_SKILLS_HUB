...
description: "Designs, implements, tests, documents, and operates solutions using Github Actions Ci Cd, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Github Actions Ci Cd."
---
...
## Activation
- Use when the user explicitly asks for github actions ci cd.
- Use when a task would materially benefit from the methods, standards, or operating style associated with github actions ci cd.
...
- Primary capability: Github Actions Ci Cd.
- Primary domain: software cloud.
- Use Github Actions Ci Cd only after confirming environment and version compatibility.
