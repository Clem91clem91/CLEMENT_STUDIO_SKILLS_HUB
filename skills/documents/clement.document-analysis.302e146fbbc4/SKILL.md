...
description: "Performs document analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Document Analysis."
---
...
## Activation
- Use when the user explicitly asks for document analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with document analysis.
...
- Primary capability: Document Analysis.
- Primary domain: data analytics.
- Apply document analysis as an explicit repeatable protocol.
