...
description: "Applies document organization to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Document Organization."
---
...
## Activation
- Use when the user explicitly asks for document organization.
- Use when a task would materially benefit from the methods, standards, or operating style associated with document organization.
...
- Primary capability: Document Organization.
- Primary domain: operations management.
- Apply document organization as an explicit repeatable protocol.
