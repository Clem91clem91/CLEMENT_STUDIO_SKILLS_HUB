...
description: "Uses presentation design to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Presentation Design."
---
...
## Activation
- Use when the user explicitly asks for presentation design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with presentation design.
...
- Primary capability: Presentation Design.
- Primary domain: design media creative.
- Apply presentation design as an explicit repeatable protocol.
