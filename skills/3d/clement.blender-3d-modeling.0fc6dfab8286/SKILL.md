...
description: "Designs, implements, tests, documents, and operates solutions using Blender 3d Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Blender 3d Modeling."
---
...
## Activation
- Use when the user explicitly asks for blender 3d modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with blender 3d modeling.
...
- Primary capability: Blender 3d Modeling.
- Primary domain: design media creative.
- Use Blender 3d Modeling only after confirming environment and version compatibility.
