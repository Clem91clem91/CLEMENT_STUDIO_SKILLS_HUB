---
name: civil-3d-modeling
description: "Designs, implements, tests, documents, and operates solutions using Civil 3d Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Civil 3d Modeling."
---
...
## Activation
- Use when the user explicitly asks for civil 3d modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with civil 3d modeling.
...
- Primary capability: Civil 3d Modeling.
- Primary domain: construction engineering.
- Use Civil 3d Modeling only after confirming environment and version compatibility.
