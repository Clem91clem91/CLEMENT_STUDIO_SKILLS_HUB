...
description: "Applies the Database Administrator professional role to plan, execute, review, and deliver reliable data analytics work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Database Administrator."
---
...
## Activation
- Use when the user explicitly asks for database administrator.
- Use when a task would materially benefit from the methods, standards, or operating style associated with database administrator.
...
- Primary capability: Database Administrator.
