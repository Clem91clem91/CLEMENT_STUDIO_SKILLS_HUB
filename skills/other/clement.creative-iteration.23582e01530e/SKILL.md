...
description: "Uses creative iteration to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Creative Iteration."
---
...
## Activation
- Use when the user explicitly asks for creative iteration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with creative iteration.
...
- Primary capability: Creative Iteration.
- Primary domain: design media creative.
- Apply creative iteration as an explicit repeatable protocol.
