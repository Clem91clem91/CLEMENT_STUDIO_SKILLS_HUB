...
description: "Performs cost structure analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Cost Structure Analysis."
---
...
## Activation
- Use when the user explicitly asks for cost structure analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with cost structure analysis.
...
- Primary capability: Cost Structure Analysis.
- Primary domain: finance investment.
- Apply cost structure analysis as an explicit repeatable protocol.
