...
description: "Uses inclusive leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Inclusive Leadership."
---
...
## Activation
- Use when the user explicitly asks for inclusive leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with inclusive leadership.
...
- Primary capability: Inclusive Leadership.
- Primary domain: communication people.
- Apply inclusive leadership as an explicit repeatable protocol.
