...
description: "Applies the Operations Manager professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Operations Manager."
---
...
## Activation
- Use when the user explicitly asks for operations manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with operations manager.
...
- Primary capability: Operations Manager.
