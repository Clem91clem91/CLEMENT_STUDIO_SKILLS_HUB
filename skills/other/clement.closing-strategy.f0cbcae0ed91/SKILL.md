...
description: "Applies closing strategy to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Closing Strategy."
---
...
## Activation
- Use when the user explicitly asks for closing strategy.
- Use when a task would materially benefit from the methods, standards, or operating style associated with closing strategy.
...
- Primary capability: Closing Strategy.
- Primary domain: operations management.
- Apply closing strategy as an explicit repeatable protocol.
