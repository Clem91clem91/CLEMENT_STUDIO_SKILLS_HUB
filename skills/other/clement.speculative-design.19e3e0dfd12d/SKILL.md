...
description: "Uses speculative design to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Speculative Design."
---
...
## Activation
- Use when the user explicitly asks for speculative design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with speculative design.
...
- Primary capability: Speculative Design.
- Primary domain: design media creative.
- Apply speculative design as an explicit repeatable protocol.
