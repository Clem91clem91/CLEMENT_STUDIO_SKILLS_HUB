---
name: ai-researcher
description: "Applies the AI Researcher professional role to plan, execute, review, and deliver reliable artificial intelligence work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving AI Researcher."
---
...
## Activation
- Use when the user explicitly asks for ai researcher.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ai researcher.
...
- Primary capability: AI Researcher.
