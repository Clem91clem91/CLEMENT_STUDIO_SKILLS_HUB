...
description: "Uses team motivation to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Team Motivation."
---
...
## Activation
- Use when the user explicitly asks for team motivation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with team motivation.
...
- Primary capability: Team Motivation.
- Primary domain: communication people.
- Apply team motivation as an explicit repeatable protocol.
