...
description: "Applies the Chief Strategy Officer professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Chief Strategy Officer."
---
...
## Activation
- Use when the user explicitly asks for chief strategy officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with chief strategy officer.
...
- Primary capability: Chief Strategy Officer.
