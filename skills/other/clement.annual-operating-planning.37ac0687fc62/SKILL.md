---
name: annual-operating-planning
description: "Applies annual operating planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Annual Operating Planning."
---
...
## Activation
- Use when the user explicitly asks for annual operating planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with annual operating planning.
...
- Primary capability: Annual Operating Planning.
- Primary domain: operations management.
- Apply annual operating planning as an explicit repeatable protocol.
