...
description: "Uses first principles reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving First Principles Reasoning."
---
...
## Activation
- Use when the user explicitly asks for first principles reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with first principles reasoning.
...
- Primary capability: First Principles Reasoning.
- Primary domain: general.
- Apply first principles reasoning as an explicit repeatable protocol.
