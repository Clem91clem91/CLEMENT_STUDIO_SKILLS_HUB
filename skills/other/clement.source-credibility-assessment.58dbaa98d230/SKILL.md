...
description: "Uses source credibility assessment as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Source Credibility Assessment."
---
...
## Activation
- Use when the user explicitly asks for source credibility assessment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with source credibility assessment.
...
- Primary capability: Source Credibility Assessment.
- Primary domain: general.
- Apply source credibility assessment as an explicit repeatable protocol.
