...
description: "Applies multi issue negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Multi Issue Negotiation."
---
...
## Activation
- Use when the user explicitly asks for multi issue negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with multi issue negotiation.
...
- Primary capability: Multi Issue Negotiation.
- Primary domain: negotiation deals.
- Apply multi issue negotiation as an explicit repeatable protocol.
