...
description: "Uses blue sky thinking to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Blue Sky Thinking."
---
...
## Activation
- Use when the user explicitly asks for blue sky thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with blue sky thinking.
...
- Primary capability: Blue Sky Thinking.
- Primary domain: design media creative.
- Apply blue sky thinking as an explicit repeatable protocol.
