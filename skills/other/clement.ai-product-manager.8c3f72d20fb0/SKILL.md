...
description: "Applies the AI Product Manager professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving AI Product Manager."
---
...
## Activation
- Use when the user explicitly asks for ai product manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ai product manager.
...
- Primary capability: AI Product Manager.
