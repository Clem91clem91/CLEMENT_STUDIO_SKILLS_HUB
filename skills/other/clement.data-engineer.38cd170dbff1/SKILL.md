---
name: data-engineer
description: "Applies the Data Engineer professional role to plan, execute, review, and deliver reliable data analytics work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Data Engineer."
---
...
## Activation
- Use when the user explicitly asks for data engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with data engineer.
...
- Primary capability: Data Engineer.
