---
name: complex-idea-simplification
description: "Uses complex idea simplification to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Complex Idea Simplification."
---
...
## Activation
- Use when the user explicitly asks for complex idea simplification.
- Use when a task would materially benefit from the methods, standards, or operating style associated with complex idea simplification.
...
- Primary capability: Complex Idea Simplification.
- Primary domain: communication people.
- Apply complex idea simplification as an explicit repeatable protocol.
