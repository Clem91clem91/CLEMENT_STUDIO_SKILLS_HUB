...
description: "Applies process standardization to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Process Standardization."
---
...
## Activation
- Use when the user explicitly asks for process standardization.
- Use when a task would materially benefit from the methods, standards, or operating style associated with process standardization.
...
- Primary capability: Process Standardization.
- Primary domain: construction engineering.
- Apply process standardization as an explicit repeatable protocol.
