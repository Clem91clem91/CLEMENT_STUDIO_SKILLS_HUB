...
description: "Applies the Network Engineer professional role to plan, execute, review, and deliver reliable cybersecurity work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Network Engineer."
---
...
## Activation
- Use when the user explicitly asks for network engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with network engineer.
...
- Primary capability: Network Engineer.
