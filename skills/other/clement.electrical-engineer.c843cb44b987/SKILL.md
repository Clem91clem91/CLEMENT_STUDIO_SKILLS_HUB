...
description: "Applies the Electrical Engineer professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Electrical Engineer."
---
...
## Activation
- Use when the user explicitly asks for electrical engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with electrical engineer.
...
- Primary capability: Electrical Engineer.
