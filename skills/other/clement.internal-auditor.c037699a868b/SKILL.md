...
description: "Applies the Internal Auditor professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Internal Auditor."
---
...
## Activation
- Use when the user explicitly asks for internal auditor.
- Use when a task would materially benefit from the methods, standards, or operating style associated with internal auditor.
...
- Primary capability: Internal Auditor.
