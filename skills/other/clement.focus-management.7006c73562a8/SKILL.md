...
description: "Uses focus management as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Focus Management."
---
...
## Activation
- Use when the user explicitly asks for focus management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with focus management.
...
- Primary capability: Focus Management.
- Primary domain: operations management.
- Apply focus management as an explicit repeatable protocol.
