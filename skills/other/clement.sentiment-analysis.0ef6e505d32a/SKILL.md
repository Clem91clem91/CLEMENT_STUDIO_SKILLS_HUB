...
description: "Performs sentiment analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Sentiment Analysis."
---
...
## Activation
- Use when the user explicitly asks for sentiment analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with sentiment analysis.
...
- Primary capability: Sentiment Analysis.
- Primary domain: data analytics.
- Apply sentiment analysis as an explicit repeatable protocol.
