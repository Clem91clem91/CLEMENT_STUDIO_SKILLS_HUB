...
description: "Applies experiment tracking to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Experiment Tracking."
---
...
## Activation
- Use when the user explicitly asks for experiment tracking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with experiment tracking.
...
- Primary capability: Experiment Tracking.
- Primary domain: operations management.
- Apply experiment tracking as an explicit repeatable protocol.
