---
name: experience-design-ideation
description: "Uses experience design ideation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Experience Design Ideation."
---
...
## Activation
- Use when the user explicitly asks for experience design ideation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with experience design ideation.
...
- Primary capability: Experience Design Ideation.
- Primary domain: design media creative.
- Apply experience design ideation as an explicit repeatable protocol.
