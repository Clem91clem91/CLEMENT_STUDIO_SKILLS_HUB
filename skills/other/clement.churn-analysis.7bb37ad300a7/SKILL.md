---
name: churn-analysis
description: "Performs churn analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Churn Analysis."
---
...
## Activation
- Use when the user explicitly asks for churn analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with churn analysis.
...
- Primary capability: Churn Analysis.
- Primary domain: data analytics.
- Apply churn analysis as an explicit repeatable protocol.
