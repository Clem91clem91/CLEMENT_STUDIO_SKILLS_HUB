...
description: "Uses internal communications to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Internal Communications."
---
...
## Activation
- Use when the user explicitly asks for internal communications.
- Use when a task would materially benefit from the methods, standards, or operating style associated with internal communications.
...
- Primary capability: Internal Communications.
- Primary domain: communication people.
- Apply internal communications as an explicit repeatable protocol.
