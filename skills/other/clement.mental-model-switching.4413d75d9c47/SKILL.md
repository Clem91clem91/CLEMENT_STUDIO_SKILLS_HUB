---
name: mental-model-switching
description: "Uses mental model switching as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Mental Model Switching."
---
...
## Activation
- Use when the user explicitly asks for mental model switching.
- Use when a task would materially benefit from the methods, standards, or operating style associated with mental model switching.
...
- Primary capability: Mental Model Switching.
- Primary domain: artificial intelligence.
- Apply mental model switching as an explicit repeatable protocol.
