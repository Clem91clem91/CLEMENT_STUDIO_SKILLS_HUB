---
name: video-producer
description: "Applies the Video Producer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Video Producer."
---
...
## Activation
- Use when the user explicitly asks for video producer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with video producer.
...
- Primary capability: Video Producer.
