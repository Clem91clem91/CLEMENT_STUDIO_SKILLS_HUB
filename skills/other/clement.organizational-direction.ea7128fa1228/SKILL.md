---
name: organizational-direction
description: "Uses organizational direction to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Organizational Direction."
---
...
## Activation
- Use when the user explicitly asks for organizational direction.
- Use when a task would materially benefit from the methods, standards, or operating style associated with organizational direction.
...
- Primary capability: Organizational Direction.
- Primary domain: operations management.
- Apply organizational direction as an explicit repeatable protocol.
