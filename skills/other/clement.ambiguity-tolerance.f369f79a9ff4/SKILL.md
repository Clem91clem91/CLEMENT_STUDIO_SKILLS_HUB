...
description: "Uses ambiguity tolerance as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Ambiguity Tolerance."
---
...
## Activation
- Use when the user explicitly asks for ambiguity tolerance.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ambiguity tolerance.
...
- Primary capability: Ambiguity Tolerance.
- Primary domain: design media creative.
- Apply ambiguity tolerance as an explicit repeatable protocol.
