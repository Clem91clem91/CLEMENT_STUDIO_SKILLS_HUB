...
description: "Applies concession trading to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Concession Trading."
---
...
## Activation
- Use when the user explicitly asks for concession trading.
- Use when a task would materially benefit from the methods, standards, or operating style associated with concession trading.
...
- Primary capability: Concession Trading.
- Primary domain: negotiation deals.
- Apply concession trading as an explicit repeatable protocol.
