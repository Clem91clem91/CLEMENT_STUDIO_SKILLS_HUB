...
description: "Uses optimization reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Optimization Reasoning."
---
...
## Activation
- Use when the user explicitly asks for optimization reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with optimization reasoning.
...
- Primary capability: Optimization Reasoning.
- Primary domain: general.
- Apply optimization reasoning as an explicit repeatable protocol.
