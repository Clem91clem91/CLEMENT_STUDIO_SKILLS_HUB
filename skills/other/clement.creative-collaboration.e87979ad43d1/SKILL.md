...
description: "Uses creative collaboration to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Creative Collaboration."
---
...
## Activation
- Use when the user explicitly asks for creative collaboration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with creative collaboration.
...
- Primary capability: Creative Collaboration.
- Primary domain: design media creative.
- Apply creative collaboration as an explicit repeatable protocol.
