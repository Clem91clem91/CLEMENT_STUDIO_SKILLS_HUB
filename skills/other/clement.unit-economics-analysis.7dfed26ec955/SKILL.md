...
description: "Performs unit economics analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Unit Economics Analysis."
---
...
## Activation
- Use when the user explicitly asks for unit economics analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with unit economics analysis.
...
- Primary capability: Unit Economics Analysis.
- Primary domain: data analytics.
- Apply unit economics analysis as an explicit repeatable protocol.
