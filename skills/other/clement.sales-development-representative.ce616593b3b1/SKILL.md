...
description: "Applies the Sales Development Representative professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Sales Development Representative."
---
...
## Activation
- Use when the user explicitly asks for sales development representative.
- Use when a task would materially benefit from the methods, standards, or operating style associated with sales development representative.
...
- Primary capability: Sales Development Representative.
