---
name: option-value-thinking
description: "Uses option value thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Option Value Thinking."
---
...
## Activation
- Use when the user explicitly asks for option value thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with option value thinking.
...
- Primary capability: Option Value Thinking.
- Primary domain: general.
- Apply option value thinking as an explicit repeatable protocol.
