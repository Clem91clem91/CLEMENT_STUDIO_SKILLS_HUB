...
description: "Uses intercultural communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Intercultural Communication."
---
...
## Activation
- Use when the user explicitly asks for intercultural communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with intercultural communication.
...
- Primary capability: Intercultural Communication.
- Primary domain: communication people.
- Apply intercultural communication as an explicit repeatable protocol.
