...
description: "Uses causal reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Causal Reasoning."
---
...
## Activation
- Use when the user explicitly asks for causal reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with causal reasoning.
...
- Primary capability: Causal Reasoning.
- Primary domain: general.
- Apply causal reasoning as an explicit repeatable protocol.
