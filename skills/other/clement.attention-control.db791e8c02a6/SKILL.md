...
description: "Uses attention control as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Attention Control."
---
...
## Activation
- Use when the user explicitly asks for attention control.
- Use when a task would materially benefit from the methods, standards, or operating style associated with attention control.
...
- Primary capability: Attention Control.
- Primary domain: operations management.
- Apply attention control as an explicit repeatable protocol.
