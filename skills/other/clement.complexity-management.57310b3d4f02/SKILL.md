...
description: "Uses complexity management as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Complexity Management."
---
...
## Activation
- Use when the user explicitly asks for complexity management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with complexity management.
...
- Primary capability: Complexity Management.
- Primary domain: operations management.
- Apply complexity management as an explicit repeatable protocol.
