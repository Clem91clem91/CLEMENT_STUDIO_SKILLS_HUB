...
description: "Applies the Public Relations Specialist professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Public Relations Specialist."
---
...
## Activation
- Use when the user explicitly asks for public relations specialist.
- Use when a task would materially benefit from the methods, standards, or operating style associated with public relations specialist.
...
- Primary capability: Public Relations Specialist.
