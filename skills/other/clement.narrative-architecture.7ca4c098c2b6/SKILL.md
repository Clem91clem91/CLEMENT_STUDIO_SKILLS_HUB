...
description: "Uses narrative architecture to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Narrative Architecture."
---
...
## Activation
- Use when the user explicitly asks for narrative architecture.
- Use when a task would materially benefit from the methods, standards, or operating style associated with narrative architecture.
...
- Primary capability: Narrative Architecture.
- Primary domain: construction engineering.
- Apply narrative architecture as an explicit repeatable protocol.
