...
description: "Applies the Motion Designer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Motion Designer."
---
...
## Activation
- Use when the user explicitly asks for motion designer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with motion designer.
...
- Primary capability: Motion Designer.
