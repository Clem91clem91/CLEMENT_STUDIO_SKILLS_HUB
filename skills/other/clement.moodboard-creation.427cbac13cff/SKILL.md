...
description: "Uses moodboard creation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Moodboard Creation."
---
...
## Activation
- Use when the user explicitly asks for moodboard creation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with moodboard creation.
...
- Primary capability: Moodboard Creation.
- Primary domain: design media creative.
- Apply moodboard creation as an explicit repeatable protocol.
