...
description: "Applies scope change control to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Scope Change Control."
---
...
## Activation
- Use when the user explicitly asks for scope change control.
- Use when a task would materially benefit from the methods, standards, or operating style associated with scope change control.
...
- Primary capability: Scope Change Control.
- Primary domain: operations management.
- Apply scope change control as an explicit repeatable protocol.
