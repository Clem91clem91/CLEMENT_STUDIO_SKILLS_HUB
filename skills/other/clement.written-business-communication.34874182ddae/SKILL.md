---
name: written-business-communication
description: "Uses written business communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Written Business Communication."
---

# Written Business Communication

Create or facilitate communication that is clear, audience-aware, accurate, actionable, and appropriate to the channel.

## Activation
- Use when the user explicitly asks for written business communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with written business communication.
- Use when message effectiveness depends on audience, channel, tone, clarity, or feedback.

## Operating instructions
1. Identify the audience, objective, context, channel, desired action, sensitivities, and constraints.
2. Determine what the audience already knows, needs to know, may misunderstand, and is likely to resist.
3. Structure the message around the main point, essential evidence, implications, and next action.
4. Adapt vocabulary, tone, length, examples, visual structure, and degree of formality.
5. Check factual accuracy, ambiguity, inclusivity, confidentiality, and unintended interpretations.
6. Invite or design the appropriate feedback loop and confirm understanding where needed.
7. Provide a ready-to-use version plus optional short and detailed variants.
8. Measure success using comprehension, action taken, response quality, and relationship impact.

## Skill-specific focus
- Primary capability: Written Business Communication.
- Primary domain: communication people.
- Apply written business communication as an explicit repeatable protocol.
...
- Quality criterion checked: clarity.
- Quality criterion checked: audience fit.
- Quality criterion checked: accuracy.
- Quality criterion checked: actionability.
