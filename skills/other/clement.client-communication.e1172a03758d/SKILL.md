...
description: "Uses client communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Client Communication."
---
...
## Activation
- Use when the user explicitly asks for client communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with client communication.
...
- Primary capability: Client Communication.
- Primary domain: communication people.
- Apply client communication as an explicit repeatable protocol.
