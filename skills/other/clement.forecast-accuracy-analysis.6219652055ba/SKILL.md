...
description: "Performs forecast accuracy analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Forecast Accuracy Analysis."
---
...
## Activation
- Use when the user explicitly asks for forecast accuracy analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with forecast accuracy analysis.
...
- Primary capability: Forecast Accuracy Analysis.
- Primary domain: data analytics.
- Apply forecast accuracy analysis as an explicit repeatable protocol.
