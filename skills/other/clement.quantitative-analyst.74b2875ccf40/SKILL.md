...
description: "Applies the Quantitative Analyst professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Quantitative Analyst."
---
...
## Activation
- Use when the user explicitly asks for quantitative analyst.
- Use when a task would materially benefit from the methods, standards, or operating style associated with quantitative analyst.
...
- Primary capability: Quantitative Analyst.
