...
description: "Applies the Devops Engineer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Devops Engineer."
---
...
## Activation
- Use when the user explicitly asks for devops engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with devops engineer.
...
- Primary capability: Devops Engineer.
