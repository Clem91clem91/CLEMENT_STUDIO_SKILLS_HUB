...
description: "Applies agreement documentation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Agreement Documentation."
---
...
## Activation
- Use when the user explicitly asks for agreement documentation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with agreement documentation.
...
- Primary capability: Agreement Documentation.
- Primary domain: negotiation deals.
- Apply agreement documentation as an explicit repeatable protocol.
