---
name: package-deal-design
description: "Applies package deal design to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Package Deal Design."
---
...
## Activation
- Use when the user explicitly asks for package deal design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with package deal design.
...
- Primary capability: Package Deal Design.
- Primary domain: design media creative.
- Apply package deal design as an explicit repeatable protocol.
