---
name: contingent-agreement-design
description: "Applies contingent agreement design to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Contingent Agreement Design."
---
...
## Activation
- Use when the user explicitly asks for contingent agreement design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with contingent agreement design.
...
- Primary capability: Contingent Agreement Design.
- Primary domain: design media creative.
- Apply contingent agreement design as an explicit repeatable protocol.
