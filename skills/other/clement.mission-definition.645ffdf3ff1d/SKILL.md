...
description: "Uses mission definition to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Mission Definition."
---
...
## Activation
- Use when the user explicitly asks for mission definition.
- Use when a task would materially benefit from the methods, standards, or operating style associated with mission definition.
...
- Primary capability: Mission Definition.
- Primary domain: operations management.
- Apply mission definition as an explicit repeatable protocol.
