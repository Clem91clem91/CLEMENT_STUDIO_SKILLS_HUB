...
description: "Uses case based reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Case Based Reasoning."
---
...
## Activation
- Use when the user explicitly asks for case based reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with case based reasoning.
...
- Primary capability: Case Based Reasoning.
- Primary domain: general.
- Apply case based reasoning as an explicit repeatable protocol.
