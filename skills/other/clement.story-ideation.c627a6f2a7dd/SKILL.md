---
name: story-ideation
description: "Uses story ideation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Story Ideation."
---
...
## Activation
- Use when the user explicitly asks for story ideation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with story ideation.
...
- Primary capability: Story Ideation.
- Primary domain: design media creative.
- Apply story ideation as an explicit repeatable protocol.
