...
description: "Uses product ideation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Product Ideation."
---
...
## Activation
- Use when the user explicitly asks for product ideation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with product ideation.
...
- Primary capability: Product Ideation.
- Primary domain: operations management.
- Apply product ideation as an explicit repeatable protocol.
