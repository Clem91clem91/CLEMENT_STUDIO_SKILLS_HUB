...
description: "Applies procurement negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Procurement Negotiation."
---
...
## Activation
- Use when the user explicitly asks for procurement negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with procurement negotiation.
...
- Primary capability: Procurement Negotiation.
- Primary domain: negotiation deals.
- Apply procurement negotiation as an explicit repeatable protocol.
