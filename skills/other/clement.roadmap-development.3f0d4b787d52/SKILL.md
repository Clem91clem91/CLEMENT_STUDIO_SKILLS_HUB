...
description: "Applies roadmap development to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Roadmap Development."
---
...
## Activation
- Use when the user explicitly asks for roadmap development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with roadmap development.
...
- Primary capability: Roadmap Development.
- Primary domain: operations management.
- Apply roadmap development as an explicit repeatable protocol.
