...
description: "Uses talent identification to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Talent Identification."
---
...
## Activation
- Use when the user explicitly asks for talent identification.
- Use when a task would materially benefit from the methods, standards, or operating style associated with talent identification.
...
- Primary capability: Talent Identification.
- Primary domain: communication people.
- Apply talent identification as an explicit repeatable protocol.
