...
description: "Uses status reporting to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Status Reporting."
---
...
## Activation
- Use when the user explicitly asks for status reporting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with status reporting.
...
- Primary capability: Status Reporting.
- Primary domain: communication people.
- Apply status reporting as an explicit repeatable protocol.
