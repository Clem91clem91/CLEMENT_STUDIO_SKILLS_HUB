...
description: "Uses lateral thinking to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Lateral Thinking."
---
...
## Activation
- Use when the user explicitly asks for lateral thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with lateral thinking.
...
- Primary capability: Lateral Thinking.
- Primary domain: design media creative.
- Apply lateral thinking as an explicit repeatable protocol.
