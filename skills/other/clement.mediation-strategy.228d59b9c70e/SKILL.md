...
description: "Applies mediation strategy to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Mediation Strategy."
---
...
## Activation
- Use when the user explicitly asks for mediation strategy.
- Use when a task would materially benefit from the methods, standards, or operating style associated with mediation strategy.
...
- Primary capability: Mediation Strategy.
- Primary domain: operations management.
- Apply mediation strategy as an explicit repeatable protocol.
