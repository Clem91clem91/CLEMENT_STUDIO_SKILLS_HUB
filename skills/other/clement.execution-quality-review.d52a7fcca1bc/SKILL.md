---
name: execution-quality-review
description: "Applies execution quality review to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Execution Quality Review."
---
...
## Activation
- Use when the user explicitly asks for execution quality review.
- Use when a task would materially benefit from the methods, standards, or operating style associated with execution quality review.
...
- Primary capability: Execution Quality Review.
- Primary domain: operations management.
- Apply execution quality review as an explicit repeatable protocol.
