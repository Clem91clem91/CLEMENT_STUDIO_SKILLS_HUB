---
name: pilot-program-management
description: "Applies pilot program management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Pilot Program Management."
---
...
## Activation
- Use when the user explicitly asks for pilot program management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with pilot program management.
...
- Primary capability: Pilot Program Management.
- Primary domain: operations management.
- Apply pilot program management as an explicit repeatable protocol.
