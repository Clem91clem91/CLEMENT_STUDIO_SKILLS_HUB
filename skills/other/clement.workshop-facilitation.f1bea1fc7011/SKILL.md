...
description: "Uses workshop facilitation to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Workshop Facilitation."
---
...
## Activation
- Use when the user explicitly asks for workshop facilitation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with workshop facilitation.
...
- Primary capability: Workshop Facilitation.
- Primary domain: communication people.
- Apply workshop facilitation as an explicit repeatable protocol.
