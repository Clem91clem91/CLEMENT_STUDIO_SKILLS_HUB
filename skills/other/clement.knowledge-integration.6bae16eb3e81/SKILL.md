...
description: "Uses knowledge integration as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Knowledge Integration."
---
...
## Activation
- Use when the user explicitly asks for knowledge integration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with knowledge integration.
...
- Primary capability: Knowledge Integration.
- Primary domain: general.
- Apply knowledge integration as an explicit repeatable protocol.
