...
description: "Uses concept mapping as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Concept Mapping."
---
...
## Activation
- Use when the user explicitly asks for concept mapping.
- Use when a task would materially benefit from the methods, standards, or operating style associated with concept mapping.
...
- Primary capability: Concept Mapping.
- Primary domain: general.
- Apply concept mapping as an explicit repeatable protocol.
