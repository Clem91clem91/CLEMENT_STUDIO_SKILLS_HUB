---
name: sem-specialist
description: "Applies the SEM Specialist professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving SEM Specialist."
---
...
## Activation
- Use when the user explicitly asks for sem specialist.
- Use when a task would materially benefit from the methods, standards, or operating style associated with sem specialist.
...
- Primary capability: SEM Specialist.
