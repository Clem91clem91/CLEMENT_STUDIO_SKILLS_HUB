---
name: procurement-workflow-management
description: "Applies procurement workflow management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Procurement Workflow Management."
---
...
## Activation
- Use when the user explicitly asks for procurement workflow management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with procurement workflow management.
...
- Primary capability: Procurement Workflow Management.
- Primary domain: operations management.
- Apply procurement workflow management as an explicit repeatable protocol.
