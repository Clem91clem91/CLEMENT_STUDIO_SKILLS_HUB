...
description: "Uses resource stewardship to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Resource Stewardship."
---
...
## Activation
- Use when the user explicitly asks for resource stewardship.
- Use when a task would materially benefit from the methods, standards, or operating style associated with resource stewardship.
...
- Primary capability: Resource Stewardship.
- Primary domain: operations management.
- Apply resource stewardship as an explicit repeatable protocol.
