---
name: stakeholder-mapping-for-negotiation
description: "Applies stakeholder mapping for negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Stakeholder Mapping For Negotiation."
---
...
## Activation
- Use when the user explicitly asks for stakeholder mapping for negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with stakeholder mapping for negotiation.
...
- Primary capability: Stakeholder Mapping For Negotiation.
- Primary domain: negotiation deals.
- Apply stakeholder mapping for negotiation as an explicit repeatable protocol.
...
- $persistent-dealmaker
- $calm-confident-presenter
- $perspective-taking
