...
description: "Applies approval readiness check to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Approval Readiness Check."
---
...
## Activation
- Use when the user explicitly asks for approval readiness check.
- Use when a task would materially benefit from the methods, standards, or operating style associated with approval readiness check.
...
- Primary capability: Approval Readiness Check.
- Primary domain: operations management.
- Apply approval readiness check as an explicit repeatable protocol.
