---
name: llm-engineer
description: "Applies the LLM Engineer professional role to plan, execute, review, and deliver reliable artificial intelligence work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving LLM Engineer."
---
...
## Activation
- Use when the user explicitly asks for llm engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with llm engineer.
...
- Primary capability: LLM Engineer.
