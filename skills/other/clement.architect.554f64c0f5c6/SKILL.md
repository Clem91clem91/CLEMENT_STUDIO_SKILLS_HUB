---
name: architect
description: "Applies the Architect professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Architect."
---
...
## Activation
- Use when the user explicitly asks for architect.
- Use when a task would materially benefit from the methods, standards, or operating style associated with architect.
