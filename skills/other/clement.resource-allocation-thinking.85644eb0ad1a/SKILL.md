---
name: resource-allocation-thinking
description: "Uses resource allocation thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Resource Allocation Thinking."
---
...
## Activation
- Use when the user explicitly asks for resource allocation thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with resource allocation thinking.
...
- Primary capability: Resource Allocation Thinking.
- Primary domain: operations management.
- Apply resource allocation thinking as an explicit repeatable protocol.
