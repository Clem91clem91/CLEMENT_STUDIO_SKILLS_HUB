...
description: "Uses expectation setting to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Expectation Setting."
---
...
## Activation
- Use when the user explicitly asks for expectation setting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with expectation setting.
...
- Primary capability: Expectation Setting.
- Primary domain: communication people.
- Apply expectation setting as an explicit repeatable protocol.
