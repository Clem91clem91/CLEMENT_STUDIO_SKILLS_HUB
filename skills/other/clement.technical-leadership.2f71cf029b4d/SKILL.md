...
description: "Uses technical leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Technical Leadership."
---
...
## Activation
- Use when the user explicitly asks for technical leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with technical leadership.
...
- Primary capability: Technical Leadership.
- Primary domain: communication people.
- Apply technical leadership as an explicit repeatable protocol.
