---
name: active-listening-in-negotiation
description: "Applies active listening in negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Active Listening In Negotiation."
---
...
## Activation
- Use when the user explicitly asks for active listening in negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with active listening in negotiation.
...
- Primary capability: Active Listening In Negotiation.
- Primary domain: communication people.
- Apply active listening in negotiation as an explicit repeatable protocol.
