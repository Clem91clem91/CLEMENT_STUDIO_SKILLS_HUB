...
description: "Uses tradeoff evaluation as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Tradeoff Evaluation."
---
...
## Activation
- Use when the user explicitly asks for tradeoff evaluation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with tradeoff evaluation.
...
- Primary capability: Tradeoff Evaluation.
- Primary domain: finance investment.
- Apply tradeoff evaluation as an explicit repeatable protocol.
