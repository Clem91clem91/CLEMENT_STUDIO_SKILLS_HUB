...
description: "Applies the Prompt Engineer professional role to plan, execute, review, and deliver reliable artificial intelligence work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Prompt Engineer."
---
...
## Activation
- Use when the user explicitly asks for prompt engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with prompt engineer.
...
- Primary capability: Prompt Engineer.
