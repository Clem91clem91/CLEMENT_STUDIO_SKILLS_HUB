...
description: "Applies task prioritization to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Task Prioritization."
---
...
## Activation
- Use when the user explicitly asks for task prioritization.
- Use when a task would materially benefit from the methods, standards, or operating style associated with task prioritization.
...
- Primary capability: Task Prioritization.
- Primary domain: operations management.
- Apply task prioritization as an explicit repeatable protocol.
