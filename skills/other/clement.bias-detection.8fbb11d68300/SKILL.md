---
name: bias-detection
description: "Uses bias detection as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Bias Detection."
---
...
## Activation
- Use when the user explicitly asks for bias detection.
- Use when a task would materially benefit from the methods, standards, or operating style associated with bias detection.
...
- Primary capability: Bias Detection.
- Primary domain: general.
- Apply bias detection as an explicit repeatable protocol.
