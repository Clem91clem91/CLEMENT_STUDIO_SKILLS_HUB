...
description: "Applies service level definition to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Service Level Definition."
---
...
## Activation
- Use when the user explicitly asks for service level definition.
- Use when a task would materially benefit from the methods, standards, or operating style associated with service level definition.
...
- Primary capability: Service Level Definition.
- Primary domain: design media creative.
- Apply service level definition as an explicit repeatable protocol.
