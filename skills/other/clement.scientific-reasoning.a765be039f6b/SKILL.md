...
description: "Uses scientific reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Scientific Reasoning."
---
...
## Activation
- Use when the user explicitly asks for scientific reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with scientific reasoning.
...
- Primary capability: Scientific Reasoning.
- Primary domain: general.
- Apply scientific reasoning as an explicit repeatable protocol.
