...
description: "Applies the Valuation Specialist professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Valuation Specialist."
---
...
## Activation
- Use when the user explicitly asks for valuation specialist.
- Use when a task would materially benefit from the methods, standards, or operating style associated with valuation specialist.
...
- Primary capability: Valuation Specialist.
