...
description: "Applies the Software Architect professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Software Architect."
---
...
## Activation
- Use when the user explicitly asks for software architect.
- Use when a task would materially benefit from the methods, standards, or operating style associated with software architect.
...
- Primary capability: Software Architect.
