---
name: silence-use
description: "Applies silence use to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Silence Use."
---
...
## Activation
- Use when the user explicitly asks for silence use.
- Use when a task would materially benefit from the methods, standards, or operating style associated with silence use.
...
- Primary capability: Silence Use.
- Primary domain: negotiation deals.
- Apply silence use as an explicit repeatable protocol.
