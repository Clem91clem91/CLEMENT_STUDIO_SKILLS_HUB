...
description: "Applies automation opportunity identification to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Automation Opportunity Identification."
---
...
## Activation
- Use when the user explicitly asks for automation opportunity identification.
- Use when a task would materially benefit from the methods, standards, or operating style associated with automation opportunity identification.
...
- Primary capability: Automation Opportunity Identification.
- Primary domain: operations management.
- Apply automation opportunity identification as an explicit repeatable protocol.
