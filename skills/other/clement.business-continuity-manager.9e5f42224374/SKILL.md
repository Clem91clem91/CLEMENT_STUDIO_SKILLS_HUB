...
description: "Applies the Business Continuity Manager professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Business Continuity Manager."
---
...
## Activation
- Use when the user explicitly asks for business continuity manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with business continuity manager.
...
- Primary capability: Business Continuity Manager.
