...
description: "Applies the Quality Manager professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Quality Manager."
---
...
## Activation
- Use when the user explicitly asks for quality manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with quality manager.
...
- Primary capability: Quality Manager.
