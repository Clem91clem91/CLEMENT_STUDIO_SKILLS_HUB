...
description: "Uses board management to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Board Management."
---
...
## Activation
- Use when the user explicitly asks for board management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with board management.
...
- Primary capability: Board Management.
- Primary domain: operations management.
- Apply board management as an explicit repeatable protocol.
