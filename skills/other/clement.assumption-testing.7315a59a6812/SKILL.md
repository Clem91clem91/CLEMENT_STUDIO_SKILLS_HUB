...
description: "Uses assumption testing as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Assumption Testing."
---
...
## Activation
- Use when the user explicitly asks for assumption testing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with assumption testing.
...
- Primary capability: Assumption Testing.
- Primary domain: software cloud.
- Apply assumption testing as an explicit repeatable protocol.
