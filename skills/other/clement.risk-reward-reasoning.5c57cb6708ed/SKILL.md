---
name: risk-reward-reasoning
description: "Uses risk reward reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Risk Reward Reasoning."
---
...
## Activation
- Use when the user explicitly asks for risk reward reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with risk reward reasoning.
...
- Primary capability: Risk Reward Reasoning.
- Primary domain: general.
- Apply risk reward reasoning as an explicit repeatable protocol.
