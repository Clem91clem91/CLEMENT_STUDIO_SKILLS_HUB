---
name: media-interviewing
description: "Uses media interviewing to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Media Interviewing."
---
...
## Activation
- Use when the user explicitly asks for media interviewing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with media interviewing.
...
- Primary capability: Media Interviewing.
- Primary domain: communication people.
- Apply media interviewing as an explicit repeatable protocol.
