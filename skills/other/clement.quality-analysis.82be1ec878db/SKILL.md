...
description: "Performs quality analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Quality Analysis."
---
...
## Activation
- Use when the user explicitly asks for quality analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with quality analysis.
...
- Primary capability: Quality Analysis.
- Primary domain: operations management.
- Apply quality analysis as an explicit repeatable protocol.
