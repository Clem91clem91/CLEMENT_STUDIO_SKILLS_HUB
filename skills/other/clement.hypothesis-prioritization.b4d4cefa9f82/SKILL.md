...
description: "Uses hypothesis prioritization as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Hypothesis Prioritization."
---
...
## Activation
- Use when the user explicitly asks for hypothesis prioritization.
- Use when a task would materially benefit from the methods, standards, or operating style associated with hypothesis prioritization.
...
- Primary capability: Hypothesis Prioritization.
- Primary domain: general.
- Apply hypothesis prioritization as an explicit repeatable protocol.
