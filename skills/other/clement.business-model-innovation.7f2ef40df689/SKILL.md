...
description: "Uses business model innovation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Business Model Innovation."
---
...
## Activation
- Use when the user explicitly asks for business model innovation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with business model innovation.
...
- Primary capability: Business Model Innovation.
- Primary domain: artificial intelligence.
- Apply business model innovation as an explicit repeatable protocol.
