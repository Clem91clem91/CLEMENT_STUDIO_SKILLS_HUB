...
description: "Uses innovation leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Innovation Leadership."
---
...
## Activation
- Use when the user explicitly asks for innovation leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with innovation leadership.
...
- Primary capability: Innovation Leadership.
- Primary domain: operations management.
- Apply innovation leadership as an explicit repeatable protocol.
