...
description: "Applies retrospective facilitation to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Retrospective Facilitation."
---
...
## Activation
- Use when the user explicitly asks for retrospective facilitation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with retrospective facilitation.
...
- Primary capability: Retrospective Facilitation.
- Primary domain: operations management.
- Apply retrospective facilitation as an explicit repeatable protocol.
