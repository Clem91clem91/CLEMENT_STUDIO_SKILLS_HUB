...
description: "Applies the Construction Manager professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Construction Manager."
---
...
## Activation
- Use when the user explicitly asks for construction manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with construction manager.
...
- Primary capability: Construction Manager.
