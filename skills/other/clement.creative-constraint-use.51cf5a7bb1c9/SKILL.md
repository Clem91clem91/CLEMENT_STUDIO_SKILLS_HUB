---
name: creative-constraint-use
description: "Uses creative constraint use to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Creative Constraint Use."
---

# Creative Constraint Use

Generate, develop, select, and refine original ideas that serve a defined objective and constraints.

## Activation
- Use when the user explicitly asks for creative constraint use.
- Use when a task would materially benefit from the methods, standards, or operating style associated with creative constraint use.
...
- Primary capability: Creative Constraint Use.
- Primary domain: design media creative.
- Apply creative constraint use as an explicit repeatable protocol.
