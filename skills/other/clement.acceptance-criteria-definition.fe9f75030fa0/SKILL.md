...
description: "Applies acceptance criteria definition to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Acceptance Criteria Definition."
---
...
## Activation
- Use when the user explicitly asks for acceptance criteria definition.
- Use when a task would materially benefit from the methods, standards, or operating style associated with acceptance criteria definition.
...
- Primary capability: Acceptance Criteria Definition.
- Primary domain: operations management.
- Apply acceptance criteria definition as an explicit repeatable protocol.
