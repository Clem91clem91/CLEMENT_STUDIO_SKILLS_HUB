...
description: "Uses process innovation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Process Innovation."
---
...
## Activation
- Use when the user explicitly asks for process innovation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with process innovation.
...
- Primary capability: Process Innovation.
- Primary domain: operations management.
- Apply process innovation as an explicit repeatable protocol.
