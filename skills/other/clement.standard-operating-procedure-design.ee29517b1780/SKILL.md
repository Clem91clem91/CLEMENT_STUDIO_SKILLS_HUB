---
name: standard-operating-procedure-design
description: "Applies standard operating procedure design to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Standard Operating Procedure Design."
---
...
## Activation
- Use when the user explicitly asks for standard operating procedure design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with standard operating procedure design.
...
- Primary capability: Standard Operating Procedure Design.
- Primary domain: design media creative.
- Apply standard operating procedure design as an explicit repeatable protocol.
