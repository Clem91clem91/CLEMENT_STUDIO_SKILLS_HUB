...
description: "Uses adaptive decision making as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Adaptive Decision Making."
---
...
## Activation
- Use when the user explicitly asks for adaptive decision making.
- Use when a task would materially benefit from the methods, standards, or operating style associated with adaptive decision making.
...
- Primary capability: Adaptive Decision Making.
- Primary domain: general.
- Apply adaptive decision making as an explicit repeatable protocol.
