...
description: "Applies commercial negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Commercial Negotiation."
---
...
## Activation
- Use when the user explicitly asks for commercial negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with commercial negotiation.
...
- Primary capability: Commercial Negotiation.
- Primary domain: negotiation deals.
- Apply commercial negotiation as an explicit repeatable protocol.
