...
description: "Uses visual ideation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Visual Ideation."
---
...
## Activation
- Use when the user explicitly asks for visual ideation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with visual ideation.
...
- Primary capability: Visual Ideation.
- Primary domain: design media creative.
- Apply visual ideation as an explicit repeatable protocol.
