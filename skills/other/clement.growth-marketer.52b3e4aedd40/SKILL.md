...
description: "Applies the Growth Marketer professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Growth Marketer."
---
...
## Activation
- Use when the user explicitly asks for growth marketer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with growth marketer.
...
- Primary capability: Growth Marketer.
