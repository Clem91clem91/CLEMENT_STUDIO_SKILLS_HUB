...
description: "Uses constraint identification as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Constraint Identification."
---
...
## Activation
- Use when the user explicitly asks for constraint identification.
- Use when a task would materially benefit from the methods, standards, or operating style associated with constraint identification.
...
- Primary capability: Constraint Identification.
- Primary domain: artificial intelligence.
- Apply constraint identification as an explicit repeatable protocol.
