---
name: meeting-minutes-management
description: "Applies meeting minutes management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Meeting Minutes Management."
---
...
## Activation
- Use when the user explicitly asks for meeting minutes management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with meeting minutes management.
...
- Primary capability: Meeting Minutes Management.
- Primary domain: operations management.
- Apply meeting minutes management as an explicit repeatable protocol.
