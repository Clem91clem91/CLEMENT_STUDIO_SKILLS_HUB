...
description: "Uses aesthetic judgment to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Aesthetic Judgment."
---
...
## Activation
- Use when the user explicitly asks for aesthetic judgment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with aesthetic judgment.
...
- Primary capability: Aesthetic Judgment.
- Primary domain: design media creative.
- Apply aesthetic judgment as an explicit repeatable protocol.
