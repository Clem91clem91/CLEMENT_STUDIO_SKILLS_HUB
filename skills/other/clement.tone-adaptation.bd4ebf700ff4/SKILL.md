...
description: "Uses tone adaptation to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Tone Adaptation."
---
...
## Activation
- Use when the user explicitly asks for tone adaptation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with tone adaptation.
...
- Primary capability: Tone Adaptation.
- Primary domain: communication people.
- Apply tone adaptation as an explicit repeatable protocol.
