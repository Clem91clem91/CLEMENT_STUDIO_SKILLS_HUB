---
name: idea-selection
description: "Uses idea selection to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Idea Selection."
---
...
## Activation
- Use when the user explicitly asks for idea selection.
- Use when a task would materially benefit from the methods, standards, or operating style associated with idea selection.
...
- Primary capability: Idea Selection.
- Primary domain: design media creative.
- Apply idea selection as an explicit repeatable protocol.
