---
name: order-fulfillment-coordination
description: "Applies order fulfillment coordination to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Order Fulfillment Coordination."
---
...
## Activation
- Use when the user explicitly asks for order fulfillment coordination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with order fulfillment coordination.
...
- Primary capability: Order Fulfillment Coordination.
- Primary domain: operations management.
- Apply order fulfillment coordination as an explicit repeatable protocol.
