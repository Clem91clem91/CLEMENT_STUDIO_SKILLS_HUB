...
description: "Uses change communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Change Communication."
---
...
## Activation
- Use when the user explicitly asks for change communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with change communication.
...
- Primary capability: Change Communication.
- Primary domain: operations management.
- Apply change communication as an explicit repeatable protocol.
