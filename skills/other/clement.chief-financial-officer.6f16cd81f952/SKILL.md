...
description: "Applies the Chief Financial Officer professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Chief Financial Officer."
---
...
## Activation
- Use when the user explicitly asks for chief financial officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with chief financial officer.
...
- Primary capability: Chief Financial Officer.
