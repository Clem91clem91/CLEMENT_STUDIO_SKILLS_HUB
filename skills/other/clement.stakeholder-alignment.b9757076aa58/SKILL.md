...
description: "Uses stakeholder alignment to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Stakeholder Alignment."
---
...
## Activation
- Use when the user explicitly asks for stakeholder alignment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with stakeholder alignment.
...
- Primary capability: Stakeholder Alignment.
- Primary domain: operations management.
- Apply stakeholder alignment as an explicit repeatable protocol.
