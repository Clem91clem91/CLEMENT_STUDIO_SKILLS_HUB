...
description: "Applies quality control execution to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Quality Control Execution."
---
...
## Activation
- Use when the user explicitly asks for quality control execution.
- Use when a task would materially benefit from the methods, standards, or operating style associated with quality control execution.
...
- Primary capability: Quality Control Execution.
- Primary domain: operations management.
- Apply quality control execution as an explicit repeatable protocol.
