...
description: "Applies the Management Consultant professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Management Consultant."
---
...
## Activation
- Use when the user explicitly asks for management consultant.
- Use when a task would materially benefit from the methods, standards, or operating style associated with management consultant.
...
- Primary capability: Management Consultant.
