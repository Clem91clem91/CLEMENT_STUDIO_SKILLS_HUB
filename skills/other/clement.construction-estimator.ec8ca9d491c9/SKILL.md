...
description: "Applies the Construction Estimator professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Construction Estimator."
---
...
## Activation
- Use when the user explicitly asks for construction estimator.
- Use when a task would materially benefit from the methods, standards, or operating style associated with construction estimator.
...
- Primary capability: Construction Estimator.
