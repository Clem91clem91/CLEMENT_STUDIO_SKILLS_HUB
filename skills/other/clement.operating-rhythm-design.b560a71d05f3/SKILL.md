...
description: "Applies operating rhythm design to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Operating Rhythm Design."
---
...
## Activation
- Use when the user explicitly asks for operating rhythm design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with operating rhythm design.
...
- Primary capability: Operating Rhythm Design.
- Primary domain: design media creative.
- Apply operating rhythm design as an explicit repeatable protocol.
