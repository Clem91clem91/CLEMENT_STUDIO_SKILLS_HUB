...
description: "Applies work elimination to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Work Elimination."
---
...
## Activation
- Use when the user explicitly asks for work elimination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with work elimination.
...
- Primary capability: Work Elimination.
- Primary domain: operations management.
- Apply work elimination as an explicit repeatable protocol.
