...
description: "Applies action item tracking to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Action Item Tracking."
---
...
## Activation
- Use when the user explicitly asks for action item tracking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with action item tracking.
...
- Primary capability: Action Item Tracking.
- Primary domain: operations management.
- Apply action item tracking as an explicit repeatable protocol.
