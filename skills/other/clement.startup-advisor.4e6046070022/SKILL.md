...
description: "Applies the Startup Advisor professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Startup Advisor."
---
...
## Activation
- Use when the user explicitly asks for startup advisor.
- Use when a task would materially benefit from the methods, standards, or operating style associated with startup advisor.
...
- Primary capability: Startup Advisor.
