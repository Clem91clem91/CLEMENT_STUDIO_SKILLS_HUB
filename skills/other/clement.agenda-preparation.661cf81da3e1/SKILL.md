...
description: "Applies agenda preparation to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Agenda Preparation."
---
...
## Activation
- Use when the user explicitly asks for agenda preparation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with agenda preparation.
...
- Primary capability: Agenda Preparation.
- Primary domain: operations management.
- Apply agenda preparation as an explicit repeatable protocol.
