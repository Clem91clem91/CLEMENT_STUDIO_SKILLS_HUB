...
description: "Applies the Financial Controller professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Financial Controller."
---
...
## Activation
- Use when the user explicitly asks for financial controller.
- Use when a task would materially benefit from the methods, standards, or operating style associated with financial controller.
...
- Primary capability: Financial Controller.
