---
name: escalation-path-design
description: "Applies escalation path design to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Escalation Path Design."
---
...
## Activation
- Use when the user explicitly asks for escalation path design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with escalation path design.
...
- Primary capability: Escalation Path Design.
- Primary domain: design media creative.
- Apply escalation path design as an explicit repeatable protocol.
