...
description: "Uses logical reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Logical Reasoning."
---
...
## Activation
- Use when the user explicitly asks for logical reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with logical reasoning.
...
- Primary capability: Logical Reasoning.
- Primary domain: general.
- Apply logical reasoning as an explicit repeatable protocol.
