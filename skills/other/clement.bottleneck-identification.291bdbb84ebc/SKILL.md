...
description: "Uses bottleneck identification as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Bottleneck Identification."
---
...
## Activation
- Use when the user explicitly asks for bottleneck identification.
- Use when a task would materially benefit from the methods, standards, or operating style associated with bottleneck identification.
...
- Primary capability: Bottleneck Identification.
- Primary domain: general.
- Apply bottleneck identification as an explicit repeatable protocol.
