---
name: time-blocking
description: "Applies time blocking to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Time Blocking."
---
...
## Activation
- Use when the user explicitly asks for time blocking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with time blocking.
...
- Primary capability: Time Blocking.
- Primary domain: operations management.
- Apply time blocking as an explicit repeatable protocol.
