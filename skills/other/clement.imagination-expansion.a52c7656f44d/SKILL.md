---
name: imagination-expansion
description: "Uses imagination expansion to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Imagination Expansion."
---
...
## Activation
- Use when the user explicitly asks for imagination expansion.
- Use when a task would materially benefit from the methods, standards, or operating style associated with imagination expansion.
...
- Primary capability: Imagination Expansion.
- Primary domain: design media creative.
- Apply imagination expansion as an explicit repeatable protocol.
