...
description: "Uses signal detection as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Signal Detection."
---
...
## Activation
- Use when the user explicitly asks for signal detection.
- Use when a task would materially benefit from the methods, standards, or operating style associated with signal detection.
...
- Primary capability: Signal Detection.
- Primary domain: general.
- Apply signal detection as an explicit repeatable protocol.
