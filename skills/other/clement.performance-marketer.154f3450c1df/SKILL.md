...
description: "Applies the Performance Marketer professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Performance Marketer."
---
...
## Activation
- Use when the user explicitly asks for performance marketer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with performance marketer.
...
- Primary capability: Performance Marketer.
