---
name: content-concept-creation
description: "Uses content concept creation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Content Concept Creation."
---
...
## Activation
- Use when the user explicitly asks for content concept creation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with content concept creation.
...
- Primary capability: Content Concept Creation.
- Primary domain: sales marketing customer.
- Apply content concept creation as an explicit repeatable protocol.
