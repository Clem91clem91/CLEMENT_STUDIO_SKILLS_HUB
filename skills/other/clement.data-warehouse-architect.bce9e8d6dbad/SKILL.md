...
description: "Applies the Data Warehouse Architect professional role to plan, execute, review, and deliver reliable data analytics work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Data Warehouse Architect."
---
...
## Activation
- Use when the user explicitly asks for data warehouse architect.
- Use when a task would materially benefit from the methods, standards, or operating style associated with data warehouse architect.
...
- Primary capability: Data Warehouse Architect.
