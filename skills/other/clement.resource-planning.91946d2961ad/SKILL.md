...
description: "Applies resource planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Resource Planning."
---
...
## Activation
- Use when the user explicitly asks for resource planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with resource planning.
...
- Primary capability: Resource Planning.
- Primary domain: operations management.
- Apply resource planning as an explicit repeatable protocol.
