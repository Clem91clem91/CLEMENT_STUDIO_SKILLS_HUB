...
description: "Uses convergent thinking to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Convergent Thinking."
---
...
## Activation
- Use when the user explicitly asks for convergent thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with convergent thinking.
...
- Primary capability: Convergent Thinking.
- Primary domain: design media creative.
- Apply convergent thinking as an explicit repeatable protocol.
