...
description: "Applies time estimation to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Time Estimation."
---
...
## Activation
- Use when the user explicitly asks for time estimation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with time estimation.
...
- Primary capability: Time Estimation.
- Primary domain: operations management.
- Apply time estimation as an explicit repeatable protocol.
