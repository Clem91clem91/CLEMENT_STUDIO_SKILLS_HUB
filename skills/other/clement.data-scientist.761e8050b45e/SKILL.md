---
name: data-scientist
description: "Applies the Data Scientist professional role to plan, execute, review, and deliver reliable data analytics work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Data Scientist."
---
...
## Activation
- Use when the user explicitly asks for data scientist.
- Use when a task would materially benefit from the methods, standards, or operating style associated with data scientist.
...
- Primary capability: Data Scientist.
