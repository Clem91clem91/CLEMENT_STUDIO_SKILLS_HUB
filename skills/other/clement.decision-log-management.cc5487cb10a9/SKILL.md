---
name: decision-log-management
description: "Applies decision log management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Decision Log Management."
---
...
## Activation
- Use when the user explicitly asks for decision log management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with decision log management.
...
- Primary capability: Decision Log Management.
- Primary domain: operations management.
- Apply decision log management as an explicit repeatable protocol.
