...
description: "Uses engineering judgment as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Engineering Judgment."
---
...
## Activation
- Use when the user explicitly asks for engineering judgment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with engineering judgment.
...
- Primary capability: Engineering Judgment.
- Primary domain: general.
- Apply engineering judgment as an explicit repeatable protocol.
