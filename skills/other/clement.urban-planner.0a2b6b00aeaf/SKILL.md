---
name: urban-planner
description: "Applies the Urban Planner professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Urban Planner."
---
...
## Activation
- Use when the user explicitly asks for urban planner.
- Use when a task would materially benefit from the methods, standards, or operating style associated with urban planner.
...
- Primary capability: Urban Planner.
