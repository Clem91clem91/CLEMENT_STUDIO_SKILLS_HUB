...
description: "Applies conflict deescalation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Conflict Deescalation."
---
...
## Activation
- Use when the user explicitly asks for conflict deescalation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with conflict deescalation.
...
- Primary capability: Conflict Deescalation.
- Primary domain: communication people.
- Apply conflict deescalation as an explicit repeatable protocol.
