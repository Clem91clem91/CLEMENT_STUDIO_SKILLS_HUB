...
description: "Uses pattern recognition as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Pattern Recognition."
---
...
## Activation
- Use when the user explicitly asks for pattern recognition.
- Use when a task would materially benefit from the methods, standards, or operating style associated with pattern recognition.
...
- Primary capability: Pattern Recognition.
- Primary domain: general.
- Apply pattern recognition as an explicit repeatable protocol.
