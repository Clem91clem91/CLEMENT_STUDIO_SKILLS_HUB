...
description: "Performs market analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Market Analysis."
---
...
## Activation
- Use when the user explicitly asks for market analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with market analysis.
...
- Primary capability: Market Analysis.
- Primary domain: sales marketing customer.
- Apply market analysis as an explicit repeatable protocol.
