...
description: "Uses decision accountability to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Decision Accountability."
---
...
## Activation
- Use when the user explicitly asks for decision accountability.
- Use when a task would materially benefit from the methods, standards, or operating style associated with decision accountability.
...
- Primary capability: Decision Accountability.
- Primary domain: sales marketing customer.
- Apply decision accountability as an explicit repeatable protocol.
