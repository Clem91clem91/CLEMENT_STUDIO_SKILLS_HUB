...
description: "Uses succession planning to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Succession Planning."
---
...
## Activation
- Use when the user explicitly asks for succession planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with succession planning.
...
- Primary capability: Succession Planning.
- Primary domain: operations management.
- Apply succession planning as an explicit repeatable protocol.
