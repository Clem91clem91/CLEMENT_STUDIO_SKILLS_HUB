...
description: "Uses priority setting as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Priority Setting."
---
...
## Activation
- Use when the user explicitly asks for priority setting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with priority setting.
...
- Primary capability: Priority Setting.
- Primary domain: general.
- Apply priority setting as an explicit repeatable protocol.
