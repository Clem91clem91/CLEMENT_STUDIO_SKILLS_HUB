...
description: "Applies knowledge base management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Knowledge Base Management."
---
...
## Activation
- Use when the user explicitly asks for knowledge base management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with knowledge base management.
...
- Primary capability: Knowledge Base Management.
- Primary domain: operations management.
- Apply knowledge base management as an explicit repeatable protocol.
