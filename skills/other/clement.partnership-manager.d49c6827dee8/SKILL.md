...
description: "Applies the Partnership Manager professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Partnership Manager."
---
...
## Activation
- Use when the user explicitly asks for partnership manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with partnership manager.
...
- Primary capability: Partnership Manager.
