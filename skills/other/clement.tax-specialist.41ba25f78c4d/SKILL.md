---
name: tax-specialist
description: "Applies the Tax Specialist professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Tax Specialist."
---
...
## Activation
- Use when the user explicitly asks for tax specialist.
- Use when a task would materially benefit from the methods, standards, or operating style associated with tax specialist.
...
- Primary capability: Tax Specialist.
