...
description: "Performs cohort analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Cohort Analysis."
---
...
## Activation
- Use when the user explicitly asks for cohort analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with cohort analysis.
...
- Primary capability: Cohort Analysis.
- Primary domain: data analytics.
- Apply cohort analysis as an explicit repeatable protocol.
