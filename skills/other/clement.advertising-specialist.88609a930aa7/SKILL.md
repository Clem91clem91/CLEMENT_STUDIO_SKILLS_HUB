...
description: "Applies the Advertising Specialist professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Advertising Specialist."
---
...
## Activation
- Use when the user explicitly asks for advertising specialist.
- Use when a task would materially benefit from the methods, standards, or operating style associated with advertising specialist.
...
- Primary capability: Advertising Specialist.
