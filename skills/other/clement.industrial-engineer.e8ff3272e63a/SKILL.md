...
description: "Applies the Industrial Engineer professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Industrial Engineer."
---
...
## Activation
- Use when the user explicitly asks for industrial engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with industrial engineer.
...
- Primary capability: Industrial Engineer.
