...
description: "Applies the Chief Product Officer professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Chief Product Officer."
---
...
## Activation
- Use when the user explicitly asks for chief product officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with chief product officer.
...
- Primary capability: Chief Product Officer.
