...
description: "Uses financial reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Financial Reasoning."
---
...
## Activation
- Use when the user explicitly asks for financial reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with financial reasoning.
...
- Primary capability: Financial Reasoning.
- Primary domain: finance investment.
- Apply financial reasoning as an explicit repeatable protocol.
