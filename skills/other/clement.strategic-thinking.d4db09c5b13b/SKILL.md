...
description: "Uses strategic thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Strategic Thinking."
---
...
## Activation
- Use when the user explicitly asks for strategic thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with strategic thinking.
...
- Primary capability: Strategic Thinking.
- Primary domain: general.
- Apply strategic thinking as an explicit repeatable protocol.
