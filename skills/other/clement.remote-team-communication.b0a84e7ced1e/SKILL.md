...
description: "Uses remote team communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Remote Team Communication."
---
...
## Activation
- Use when the user explicitly asks for remote team communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with remote team communication.
...
- Primary capability: Remote Team Communication.
- Primary domain: communication people.
- Apply remote team communication as an explicit repeatable protocol.
