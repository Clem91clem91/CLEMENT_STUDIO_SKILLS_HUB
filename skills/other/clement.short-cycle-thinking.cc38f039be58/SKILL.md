---
name: short-cycle-thinking
description: "Uses short cycle thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Short Cycle Thinking."
---
...
## Activation
- Use when the user explicitly asks for short cycle thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with short cycle thinking.
...
- Primary capability: Short Cycle Thinking.
- Primary domain: general.
- Apply short cycle thinking as an explicit repeatable protocol.
