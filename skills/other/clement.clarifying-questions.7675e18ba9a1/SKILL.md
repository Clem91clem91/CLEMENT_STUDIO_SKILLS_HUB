...
description: "Uses clarifying questions to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Clarifying Questions."
---
...
## Activation
- Use when the user explicitly asks for clarifying questions.
- Use when a task would materially benefit from the methods, standards, or operating style associated with clarifying questions.
...
- Primary capability: Clarifying Questions.
- Primary domain: communication people.
- Apply clarifying questions as an explicit repeatable protocol.
