...
description: "Applies monthly business review to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Monthly Business Review."
---
...
## Activation
- Use when the user explicitly asks for monthly business review.
- Use when a task would materially benefit from the methods, standards, or operating style associated with monthly business review.
...
- Primary capability: Monthly Business Review.
- Primary domain: operations management.
- Apply monthly business review as an explicit repeatable protocol.
