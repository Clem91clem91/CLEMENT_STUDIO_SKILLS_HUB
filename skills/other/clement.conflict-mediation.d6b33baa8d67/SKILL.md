...
description: "Uses conflict mediation to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Conflict Mediation."
---
...
## Activation
- Use when the user explicitly asks for conflict mediation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with conflict mediation.
...
- Primary capability: Conflict Mediation.
- Primary domain: communication people.
- Apply conflict mediation as an explicit repeatable protocol.
