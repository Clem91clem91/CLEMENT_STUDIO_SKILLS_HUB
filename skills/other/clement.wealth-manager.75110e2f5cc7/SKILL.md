---
name: wealth-manager
description: "Applies the Wealth Manager professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Wealth Manager."
---
...
## Activation
- Use when the user explicitly asks for wealth manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with wealth manager.
...
- Primary capability: Wealth Manager.
