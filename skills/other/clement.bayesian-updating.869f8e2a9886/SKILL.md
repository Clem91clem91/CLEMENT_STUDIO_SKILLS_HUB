...
description: "Uses bayesian updating as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Bayesian Updating."
---
...
## Activation
- Use when the user explicitly asks for bayesian updating.
- Use when a task would materially benefit from the methods, standards, or operating style associated with bayesian updating.
...
- Primary capability: Bayesian Updating.
- Primary domain: general.
- Apply bayesian updating as an explicit repeatable protocol.
