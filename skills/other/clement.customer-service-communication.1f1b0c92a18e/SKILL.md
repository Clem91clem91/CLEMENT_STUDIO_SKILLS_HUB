...
description: "Uses customer service communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Customer Service Communication."
---
...
## Activation
- Use when the user explicitly asks for customer service communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with customer service communication.
...
- Primary capability: Customer Service Communication.
- Primary domain: sales marketing customer.
- Apply customer service communication as an explicit repeatable protocol.
