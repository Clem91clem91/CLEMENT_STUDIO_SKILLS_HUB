...
description: "Uses concise explanation to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Concise Explanation."
---
...
## Activation
- Use when the user explicitly asks for concise explanation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with concise explanation.
...
- Primary capability: Concise Explanation.
- Primary domain: communication people.
- Apply concise explanation as an explicit repeatable protocol.
