---
name: decision-tree-reasoning
description: "Uses decision tree reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Decision Tree Reasoning."
---
...
## Activation
- Use when the user explicitly asks for decision tree reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with decision tree reasoning.
...
- Primary capability: Decision Tree Reasoning.
- Primary domain: general.
- Apply decision tree reasoning as an explicit repeatable protocol.
