---
name: work-breakdown-structuring
description: "Applies work breakdown structuring to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Work Breakdown Structuring."
---
...
## Activation
- Use when the user explicitly asks for work breakdown structuring.
- Use when a task would materially benefit from the methods, standards, or operating style associated with work breakdown structuring.
...
- Primary capability: Work Breakdown Structuring.
- Primary domain: operations management.
- Apply work breakdown structuring as an explicit repeatable protocol.
