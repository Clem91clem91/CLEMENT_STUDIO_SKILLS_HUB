...
description: "Uses crisis communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Crisis Communication."
---
...
## Activation
- Use when the user explicitly asks for crisis communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with crisis communication.
...
- Primary capability: Crisis Communication.
- Primary domain: communication people.
- Apply crisis communication as an explicit repeatable protocol.
