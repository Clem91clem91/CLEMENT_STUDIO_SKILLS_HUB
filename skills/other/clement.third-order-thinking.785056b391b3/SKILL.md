...
description: "Uses third order thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Third Order Thinking."
---
...
## Activation
- Use when the user explicitly asks for third order thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with third order thinking.
...
- Primary capability: Third Order Thinking.
- Primary domain: general.
- Apply third order thinking as an explicit repeatable protocol.
