---
name: value-claiming-negotiation
description: "Applies value claiming negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Value Claiming Negotiation."
---
...
## Activation
- Use when the user explicitly asks for value claiming negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with value claiming negotiation.
...
- Primary capability: Value Claiming Negotiation.
- Primary domain: negotiation deals.
- Apply value claiming negotiation as an explicit repeatable protocol.
