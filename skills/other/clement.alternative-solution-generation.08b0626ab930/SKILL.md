...
description: "Uses alternative solution generation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Alternative Solution Generation."
---
...
## Activation
- Use when the user explicitly asks for alternative solution generation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with alternative solution generation.
...
- Primary capability: Alternative Solution Generation.
- Primary domain: design media creative.
- Apply alternative solution generation as an explicit repeatable protocol.
