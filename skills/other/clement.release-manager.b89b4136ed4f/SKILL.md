...
description: "Applies the Release Manager professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Release Manager."
---
...
## Activation
- Use when the user explicitly asks for release manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with release manager.
...
- Primary capability: Release Manager.
