...
description: "Uses talent development to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Talent Development."
---
...
## Activation
- Use when the user explicitly asks for talent development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with talent development.
...
- Primary capability: Talent Development.
- Primary domain: communication people.
- Apply talent development as an explicit repeatable protocol.
