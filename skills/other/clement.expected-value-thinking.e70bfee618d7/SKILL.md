...
description: "Uses expected value thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Expected Value Thinking."
---
...
## Activation
- Use when the user explicitly asks for expected value thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with expected value thinking.
...
- Primary capability: Expected Value Thinking.
- Primary domain: general.
- Apply expected value thinking as an explicit repeatable protocol.
