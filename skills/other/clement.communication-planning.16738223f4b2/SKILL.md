...
description: "Uses communication planning to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Communication Planning."
---
...
## Activation
- Use when the user explicitly asks for communication planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with communication planning.
...
- Primary capability: Communication Planning.
- Primary domain: operations management.
- Apply communication planning as an explicit repeatable protocol.
