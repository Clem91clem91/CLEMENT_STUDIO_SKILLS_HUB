...
description: "Applies negotiation preparation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Negotiation Preparation."
---
...
## Activation
- Use when the user explicitly asks for negotiation preparation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with negotiation preparation.
...
- Primary capability: Negotiation Preparation.
- Primary domain: negotiation deals.
- Apply negotiation preparation as an explicit repeatable protocol.
