---
name: brand-designer
description: "Applies the Brand Designer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Brand Designer."
---
...
## Activation
- Use when the user explicitly asks for brand designer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with brand designer.
...
- Primary capability: Brand Designer.
