---
name: risk-analyst
description: "Applies the Risk Analyst professional role to plan, execute, review, and deliver reliable data analytics work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Risk Analyst."
---
...
## Activation
- Use when the user explicitly asks for risk analyst.
- Use when a task would materially benefit from the methods, standards, or operating style associated with risk analyst.
...
- Primary capability: Risk Analyst.
