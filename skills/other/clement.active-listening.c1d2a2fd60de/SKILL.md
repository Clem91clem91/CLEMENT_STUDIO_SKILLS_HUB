...
description: "Uses active listening to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Active Listening."
---
...
## Activation
- Use when the user explicitly asks for active listening.
- Use when a task would materially benefit from the methods, standards, or operating style associated with active listening.
...
- Primary capability: Active Listening.
- Primary domain: communication people.
- Apply active listening as an explicit repeatable protocol.
