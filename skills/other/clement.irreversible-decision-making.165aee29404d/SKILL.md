---
name: irreversible-decision-making
description: "Uses irreversible decision making as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Irreversible Decision Making."
---
...
## Activation
- Use when the user explicitly asks for irreversible decision making.
- Use when a task would materially benefit from the methods, standards, or operating style associated with irreversible decision making.
...
- Primary capability: Irreversible Decision Making.
- Primary domain: general.
- Apply irreversible decision making as an explicit repeatable protocol.
