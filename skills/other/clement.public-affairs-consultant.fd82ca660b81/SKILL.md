...
description: "Applies the Public Affairs Consultant professional role to plan, execute, review, and deliver reliable legal compliance work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Public Affairs Consultant."
---
...
## Activation
- Use when the user explicitly asks for public affairs consultant.
- Use when a task would materially benefit from the methods, standards, or operating style associated with public affairs consultant.
...
- Primary capability: Public Affairs Consultant.
