...
description: "Uses community engagement to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Community Engagement."
---
...
## Activation
- Use when the user explicitly asks for community engagement.
- Use when a task would materially benefit from the methods, standards, or operating style associated with community engagement.
...
- Primary capability: Community Engagement.
- Primary domain: sales marketing customer.
- Apply community engagement as an explicit repeatable protocol.
