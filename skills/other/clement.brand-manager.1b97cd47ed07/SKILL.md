---
name: brand-manager
description: "Applies the Brand Manager professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Brand Manager."
---
...
## Activation
- Use when the user explicitly asks for brand manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with brand manager.
...
- Primary capability: Brand Manager.
