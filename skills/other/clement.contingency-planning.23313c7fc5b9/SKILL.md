...
description: "Applies contingency planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Contingency Planning."
---
...
## Activation
- Use when the user explicitly asks for contingency planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with contingency planning.
...
- Primary capability: Contingency Planning.
- Primary domain: operations management.
- Apply contingency planning as an explicit repeatable protocol.
