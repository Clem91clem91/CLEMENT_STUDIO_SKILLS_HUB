...
description: "Uses constraint driven design to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Constraint Driven Design."
---
...
## Activation
- Use when the user explicitly asks for constraint driven design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with constraint driven design.
...
- Primary capability: Constraint Driven Design.
- Primary domain: design media creative.
- Apply constraint driven design as an explicit repeatable protocol.
