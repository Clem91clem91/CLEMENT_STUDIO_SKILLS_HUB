...
description: "Applies client negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Client Negotiation."
---
...
## Activation
- Use when the user explicitly asks for client negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with client negotiation.
...
- Primary capability: Client Negotiation.
- Primary domain: negotiation deals.
- Apply client negotiation as an explicit repeatable protocol.
