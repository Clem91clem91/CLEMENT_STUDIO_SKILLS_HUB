...
description: "Uses creative risk taking to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Creative Risk Taking."
---
...
## Activation
- Use when the user explicitly asks for creative risk taking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with creative risk taking.
...
- Primary capability: Creative Risk Taking.
- Primary domain: design media creative.
- Apply creative risk taking as an explicit repeatable protocol.
