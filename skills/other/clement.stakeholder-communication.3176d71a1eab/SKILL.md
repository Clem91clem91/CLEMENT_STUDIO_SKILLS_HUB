...
description: "Uses stakeholder communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Stakeholder Communication."
---
...
## Activation
- Use when the user explicitly asks for stakeholder communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with stakeholder communication.
...
- Primary capability: Stakeholder Communication.
- Primary domain: communication people.
- Apply stakeholder communication as an explicit repeatable protocol.
