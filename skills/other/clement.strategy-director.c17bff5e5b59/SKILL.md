...
description: "Applies the Strategy Director professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Strategy Director."
---
...
## Activation
- Use when the user explicitly asks for strategy director.
- Use when a task would materially benefit from the methods, standards, or operating style associated with strategy director.
...
- Primary capability: Strategy Director.
