...
description: "Uses legacy building to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Legacy Building."
---
...
## Activation
- Use when the user explicitly asks for legacy building.
- Use when a task would materially benefit from the methods, standards, or operating style associated with legacy building.
...
- Primary capability: Legacy Building.
- Primary domain: design media creative.
- Apply legacy building as an explicit repeatable protocol.
