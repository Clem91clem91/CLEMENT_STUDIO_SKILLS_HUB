...
description: "Uses mental model selection as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Mental Model Selection."
---
...
## Activation
- Use when the user explicitly asks for mental model selection.
- Use when a task would materially benefit from the methods, standards, or operating style associated with mental model selection.
...
- Primary capability: Mental Model Selection.
- Primary domain: artificial intelligence.
- Apply mental model selection as an explicit repeatable protocol.
