...
description: "Uses public speaking to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Public Speaking."
---
...
## Activation
- Use when the user explicitly asks for public speaking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with public speaking.
...
- Primary capability: Public Speaking.
- Primary domain: communication people.
- Apply public speaking as an explicit repeatable protocol.
