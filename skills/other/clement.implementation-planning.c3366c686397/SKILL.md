...
description: "Applies implementation planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Implementation Planning."
---
...
## Activation
- Use when the user explicitly asks for implementation planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with implementation planning.
...
- Primary capability: Implementation Planning.
- Primary domain: operations management.
- Apply implementation planning as an explicit repeatable protocol.
