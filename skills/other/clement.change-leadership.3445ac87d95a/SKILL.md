...
description: "Uses change leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Change Leadership."
---
...
## Activation
- Use when the user explicitly asks for change leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with change leadership.
...
- Primary capability: Change Leadership.
- Primary domain: operations management.
- Apply change leadership as an explicit repeatable protocol.
