...
description: "Applies the General Manager professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving General Manager."
---
...
## Activation
- Use when the user explicitly asks for general manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with general manager.
...
- Primary capability: General Manager.
