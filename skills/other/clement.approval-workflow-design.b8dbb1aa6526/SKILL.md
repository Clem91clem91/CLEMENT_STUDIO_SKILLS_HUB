...
description: "Applies approval workflow design to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Approval Workflow Design."
---
...
## Activation
- Use when the user explicitly asks for approval workflow design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with approval workflow design.
...
- Primary capability: Approval Workflow Design.
- Primary domain: design media creative.
- Apply approval workflow design as an explicit repeatable protocol.
