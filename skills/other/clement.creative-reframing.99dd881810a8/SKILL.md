...
description: "Uses creative reframing to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Creative Reframing."
---
...
## Activation
- Use when the user explicitly asks for creative reframing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with creative reframing.
...
- Primary capability: Creative Reframing.
- Primary domain: design media creative.
- Apply creative reframing as an explicit repeatable protocol.
