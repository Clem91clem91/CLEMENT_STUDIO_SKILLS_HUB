...
description: "Applies effort estimation to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Effort Estimation."
---
...
## Activation
- Use when the user explicitly asks for effort estimation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with effort estimation.
...
- Primary capability: Effort Estimation.
- Primary domain: operations management.
- Apply effort estimation as an explicit repeatable protocol.
