...
description: "Performs sensitivity analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Sensitivity Analysis."
---
...
## Activation
- Use when the user explicitly asks for sensitivity analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with sensitivity analysis.
...
- Primary capability: Sensitivity Analysis.
- Primary domain: data analytics.
- Apply sensitivity analysis as an explicit repeatable protocol.
