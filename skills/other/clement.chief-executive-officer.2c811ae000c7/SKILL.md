...
description: "Applies the Chief Executive Officer professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Chief Executive Officer."
---
...
## Activation
- Use when the user explicitly asks for chief executive officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with chief executive officer.
...
- Primary capability: Chief Executive Officer.
