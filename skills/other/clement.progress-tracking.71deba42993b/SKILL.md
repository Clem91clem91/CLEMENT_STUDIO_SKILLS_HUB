...
description: "Applies progress tracking to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Progress Tracking."
---
...
## Activation
- Use when the user explicitly asks for progress tracking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with progress tracking.
...
- Primary capability: Progress Tracking.
- Primary domain: operations management.
- Apply progress tracking as an explicit repeatable protocol.
