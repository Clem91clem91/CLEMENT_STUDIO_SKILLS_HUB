---
name: satisficing-judgment
description: "Uses satisficing judgment as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Satisficing Judgment."
---

# Satisficing Judgment

Apply a named reasoning method to improve problem definition, evidence use, alternatives, and decision quality.

## Activation
- Use when the user explicitly asks for satisficing judgment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with satisficing judgment.
...
- Primary capability: Satisficing Judgment.
- Primary domain: general.
- Apply satisficing judgment as an explicit repeatable protocol.
