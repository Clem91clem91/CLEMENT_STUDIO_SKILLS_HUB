...
description: "Applies goal definition to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Goal Definition."
---
...
## Activation
- Use when the user explicitly asks for goal definition.
- Use when a task would materially benefit from the methods, standards, or operating style associated with goal definition.
...
- Primary capability: Goal Definition.
- Primary domain: operations management.
- Apply goal definition as an explicit repeatable protocol.
