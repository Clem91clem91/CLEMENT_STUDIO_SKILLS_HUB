...
description: "Uses question formulation as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Question Formulation."
---
...
## Activation
- Use when the user explicitly asks for question formulation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with question formulation.
...
- Primary capability: Question Formulation.
- Primary domain: general.
- Apply question formulation as an explicit repeatable protocol.
