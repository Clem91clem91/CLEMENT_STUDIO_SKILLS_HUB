---
name: goal-alignment
description: "Uses goal alignment to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Goal Alignment."
---
...
## Activation
- Use when the user explicitly asks for goal alignment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with goal alignment.
...
- Primary capability: Goal Alignment.
- Primary domain: operations management.
- Apply goal alignment as an explicit repeatable protocol.
