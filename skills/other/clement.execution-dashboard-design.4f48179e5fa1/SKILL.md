---
name: execution-dashboard-design
description: "Applies execution dashboard design to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Execution Dashboard Design."
---
...
## Activation
- Use when the user explicitly asks for execution dashboard design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with execution dashboard design.
...
- Primary capability: Execution Dashboard Design.
- Primary domain: design media creative.
- Apply execution dashboard design as an explicit repeatable protocol.
