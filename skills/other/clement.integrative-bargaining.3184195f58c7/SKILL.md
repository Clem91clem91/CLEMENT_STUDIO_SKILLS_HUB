---
name: integrative-bargaining
description: "Applies integrative bargaining to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Integrative Bargaining."
---
...
## Activation
- Use when the user explicitly asks for integrative bargaining.
- Use when a task would materially benefit from the methods, standards, or operating style associated with integrative bargaining.
...
- Primary capability: Integrative Bargaining.
- Primary domain: negotiation deals.
- Apply integrative bargaining as an explicit repeatable protocol.
