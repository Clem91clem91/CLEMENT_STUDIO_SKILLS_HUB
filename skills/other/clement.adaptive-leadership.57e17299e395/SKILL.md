...
description: "Uses adaptive leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Adaptive Leadership."
---
...
## Activation
- Use when the user explicitly asks for adaptive leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with adaptive leadership.
...
- Primary capability: Adaptive Leadership.
- Primary domain: communication people.
- Apply adaptive leadership as an explicit repeatable protocol.
