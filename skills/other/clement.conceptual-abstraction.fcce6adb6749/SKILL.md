...
description: "Uses conceptual abstraction as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Conceptual Abstraction."
---
...
## Activation
- Use when the user explicitly asks for conceptual abstraction.
- Use when a task would materially benefit from the methods, standards, or operating style associated with conceptual abstraction.
...
- Primary capability: Conceptual Abstraction.
- Primary domain: general.
- Apply conceptual abstraction as an explicit repeatable protocol.
