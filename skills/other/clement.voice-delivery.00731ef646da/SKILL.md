---
name: voice-delivery
description: "Uses voice delivery to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Voice Delivery."
---
...
## Activation
- Use when the user explicitly asks for voice delivery.
- Use when a task would materially benefit from the methods, standards, or operating style associated with voice delivery.
...
- Primary capability: Voice Delivery.
- Primary domain: communication people.
- Apply voice delivery as an explicit repeatable protocol.
