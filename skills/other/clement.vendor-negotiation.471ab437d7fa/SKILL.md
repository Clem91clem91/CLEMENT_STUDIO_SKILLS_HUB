...
description: "Applies vendor negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Vendor Negotiation."
---
...
## Activation
- Use when the user explicitly asks for vendor negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with vendor negotiation.
...
- Primary capability: Vendor Negotiation.
- Primary domain: negotiation deals.
- Apply vendor negotiation as an explicit repeatable protocol.
