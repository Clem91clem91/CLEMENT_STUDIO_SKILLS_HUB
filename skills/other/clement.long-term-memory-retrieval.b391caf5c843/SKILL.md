...
description: "Uses long term memory retrieval as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Long Term Memory Retrieval."
---
...
## Activation
- Use when the user explicitly asks for long term memory retrieval.
- Use when a task would materially benefit from the methods, standards, or operating style associated with long term memory retrieval.
...
- Primary capability: Long Term Memory Retrieval.
- Primary domain: general.
- Apply long term memory retrieval as an explicit repeatable protocol.
