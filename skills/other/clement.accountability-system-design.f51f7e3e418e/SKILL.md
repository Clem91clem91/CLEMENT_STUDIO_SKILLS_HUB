...
description: "Uses accountability system design to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Accountability System Design."
---
...
## Activation
- Use when the user explicitly asks for accountability system design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with accountability system design.
...
- Primary capability: Accountability System Design.
- Primary domain: design media creative.
- Apply accountability system design as an explicit repeatable protocol.
