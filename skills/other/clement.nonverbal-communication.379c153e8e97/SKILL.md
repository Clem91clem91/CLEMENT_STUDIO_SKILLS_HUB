...
description: "Uses nonverbal communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Nonverbal Communication."
---
...
## Activation
- Use when the user explicitly asks for nonverbal communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with nonverbal communication.
...
- Primary capability: Nonverbal Communication.
- Primary domain: communication people.
- Apply nonverbal communication as an explicit repeatable protocol.
