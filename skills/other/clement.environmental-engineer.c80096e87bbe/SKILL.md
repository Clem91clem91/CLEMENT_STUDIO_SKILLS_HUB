...
description: "Applies the Environmental Engineer professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Environmental Engineer."
---
...
## Activation
- Use when the user explicitly asks for environmental engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with environmental engineer.
...
- Primary capability: Environmental Engineer.
