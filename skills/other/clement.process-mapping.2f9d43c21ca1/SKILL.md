...
description: "Applies process mapping to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Process Mapping."
---
...
## Activation
- Use when the user explicitly asks for process mapping.
- Use when a task would materially benefit from the methods, standards, or operating style associated with process mapping.
...
- Primary capability: Process Mapping.
- Primary domain: construction engineering.
- Apply process mapping as an explicit repeatable protocol.
