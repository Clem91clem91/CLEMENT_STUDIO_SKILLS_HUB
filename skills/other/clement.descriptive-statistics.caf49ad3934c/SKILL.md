...
description: "Performs descriptive statistics through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Descriptive Statistics."
---
...
## Activation
- Use when the user explicitly asks for descriptive statistics.
- Use when a task would materially benefit from the methods, standards, or operating style associated with descriptive statistics.
...
- Primary capability: Descriptive Statistics.
- Primary domain: data analytics.
- Apply descriptive statistics as an explicit repeatable protocol.
