...
description: "Uses leadership decision review to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Leadership Decision Review."
---
...
## Activation
- Use when the user explicitly asks for leadership decision review.
- Use when a task would materially benefit from the methods, standards, or operating style associated with leadership decision review.
...
- Primary capability: Leadership Decision Review.
- Primary domain: communication people.
- Apply leadership decision review as an explicit repeatable protocol.
