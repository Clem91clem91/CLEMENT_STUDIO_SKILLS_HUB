...
description: "Applies partnership negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Partnership Negotiation."
---
...
## Activation
- Use when the user explicitly asks for partnership negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with partnership negotiation.
...
- Primary capability: Partnership Negotiation.
- Primary domain: sales marketing customer.
- Apply partnership negotiation as an explicit repeatable protocol.
