...
description: "Applies the Mining Engineer professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Mining Engineer."
---
...
## Activation
- Use when the user explicitly asks for mining engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with mining engineer.
...
- Primary capability: Mining Engineer.
