...
description: "Uses visual storyboarding to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Visual Storyboarding."
---
...
## Activation
- Use when the user explicitly asks for visual storyboarding.
- Use when a task would materially benefit from the methods, standards, or operating style associated with visual storyboarding.
...
- Primary capability: Visual Storyboarding.
- Primary domain: design media creative.
- Apply visual storyboarding as an explicit repeatable protocol.
