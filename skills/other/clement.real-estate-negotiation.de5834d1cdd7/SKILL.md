...
description: "Applies real estate negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Real Estate Negotiation."
---
...
## Activation
- Use when the user explicitly asks for real estate negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with real estate negotiation.
...
- Primary capability: Real Estate Negotiation.
- Primary domain: negotiation deals.
- Apply real estate negotiation as an explicit repeatable protocol.
