---
name: sound-designer
description: "Applies the Sound Designer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Sound Designer."
---
...
## Activation
- Use when the user explicitly asks for sound designer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with sound designer.
...
- Primary capability: Sound Designer.
