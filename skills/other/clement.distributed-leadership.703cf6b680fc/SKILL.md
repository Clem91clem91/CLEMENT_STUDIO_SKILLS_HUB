...
description: "Uses distributed leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Distributed Leadership."
---
...
## Activation
- Use when the user explicitly asks for distributed leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with distributed leadership.
...
- Primary capability: Distributed Leadership.
- Primary domain: communication people.
- Apply distributed leadership as an explicit repeatable protocol.
