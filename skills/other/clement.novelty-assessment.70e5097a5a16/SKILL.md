...
description: "Uses novelty assessment to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Novelty Assessment."
---
...
## Activation
- Use when the user explicitly asks for novelty assessment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with novelty assessment.
...
- Primary capability: Novelty Assessment.
- Primary domain: design media creative.
- Apply novelty assessment as an explicit repeatable protocol.
