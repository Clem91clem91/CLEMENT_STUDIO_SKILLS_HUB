...
description: "Applies checklist design to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Checklist Design."
---
...
## Activation
- Use when the user explicitly asks for checklist design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with checklist design.
...
- Primary capability: Checklist Design.
- Primary domain: design media creative.
- Apply checklist design as an explicit repeatable protocol.
