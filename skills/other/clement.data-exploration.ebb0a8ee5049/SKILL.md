...
description: "Performs data exploration through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Data Exploration."
---
...
## Activation
- Use when the user explicitly asks for data exploration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with data exploration.
...
- Primary capability: Data Exploration.
- Primary domain: data analytics.
- Apply data exploration as an explicit repeatable protocol.
