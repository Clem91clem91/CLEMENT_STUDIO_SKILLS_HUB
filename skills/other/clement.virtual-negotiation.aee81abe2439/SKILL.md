---
name: virtual-negotiation
description: "Applies virtual negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Virtual Negotiation."
---
...
## Activation
- Use when the user explicitly asks for virtual negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with virtual negotiation.
...
- Primary capability: Virtual Negotiation.
- Primary domain: negotiation deals.
- Apply virtual negotiation as an explicit repeatable protocol.
