...
description: "Applies the Claims Adjuster professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Claims Adjuster."
---
...
## Activation
- Use when the user explicitly asks for claims adjuster.
- Use when a task would materially benefit from the methods, standards, or operating style associated with claims adjuster.
...
- Primary capability: Claims Adjuster.
