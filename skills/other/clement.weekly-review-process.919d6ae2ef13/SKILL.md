...
description: "Applies weekly review process to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Weekly Review Process."
---
...
## Activation
- Use when the user explicitly asks for weekly review process.
- Use when a task would materially benefit from the methods, standards, or operating style associated with weekly review process.
...
- Primary capability: Weekly Review Process.
- Primary domain: construction engineering.
- Apply weekly review process as an explicit repeatable protocol.
