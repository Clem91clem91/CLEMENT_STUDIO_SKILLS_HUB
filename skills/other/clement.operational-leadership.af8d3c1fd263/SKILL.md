...
description: "Uses operational leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Operational Leadership."
---
...
## Activation
- Use when the user explicitly asks for operational leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with operational leadership.
...
- Primary capability: Operational Leadership.
- Primary domain: communication people.
- Apply operational leadership as an explicit repeatable protocol.
