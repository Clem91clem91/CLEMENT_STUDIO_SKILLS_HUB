...
description: "Uses cognitive flexibility as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Cognitive Flexibility."
---
...
## Activation
- Use when the user explicitly asks for cognitive flexibility.
- Use when a task would materially benefit from the methods, standards, or operating style associated with cognitive flexibility.
...
- Primary capability: Cognitive Flexibility.
- Primary domain: general.
- Apply cognitive flexibility as an explicit repeatable protocol.
