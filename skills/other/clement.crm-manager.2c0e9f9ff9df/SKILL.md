---
name: crm-manager
description: "Applies the CRM Manager professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving CRM Manager."
---
...
## Activation
- Use when the user explicitly asks for crm manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with crm manager.
...
- Primary capability: CRM Manager.
