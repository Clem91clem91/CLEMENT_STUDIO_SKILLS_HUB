...
description: "Uses deductive reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Deductive Reasoning."
---
...
## Activation
- Use when the user explicitly asks for deductive reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with deductive reasoning.
...
- Primary capability: Deductive Reasoning.
- Primary domain: general.
- Apply deductive reasoning as an explicit repeatable protocol.
