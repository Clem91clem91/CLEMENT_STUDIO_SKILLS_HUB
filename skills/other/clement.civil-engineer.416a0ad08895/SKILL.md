---
name: civil-engineer
description: "Applies the Civil Engineer professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Civil Engineer."
---
...
## Activation
- Use when the user explicitly asks for civil engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with civil engineer.
...
- Primary capability: Civil Engineer.
