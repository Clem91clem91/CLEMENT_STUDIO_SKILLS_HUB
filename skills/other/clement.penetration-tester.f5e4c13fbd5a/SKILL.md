...
description: "Applies the Penetration Tester professional role to plan, execute, review, and deliver reliable cybersecurity work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Penetration Tester."
---
...
## Activation
- Use when the user explicitly asks for penetration tester.
- Use when a task would materially benefit from the methods, standards, or operating style associated with penetration tester.
...
- Primary capability: Penetration Tester.
