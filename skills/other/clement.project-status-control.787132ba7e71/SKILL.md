...
description: "Applies project status control to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Project Status Control."
---
...
## Activation
- Use when the user explicitly asks for project status control.
- Use when a task would materially benefit from the methods, standards, or operating style associated with project status control.
...
- Primary capability: Project Status Control.
- Primary domain: operations management.
- Apply project status control as an explicit repeatable protocol.
