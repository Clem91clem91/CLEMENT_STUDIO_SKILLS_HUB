...
description: "Uses organizational influence to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Organizational Influence."
---
...
## Activation
- Use when the user explicitly asks for organizational influence.
- Use when a task would materially benefit from the methods, standards, or operating style associated with organizational influence.
...
- Primary capability: Organizational Influence.
- Primary domain: operations management.
- Apply organizational influence as an explicit repeatable protocol.
