---
name: credit-analyst
description: "Applies the Credit Analyst professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Credit Analyst."
---
...
## Activation
- Use when the user explicitly asks for credit analyst.
- Use when a task would materially benefit from the methods, standards, or operating style associated with credit analyst.
...
- Primary capability: Credit Analyst.
