---
name: editor
description: "Applies the Editor professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Editor."
---
...
## Activation
- Use when the user explicitly asks for editor.
- Use when a task would materially benefit from the methods, standards, or operating style associated with editor.
