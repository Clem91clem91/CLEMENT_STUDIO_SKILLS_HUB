---
name: future-scenario-imagination
description: "Uses future scenario imagination to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Future Scenario Imagination."
---

# Future Scenario Imagination

Generate, develop, select, and refine original ideas that serve a defined objective and constraints.

## Activation
- Use when the user explicitly asks for future scenario imagination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with future scenario imagination.
...
- Primary capability: Future Scenario Imagination.
- Primary domain: design media creative.
- Apply future scenario imagination as an explicit repeatable protocol.
