...
description: "Applies the Business Consultant professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Business Consultant."
---
...
## Activation
- Use when the user explicitly asks for business consultant.
- Use when a task would materially benefit from the methods, standards, or operating style associated with business consultant.
...
- Primary capability: Business Consultant.
