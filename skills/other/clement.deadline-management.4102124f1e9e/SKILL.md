...
description: "Applies deadline management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Deadline Management."
---
...
## Activation
- Use when the user explicitly asks for deadline management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with deadline management.
...
- Primary capability: Deadline Management.
- Primary domain: operations management.
- Apply deadline management as an explicit repeatable protocol.
