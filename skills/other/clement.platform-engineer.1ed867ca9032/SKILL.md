...
description: "Applies the Platform Engineer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Platform Engineer."
---
...
## Activation
- Use when the user explicitly asks for platform engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with platform engineer.
...
- Primary capability: Platform Engineer.
