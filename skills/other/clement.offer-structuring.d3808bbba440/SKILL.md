---
name: offer-structuring
description: "Applies offer structuring to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Offer Structuring."
---
...
## Activation
- Use when the user explicitly asks for offer structuring.
- Use when a task would materially benefit from the methods, standards, or operating style associated with offer structuring.
...
- Primary capability: Offer Structuring.
- Primary domain: negotiation deals.
- Apply offer structuring as an explicit repeatable protocol.
