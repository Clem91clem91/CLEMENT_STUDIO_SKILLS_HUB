---
name: icon-designer
description: "Applies the Icon Designer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Icon Designer."
---
...
## Activation
- Use when the user explicitly asks for icon designer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with icon designer.
...
- Primary capability: Icon Designer.
