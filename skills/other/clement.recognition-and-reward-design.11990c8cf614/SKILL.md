---
name: recognition-and-reward-design
description: "Uses recognition and reward design to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Recognition And Reward Design."
---
...
## Activation
- Use when the user explicitly asks for recognition and reward design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with recognition and reward design.
...
- Primary capability: Recognition And Reward Design.
- Primary domain: design media creative.
- Apply recognition and reward design as an explicit repeatable protocol.
