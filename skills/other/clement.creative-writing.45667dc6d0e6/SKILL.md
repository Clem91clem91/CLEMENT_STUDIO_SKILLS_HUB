...
description: "Uses creative writing to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Creative Writing."
---
...
## Activation
- Use when the user explicitly asks for creative writing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with creative writing.
...
- Primary capability: Creative Writing.
- Primary domain: design media creative.
- Apply creative writing as an explicit repeatable protocol.
