...
description: "Applies inventory control to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Inventory Control."
---
...
## Activation
- Use when the user explicitly asks for inventory control.
- Use when a task would materially benefit from the methods, standards, or operating style associated with inventory control.
...
- Primary capability: Inventory Control.
- Primary domain: operations management.
- Apply inventory control as an explicit repeatable protocol.
