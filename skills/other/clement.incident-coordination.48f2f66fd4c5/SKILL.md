...
description: "Applies incident coordination to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Incident Coordination."
---
...
## Activation
- Use when the user explicitly asks for incident coordination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with incident coordination.
...
- Primary capability: Incident Coordination.
- Primary domain: operations management.
- Apply incident coordination as an explicit repeatable protocol.
