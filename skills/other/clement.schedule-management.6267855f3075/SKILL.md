...
description: "Applies schedule management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Schedule Management."
---
...
## Activation
- Use when the user explicitly asks for schedule management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with schedule management.
...
- Primary capability: Schedule Management.
- Primary domain: operations management.
- Apply schedule management as an explicit repeatable protocol.
