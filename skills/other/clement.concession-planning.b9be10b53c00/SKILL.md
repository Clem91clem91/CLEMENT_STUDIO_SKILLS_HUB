---
name: concession-planning
description: "Applies concession planning to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Concession Planning."
---
...
## Activation
- Use when the user explicitly asks for concession planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with concession planning.
...
- Primary capability: Concession Planning.
- Primary domain: operations management.
- Apply concession planning as an explicit repeatable protocol.
