...
description: "Applies salary negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Salary Negotiation."
---
...
## Activation
- Use when the user explicitly asks for salary negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with salary negotiation.
...
- Primary capability: Salary Negotiation.
- Primary domain: negotiation deals.
- Apply salary negotiation as an explicit repeatable protocol.
