...
description: "Applies vendor coordination to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Vendor Coordination."
---
...
## Activation
- Use when the user explicitly asks for vendor coordination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with vendor coordination.
...
- Primary capability: Vendor Coordination.
- Primary domain: operations management.
- Apply vendor coordination as an explicit repeatable protocol.
