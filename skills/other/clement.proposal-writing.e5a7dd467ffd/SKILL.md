...
description: "Uses proposal writing to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Proposal Writing."
---
...
## Activation
- Use when the user explicitly asks for proposal writing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with proposal writing.
...
- Primary capability: Proposal Writing.
- Primary domain: communication people.
- Apply proposal writing as an explicit repeatable protocol.
