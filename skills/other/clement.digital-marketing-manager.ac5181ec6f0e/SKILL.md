...
description: "Applies the Digital Marketing Manager professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Digital Marketing Manager."
---
...
## Activation
- Use when the user explicitly asks for digital marketing manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with digital marketing manager.
...
- Primary capability: Digital Marketing Manager.
