---
name: value-creation-negotiation
description: "Applies value creation negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Value Creation Negotiation."
---
...
## Activation
- Use when the user explicitly asks for value creation negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with value creation negotiation.
...
- Primary capability: Value Creation Negotiation.
- Primary domain: negotiation deals.
- Apply value creation negotiation as an explicit repeatable protocol.
