...
description: "Uses argument mapping as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Argument Mapping."
---
...
## Activation
- Use when the user explicitly asks for argument mapping.
- Use when a task would materially benefit from the methods, standards, or operating style associated with argument mapping.
...
- Primary capability: Argument Mapping.
- Primary domain: general.
- Apply argument mapping as an explicit repeatable protocol.
