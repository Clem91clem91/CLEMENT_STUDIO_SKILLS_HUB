...
description: "Applies the Social Media Manager professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Social Media Manager."
---
...
## Activation
- Use when the user explicitly asks for social media manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with social media manager.
...
- Primary capability: Social Media Manager.
