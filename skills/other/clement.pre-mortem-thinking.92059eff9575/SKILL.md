...
description: "Uses pre mortem thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Pre Mortem Thinking."
---
...
## Activation
- Use when the user explicitly asks for pre mortem thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with pre mortem thinking.
...
- Primary capability: Pre Mortem Thinking.
- Primary domain: general.
- Apply pre mortem thinking as an explicit repeatable protocol.
