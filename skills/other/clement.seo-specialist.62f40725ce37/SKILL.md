---
name: seo-specialist
description: "Applies the SEO Specialist professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving SEO Specialist."
---
...
## Activation
- Use when the user explicitly asks for seo specialist.
- Use when a task would materially benefit from the methods, standards, or operating style associated with seo specialist.
...
- Primary capability: SEO Specialist.
