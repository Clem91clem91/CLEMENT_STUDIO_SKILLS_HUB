---
name: trend-reinterpretation
description: "Uses trend reinterpretation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Trend Reinterpretation."
---
...
## Activation
- Use when the user explicitly asks for trend reinterpretation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with trend reinterpretation.
...
- Primary capability: Trend Reinterpretation.
- Primary domain: design media creative.
- Apply trend reinterpretation as an explicit repeatable protocol.
