...
description: "Uses creative problem solving as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Creative Problem Solving."
---
...
## Activation
- Use when the user explicitly asks for creative problem solving.
- Use when a task would materially benefit from the methods, standards, or operating style associated with creative problem solving.
...
- Primary capability: Creative Problem Solving.
- Primary domain: design media creative.
- Apply creative problem solving as an explicit repeatable protocol.
