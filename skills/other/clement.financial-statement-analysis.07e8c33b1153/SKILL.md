...
description: "Performs financial statement analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Financial Statement Analysis."
---
...
## Activation
- Use when the user explicitly asks for financial statement analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with financial statement analysis.
...
- Primary capability: Financial Statement Analysis.
- Primary domain: finance investment.
- Apply financial statement analysis as an explicit repeatable protocol.
