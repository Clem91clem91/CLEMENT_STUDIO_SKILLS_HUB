...
description: "Uses executive presence to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Executive Presence."
---
...
## Activation
- Use when the user explicitly asks for executive presence.
- Use when a task would materially benefit from the methods, standards, or operating style associated with executive presence.
...
- Primary capability: Executive Presence.
- Primary domain: operations management.
- Apply executive presence as an explicit repeatable protocol.
