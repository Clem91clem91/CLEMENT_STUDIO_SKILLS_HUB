---
name: working-memory-management
description: "Uses working memory management as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Working Memory Management."
---
...
## Activation
- Use when the user explicitly asks for working memory management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with working memory management.
...
- Primary capability: Working Memory Management.
- Primary domain: operations management.
- Apply working memory management as an explicit repeatable protocol.
