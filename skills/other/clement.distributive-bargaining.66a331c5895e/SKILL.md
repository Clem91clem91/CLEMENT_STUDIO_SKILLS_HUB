---
name: distributive-bargaining
description: "Applies distributive bargaining to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Distributive Bargaining."
---
...
## Activation
- Use when the user explicitly asks for distributive bargaining.
- Use when a task would materially benefit from the methods, standards, or operating style associated with distributive bargaining.
...
- Primary capability: Distributive Bargaining.
- Primary domain: negotiation deals.
- Apply distributive bargaining as an explicit repeatable protocol.
