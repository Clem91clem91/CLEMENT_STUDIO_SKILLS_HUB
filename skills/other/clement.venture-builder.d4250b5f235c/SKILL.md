...
description: "Applies the Venture Builder professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Venture Builder."
---
...
## Activation
- Use when the user explicitly asks for venture builder.
- Use when a task would materially benefit from the methods, standards, or operating style associated with venture builder.
...
- Primary capability: Venture Builder.
