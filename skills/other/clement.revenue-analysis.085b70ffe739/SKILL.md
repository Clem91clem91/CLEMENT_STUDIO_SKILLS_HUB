...
description: "Performs revenue analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Revenue Analysis."
---
...
## Activation
- Use when the user explicitly asks for revenue analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with revenue analysis.
...
- Primary capability: Revenue Analysis.
- Primary domain: finance investment.
- Apply revenue analysis as an explicit repeatable protocol.
