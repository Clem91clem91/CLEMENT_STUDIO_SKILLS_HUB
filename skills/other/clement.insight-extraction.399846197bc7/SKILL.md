...
description: "Uses insight extraction as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Insight Extraction."
---
...
## Activation
- Use when the user explicitly asks for insight extraction.
- Use when a task would materially benefit from the methods, standards, or operating style associated with insight extraction.
...
- Primary capability: Insight Extraction.
- Primary domain: general.
- Apply insight extraction as an explicit repeatable protocol.
