...
description: "Uses cross domain inspiration to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Cross Domain Inspiration."
---
...
## Activation
- Use when the user explicitly asks for cross domain inspiration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with cross domain inspiration.
...
- Primary capability: Cross Domain Inspiration.
- Primary domain: artificial intelligence.
- Apply cross domain inspiration as an explicit repeatable protocol.
