...
description: "Applies the Process Improvement Manager professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Process Improvement Manager."
---
...
## Activation
- Use when the user explicitly asks for process improvement manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with process improvement manager.
...
- Primary capability: Process Improvement Manager.
