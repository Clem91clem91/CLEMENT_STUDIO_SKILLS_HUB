...
description: "Uses remote leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Remote Leadership."
---
...
## Activation
- Use when the user explicitly asks for remote leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with remote leadership.
...
- Primary capability: Remote Leadership.
- Primary domain: communication people.
- Apply remote leadership as an explicit repeatable protocol.
