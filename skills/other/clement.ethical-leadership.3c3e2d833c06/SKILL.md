...
description: "Uses ethical leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Ethical Leadership."
---
...
## Activation
- Use when the user explicitly asks for ethical leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ethical leadership.
...
- Primary capability: Ethical Leadership.
- Primary domain: communication people.
- Apply ethical leadership as an explicit repeatable protocol.
