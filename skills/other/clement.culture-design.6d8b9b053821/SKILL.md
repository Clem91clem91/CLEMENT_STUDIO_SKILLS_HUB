---
name: culture-design
description: "Uses culture design to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Culture Design."
---
...
## Activation
- Use when the user explicitly asks for culture design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with culture design.
...
- Primary capability: Culture Design.
- Primary domain: design media creative.
- Apply culture design as an explicit repeatable protocol.
