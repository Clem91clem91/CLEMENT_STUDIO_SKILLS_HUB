...
description: "Applies term sheet negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Term Sheet Negotiation."
---
...
## Activation
- Use when the user explicitly asks for term sheet negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with term sheet negotiation.
...
- Primary capability: Term Sheet Negotiation.
- Primary domain: negotiation deals.
- Apply term sheet negotiation as an explicit repeatable protocol.
