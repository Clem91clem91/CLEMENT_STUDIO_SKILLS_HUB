...
description: "Uses decision quality review as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Decision Quality Review."
---
...
## Activation
- Use when the user explicitly asks for decision quality review.
- Use when a task would materially benefit from the methods, standards, or operating style associated with decision quality review.
...
- Primary capability: Decision Quality Review.
- Primary domain: operations management.
- Apply decision quality review as an explicit repeatable protocol.
