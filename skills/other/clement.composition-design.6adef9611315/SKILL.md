...
description: "Uses composition design to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Composition Design."
---
...
## Activation
- Use when the user explicitly asks for composition design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with composition design.
...
- Primary capability: Composition Design.
- Primary domain: design media creative.
- Apply composition design as an explicit repeatable protocol.
