...
description: "Uses persuasive messaging to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Persuasive Messaging."
---
...
## Activation
- Use when the user explicitly asks for persuasive messaging.
- Use when a task would materially benefit from the methods, standards, or operating style associated with persuasive messaging.
...
- Primary capability: Persuasive Messaging.
- Primary domain: communication people.
- Apply persuasive messaging as an explicit repeatable protocol.
