...
description: "Uses technical communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Technical Communication."
---
...
## Activation
- Use when the user explicitly asks for technical communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with technical communication.
...
- Primary capability: Technical Communication.
- Primary domain: communication people.
- Apply technical communication as an explicit repeatable protocol.
