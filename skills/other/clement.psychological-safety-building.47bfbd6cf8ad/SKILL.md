---
name: psychological-safety-building
description: "Uses psychological safety building to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Psychological Safety Building."
---
...
## Activation
- Use when the user explicitly asks for psychological safety building.
- Use when a task would materially benefit from the methods, standards, or operating style associated with psychological safety building.
...
- Primary capability: Psychological Safety Building.
- Primary domain: communication people.
- Apply psychological safety building as an explicit repeatable protocol.
