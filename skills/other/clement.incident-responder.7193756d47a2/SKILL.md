...
description: "Applies the Incident Responder professional role to plan, execute, review, and deliver reliable cybersecurity work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Incident Responder."
---
...
## Activation
- Use when the user explicitly asks for incident responder.
- Use when a task would materially benefit from the methods, standards, or operating style associated with incident responder.
...
- Primary capability: Incident Responder.
