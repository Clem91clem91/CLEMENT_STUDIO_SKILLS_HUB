---
name: paralegal
description: "Applies the Paralegal professional role to plan, execute, review, and deliver reliable legal compliance work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Paralegal."
---
...
## Activation
- Use when the user explicitly asks for paralegal.
- Use when a task would materially benefit from the methods, standards, or operating style associated with paralegal.
