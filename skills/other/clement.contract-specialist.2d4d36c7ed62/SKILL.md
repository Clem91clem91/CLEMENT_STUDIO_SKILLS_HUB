...
description: "Applies the Contract Specialist professional role to plan, execute, review, and deliver reliable legal compliance work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Contract Specialist."
---
...
## Activation
- Use when the user explicitly asks for contract specialist.
- Use when a task would materially benefit from the methods, standards, or operating style associated with contract specialist.
...
- Primary capability: Contract Specialist.
