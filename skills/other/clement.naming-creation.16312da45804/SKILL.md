---
name: naming-creation
description: "Uses naming creation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Naming Creation."
---
...
## Activation
- Use when the user explicitly asks for naming creation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with naming creation.
...
- Primary capability: Naming Creation.
- Primary domain: design media creative.
- Apply naming creation as an explicit repeatable protocol.
