...
description: "Applies objection handling to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Objection Handling."
---
...
## Activation
- Use when the user explicitly asks for objection handling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with objection handling.
...
- Primary capability: Objection Handling.
- Primary domain: negotiation deals.
- Apply objection handling as an explicit repeatable protocol.
