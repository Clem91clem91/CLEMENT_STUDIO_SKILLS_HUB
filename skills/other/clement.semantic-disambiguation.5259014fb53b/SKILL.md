...
description: "Uses semantic disambiguation as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Semantic Disambiguation."
---
...
## Activation
- Use when the user explicitly asks for semantic disambiguation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with semantic disambiguation.
...
- Primary capability: Semantic Disambiguation.
- Primary domain: sales marketing customer.
- Apply semantic disambiguation as an explicit repeatable protocol.
