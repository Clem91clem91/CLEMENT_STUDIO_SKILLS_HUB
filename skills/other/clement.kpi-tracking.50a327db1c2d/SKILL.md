---
name: kpi-tracking
description: "Applies kpi tracking to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving KPI Tracking."
---
...
## Activation
- Use when the user explicitly asks for kpi tracking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with kpi tracking.
...
- Primary capability: KPI Tracking.
- Primary domain: operations management.
- Apply kpi tracking as an explicit repeatable protocol.
