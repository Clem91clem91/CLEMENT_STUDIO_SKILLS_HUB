---
name: power-balance-assessment
description: "Applies power balance assessment to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Power Balance Assessment."
---
...
## Activation
- Use when the user explicitly asks for power balance assessment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with power balance assessment.
...
- Primary capability: Power Balance Assessment.
- Primary domain: negotiation deals.
- Apply power balance assessment as an explicit repeatable protocol.
