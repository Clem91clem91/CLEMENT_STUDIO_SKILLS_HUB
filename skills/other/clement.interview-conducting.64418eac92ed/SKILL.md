...
description: "Uses interview conducting to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Interview Conducting."
---
...
## Activation
- Use when the user explicitly asks for interview conducting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with interview conducting.
...
- Primary capability: Interview Conducting.
- Primary domain: communication people.
- Apply interview conducting as an explicit repeatable protocol.
