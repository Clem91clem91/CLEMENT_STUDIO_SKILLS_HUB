...
description: "Applies the Chief Marketing Officer professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Chief Marketing Officer."
---
...
## Activation
- Use when the user explicitly asks for chief marketing officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with chief marketing officer.
...
- Primary capability: Chief Marketing Officer.
