...
description: "Uses counterfactual reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Counterfactual Reasoning."
---
...
## Activation
- Use when the user explicitly asks for counterfactual reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with counterfactual reasoning.
...
- Primary capability: Counterfactual Reasoning.
- Primary domain: general.
- Apply counterfactual reasoning as an explicit repeatable protocol.
