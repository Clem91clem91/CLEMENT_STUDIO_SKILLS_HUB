...
description: "Applies workflow documentation to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Workflow Documentation."
---
...
## Activation
- Use when the user explicitly asks for workflow documentation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with workflow documentation.
...
- Primary capability: Workflow Documentation.
- Primary domain: operations management.
- Apply workflow documentation as an explicit repeatable protocol.
