...
description: "Applies records management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Records Management."
---
...
## Activation
- Use when the user explicitly asks for records management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with records management.
...
- Primary capability: Records Management.
- Primary domain: operations management.
- Apply records management as an explicit repeatable protocol.
