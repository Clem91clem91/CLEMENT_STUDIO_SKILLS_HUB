...
description: "Uses systems thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Systems Thinking."
---
...
## Activation
- Use when the user explicitly asks for systems thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with systems thinking.
...
- Primary capability: Systems Thinking.
- Primary domain: software cloud.
- Apply systems thinking as an explicit repeatable protocol.
