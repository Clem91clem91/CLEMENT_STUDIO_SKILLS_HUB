...
description: "Uses scenario planning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Scenario Planning."
---
...
## Activation
- Use when the user explicitly asks for scenario planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with scenario planning.
...
- Primary capability: Scenario Planning.
- Primary domain: operations management.
- Apply scenario planning as an explicit repeatable protocol.
