...
description: "Uses legal reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Legal Reasoning."
---
...
## Activation
- Use when the user explicitly asks for legal reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with legal reasoning.
...
- Primary capability: Legal Reasoning.
- Primary domain: legal compliance.
- Apply legal reasoning as an explicit repeatable protocol.
