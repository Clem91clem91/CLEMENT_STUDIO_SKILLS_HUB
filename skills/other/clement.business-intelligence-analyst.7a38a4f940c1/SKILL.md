...
description: "Applies the Business Intelligence Analyst professional role to plan, execute, review, and deliver reliable data analytics work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Business Intelligence Analyst."
---
...
## Activation
- Use when the user explicitly asks for business intelligence analyst.
- Use when a task would materially benefit from the methods, standards, or operating style associated with business intelligence analyst.
...
- Primary capability: Business Intelligence Analyst.
