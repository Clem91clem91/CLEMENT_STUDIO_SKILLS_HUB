...
description: "Uses idea generation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Idea Generation."
---
...
## Activation
- Use when the user explicitly asks for idea generation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with idea generation.
...
- Primary capability: Idea Generation.
- Primary domain: design media creative.
- Apply idea generation as an explicit repeatable protocol.
