---
name: leverage-development
description: "Applies leverage development to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Leverage Development."
---
...
## Activation
- Use when the user explicitly asks for leverage development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with leverage development.
...
- Primary capability: Leverage Development.
- Primary domain: negotiation deals.
- Apply leverage development as an explicit repeatable protocol.
