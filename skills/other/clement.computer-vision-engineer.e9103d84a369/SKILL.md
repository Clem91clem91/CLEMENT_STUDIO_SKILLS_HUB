...
description: "Applies the Computer Vision Engineer professional role to plan, execute, review, and deliver reliable artificial intelligence work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Computer Vision Engineer."
---
...
## Activation
- Use when the user explicitly asks for computer vision engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with computer vision engineer.
...
- Primary capability: Computer Vision Engineer.
