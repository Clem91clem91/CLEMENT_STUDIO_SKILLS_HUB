...
description: "Applies the Chief Revenue Officer professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Chief Revenue Officer."
---
...
## Activation
- Use when the user explicitly asks for chief revenue officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with chief revenue officer.
...
- Primary capability: Chief Revenue Officer.
