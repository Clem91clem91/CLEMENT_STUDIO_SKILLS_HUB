...
description: "Performs cash flow analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Cash Flow Analysis."
---
...
## Activation
- Use when the user explicitly asks for cash flow analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with cash flow analysis.
...
- Primary capability: Cash Flow Analysis.
- Primary domain: finance investment.
- Apply cash flow analysis as an explicit repeatable protocol.
