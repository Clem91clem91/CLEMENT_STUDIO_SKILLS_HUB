...
description: "Applies milestone planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Milestone Planning."
---
...
## Activation
- Use when the user explicitly asks for milestone planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with milestone planning.
...
- Primary capability: Milestone Planning.
- Primary domain: operations management.
- Apply milestone planning as an explicit repeatable protocol.
