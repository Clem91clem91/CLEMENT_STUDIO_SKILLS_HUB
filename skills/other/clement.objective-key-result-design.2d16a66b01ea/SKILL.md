---
name: objective-key-result-design
description: "Applies objective key result design to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Objective Key Result Design."
---

# Objective Key Result Design

Turn objectives into coordinated, measurable, reliable execution with clear ownership and continuous control.

## Activation
- Use when the user explicitly asks for objective key result design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with objective key result design.
...
- Primary capability: Objective Key Result Design.
- Primary domain: design media creative.
- Apply objective key result design as an explicit repeatable protocol.
