...
description: "Uses design thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Design Thinking."
---
...
## Activation
- Use when the user explicitly asks for design thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with design thinking.
...
- Primary capability: Design Thinking.
- Primary domain: design media creative.
- Apply design thinking as an explicit repeatable protocol.
