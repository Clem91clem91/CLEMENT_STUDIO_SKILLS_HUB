...
description: "Uses scenario generation as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Scenario Generation."
---
...
## Activation
- Use when the user explicitly asks for scenario generation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with scenario generation.
...
- Primary capability: Scenario Generation.
- Primary domain: general.
- Apply scenario generation as an explicit repeatable protocol.
