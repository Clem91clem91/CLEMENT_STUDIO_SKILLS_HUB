...
description: "Applies the Site Reliability Engineer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Site Reliability Engineer."
---
...
## Activation
- Use when the user explicitly asks for site reliability engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with site reliability engineer.
...
- Primary capability: Site Reliability Engineer.
