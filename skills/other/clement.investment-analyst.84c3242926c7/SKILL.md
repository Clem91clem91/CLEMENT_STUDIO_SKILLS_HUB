...
description: "Applies the Investment Analyst professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Investment Analyst."
---
...
## Activation
- Use when the user explicitly asks for investment analyst.
- Use when a task would materially benefit from the methods, standards, or operating style associated with investment analyst.
...
- Primary capability: Investment Analyst.
