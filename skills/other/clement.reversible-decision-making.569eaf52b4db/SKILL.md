---
name: reversible-decision-making
description: "Uses reversible decision making as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Reversible Decision Making."
---
...
## Activation
- Use when the user explicitly asks for reversible decision making.
- Use when a task would materially benefit from the methods, standards, or operating style associated with reversible decision making.
...
- Primary capability: Reversible Decision Making.
- Primary domain: general.
- Apply reversible decision making as an explicit repeatable protocol.
