---
name: leverage-point-detection
description: "Uses leverage point detection as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Leverage Point Detection."
---
...
## Activation
- Use when the user explicitly asks for leverage point detection.
- Use when a task would materially benefit from the methods, standards, or operating style associated with leverage point detection.
...
- Primary capability: Leverage Point Detection.
- Primary domain: negotiation deals.
- Apply leverage point detection as an explicit repeatable protocol.
