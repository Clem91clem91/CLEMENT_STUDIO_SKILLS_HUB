...
description: "Uses creative experimentation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Creative Experimentation."
---
...
## Activation
- Use when the user explicitly asks for creative experimentation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with creative experimentation.
...
- Primary capability: Creative Experimentation.
- Primary domain: design media creative.
- Apply creative experimentation as an explicit repeatable protocol.
