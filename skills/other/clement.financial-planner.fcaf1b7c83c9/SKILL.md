...
description: "Applies the Financial Planner professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Financial Planner."
---
...
## Activation
- Use when the user explicitly asks for financial planner.
- Use when a task would materially benefit from the methods, standards, or operating style associated with financial planner.
...
- Primary capability: Financial Planner.
- Primary domain: finance investment.
- Apply the named professional craft with explicit standards, evidence, quality control, and handoff.
