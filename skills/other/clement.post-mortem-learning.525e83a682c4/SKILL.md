...
description: "Uses post mortem learning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Post Mortem Learning."
---
...
## Activation
- Use when the user explicitly asks for post mortem learning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with post mortem learning.
...
- Primary capability: Post Mortem Learning.
- Primary domain: artificial intelligence.
- Apply post mortem learning as an explicit repeatable protocol.
