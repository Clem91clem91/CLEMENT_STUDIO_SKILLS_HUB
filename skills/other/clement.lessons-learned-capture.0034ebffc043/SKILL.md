...
description: "Applies lessons learned capture to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Lessons Learned Capture."
---
...
## Activation
- Use when the user explicitly asks for lessons learned capture.
- Use when a task would materially benefit from the methods, standards, or operating style associated with lessons learned capture.
...
- Primary capability: Lessons Learned Capture.
- Primary domain: operations management.
- Apply lessons learned capture as an explicit repeatable protocol.
