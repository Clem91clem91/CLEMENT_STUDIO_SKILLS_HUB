...
description: "Applies inbox management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Inbox Management."
---
...
## Activation
- Use when the user explicitly asks for inbox management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with inbox management.
...
- Primary capability: Inbox Management.
- Primary domain: operations management.
- Apply inbox management as an explicit repeatable protocol.
