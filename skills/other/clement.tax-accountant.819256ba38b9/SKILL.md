---
name: tax-accountant
description: "Applies the Tax Accountant professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Tax Accountant."
---
...
## Activation
- Use when the user explicitly asks for tax accountant.
- Use when a task would materially benefit from the methods, standards, or operating style associated with tax accountant.
...
- Primary capability: Tax Accountant.
