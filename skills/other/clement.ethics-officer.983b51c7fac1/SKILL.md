---
name: ethics-officer
description: "Applies the Ethics Officer professional role to plan, execute, review, and deliver reliable legal compliance work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Ethics Officer."
---
...
## Activation
- Use when the user explicitly asks for ethics officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ethics officer.
...
- Primary capability: Ethics Officer.
