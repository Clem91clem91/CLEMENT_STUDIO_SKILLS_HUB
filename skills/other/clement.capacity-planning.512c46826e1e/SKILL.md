...
description: "Applies capacity planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Capacity Planning."
---
...
## Activation
- Use when the user explicitly asks for capacity planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with capacity planning.
...
- Primary capability: Capacity Planning.
- Primary domain: operations management.
- Apply capacity planning as an explicit repeatable protocol.
