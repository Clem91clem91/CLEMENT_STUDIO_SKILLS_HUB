...
description: "Uses situational leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Situational Leadership."
---
...
## Activation
- Use when the user explicitly asks for situational leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with situational leadership.
...
- Primary capability: Situational Leadership.
- Primary domain: communication people.
- Apply situational leadership as an explicit repeatable protocol.
