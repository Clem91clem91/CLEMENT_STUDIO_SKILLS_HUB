...
description: "Uses character creation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Character Creation."
---
...
## Activation
- Use when the user explicitly asks for character creation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with character creation.
...
- Primary capability: Character Creation.
- Primary domain: design media creative.
- Apply character creation as an explicit repeatable protocol.
