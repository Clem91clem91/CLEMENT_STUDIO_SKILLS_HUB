...
description: "Uses inductive reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Inductive Reasoning."
---
...
## Activation
- Use when the user explicitly asks for inductive reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with inductive reasoning.
...
- Primary capability: Inductive Reasoning.
- Primary domain: general.
- Apply inductive reasoning as an explicit repeatable protocol.
