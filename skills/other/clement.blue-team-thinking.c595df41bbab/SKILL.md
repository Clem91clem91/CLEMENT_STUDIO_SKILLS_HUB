---
name: blue-team-thinking
description: "Uses blue team thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Blue Team Thinking."
---
...
## Activation
- Use when the user explicitly asks for blue team thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with blue team thinking.
...
- Primary capability: Blue Team Thinking.
- Primary domain: communication people.
- Apply blue team thinking as an explicit repeatable protocol.
