...
description: "Uses transformational leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Transformational Leadership."
---
...
## Activation
- Use when the user explicitly asks for transformational leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with transformational leadership.
...
- Primary capability: Transformational Leadership.
- Primary domain: communication people.
- Apply transformational leadership as an explicit repeatable protocol.
