...
description: "Applies principled negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Principled Negotiation."
---
...
## Activation
- Use when the user explicitly asks for principled negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with principled negotiation.
...
- Primary capability: Principled Negotiation.
- Primary domain: negotiation deals.
- Apply principled negotiation as an explicit repeatable protocol.
