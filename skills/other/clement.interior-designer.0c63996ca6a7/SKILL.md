...
description: "Applies the Interior Designer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Interior Designer."
---
...
## Activation
- Use when the user explicitly asks for interior designer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with interior designer.
...
- Primary capability: Interior Designer.
