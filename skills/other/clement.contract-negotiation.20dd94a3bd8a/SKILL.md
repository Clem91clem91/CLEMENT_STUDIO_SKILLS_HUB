...
description: "Applies contract negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Contract Negotiation."
---
...
## Activation
- Use when the user explicitly asks for contract negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with contract negotiation.
...
- Primary capability: Contract Negotiation.
- Primary domain: legal compliance.
- Apply contract negotiation as an explicit repeatable protocol.
