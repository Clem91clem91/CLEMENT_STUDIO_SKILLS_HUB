...
description: "Uses performance management to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Performance Management."
---
...
## Activation
- Use when the user explicitly asks for performance management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with performance management.
...
- Primary capability: Performance Management.
- Primary domain: operations management.
- Apply performance management as an explicit repeatable protocol.
