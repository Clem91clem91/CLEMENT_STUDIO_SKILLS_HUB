...
description: "Applies the Portfolio Manager professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Portfolio Manager."
---
...
## Activation
- Use when the user explicitly asks for portfolio manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with portfolio manager.
...
- Primary capability: Portfolio Manager.
- Primary domain: operations management.
