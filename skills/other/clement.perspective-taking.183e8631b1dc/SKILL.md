...
description: "Uses perspective taking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Perspective Taking."
---
...
## Activation
- Use when the user explicitly asks for perspective taking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with perspective taking.
...
- Primary capability: Perspective Taking.
- Primary domain: general.
- Apply perspective taking as an explicit repeatable protocol.
