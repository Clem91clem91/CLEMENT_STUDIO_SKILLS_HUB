---
name: operational-recovery-planning
description: "Applies operational recovery planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Operational Recovery Planning."
---
...
## Activation
- Use when the user explicitly asks for operational recovery planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with operational recovery planning.
...
- Primary capability: Operational Recovery Planning.
- Primary domain: operations management.
- Apply operational recovery planning as an explicit repeatable protocol.
