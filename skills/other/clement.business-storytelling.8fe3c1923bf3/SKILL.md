...
description: "Uses business storytelling to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Business Storytelling."
---
...
## Activation
- Use when the user explicitly asks for business storytelling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with business storytelling.
...
- Primary capability: Business Storytelling.
- Primary domain: communication people.
- Apply business storytelling as an explicit repeatable protocol.
