...
description: "Applies the Product Designer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Product Designer."
---
...
## Activation
- Use when the user explicitly asks for product designer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with product designer.
...
- Primary capability: Product Designer.
