---
name: continuous-improvement-execution
description: "Applies continuous improvement execution to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Continuous Improvement Execution."
---
...
## Activation
- Use when the user explicitly asks for continuous improvement execution.
- Use when a task would materially benefit from the methods, standards, or operating style associated with continuous improvement execution.
...
- Primary capability: Continuous Improvement Execution.
- Primary domain: operations management.
- Apply continuous improvement execution as an explicit repeatable protocol.
