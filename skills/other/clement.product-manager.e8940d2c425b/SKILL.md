...
description: "Applies the Product Manager professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Product Manager."
---
...
## Activation
- Use when the user explicitly asks for product manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with product manager.
...
- Primary capability: Product Manager.
