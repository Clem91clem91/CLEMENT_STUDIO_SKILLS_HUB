...
description: "Applies meeting scheduling to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Meeting Scheduling."
---
...
## Activation
- Use when the user explicitly asks for meeting scheduling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with meeting scheduling.
...
- Primary capability: Meeting Scheduling.
- Primary domain: operations management.
- Apply meeting scheduling as an explicit repeatable protocol.
