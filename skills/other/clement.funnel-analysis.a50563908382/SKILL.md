...
description: "Performs funnel analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Funnel Analysis."
---
...
## Activation
- Use when the user explicitly asks for funnel analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with funnel analysis.
...
- Primary capability: Funnel Analysis.
- Primary domain: data analytics.
- Apply funnel analysis as an explicit repeatable protocol.
