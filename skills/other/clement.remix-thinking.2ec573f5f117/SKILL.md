---
name: remix-thinking
description: "Uses remix thinking to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Remix Thinking."
---
...
## Activation
- Use when the user explicitly asks for remix thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with remix thinking.
...
- Primary capability: Remix Thinking.
- Primary domain: design media creative.
- Apply remix thinking as an explicit repeatable protocol.
