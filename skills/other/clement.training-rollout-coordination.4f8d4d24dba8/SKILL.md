---
name: training-rollout-coordination
description: "Applies training rollout coordination to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Training Rollout Coordination."
---
...
## Activation
- Use when the user explicitly asks for training rollout coordination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with training rollout coordination.
...
- Primary capability: Training Rollout Coordination.
- Primary domain: operations management.
- Apply training rollout coordination as an explicit repeatable protocol.
