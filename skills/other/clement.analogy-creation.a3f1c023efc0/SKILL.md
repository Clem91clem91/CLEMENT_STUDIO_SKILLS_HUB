...
description: "Uses analogy creation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Analogy Creation."
---
...
## Activation
- Use when the user explicitly asks for analogy creation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with analogy creation.
...
- Primary capability: Analogy Creation.
- Primary domain: design media creative.
- Apply analogy creation as an explicit repeatable protocol.
