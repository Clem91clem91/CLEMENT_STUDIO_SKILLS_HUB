...
description: "Uses knowledge chunking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Knowledge Chunking."
---
...
## Activation
- Use when the user explicitly asks for knowledge chunking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with knowledge chunking.
...
- Primary capability: Knowledge Chunking.
- Primary domain: general.
- Apply knowledge chunking as an explicit repeatable protocol.
