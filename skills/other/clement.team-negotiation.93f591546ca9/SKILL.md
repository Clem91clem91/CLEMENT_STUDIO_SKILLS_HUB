---
name: team-negotiation
description: "Applies team negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Team Negotiation."
---
...
## Activation
- Use when the user explicitly asks for team negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with team negotiation.
...
- Primary capability: Team Negotiation.
- Primary domain: communication people.
- Apply team negotiation as an explicit repeatable protocol.
