...
description: "Applies critical path planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Critical Path Planning."
---
...
## Activation
- Use when the user explicitly asks for critical path planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with critical path planning.
...
- Primary capability: Critical Path Planning.
- Primary domain: operations management.
- Apply critical path planning as an explicit repeatable protocol.
