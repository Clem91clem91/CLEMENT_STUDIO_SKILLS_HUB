...
description: "Applies the Data Protection Officer professional role to plan, execute, review, and deliver reliable legal compliance work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Data Protection Officer."
---
...
## Activation
- Use when the user explicitly asks for data protection officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with data protection officer.
...
- Primary capability: Data Protection Officer.
