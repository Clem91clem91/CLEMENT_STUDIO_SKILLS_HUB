...
description: "Applies the Community Manager professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Community Manager."
---
...
## Activation
- Use when the user explicitly asks for community manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with community manager.
...
- Primary capability: Community Manager.
