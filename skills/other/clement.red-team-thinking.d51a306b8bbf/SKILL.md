...
description: "Uses red team thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Red Team Thinking."
---
...
## Activation
- Use when the user explicitly asks for red team thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with red team thinking.
...
- Primary capability: Red Team Thinking.
- Primary domain: communication people.
- Apply red team thinking as an explicit repeatable protocol.
