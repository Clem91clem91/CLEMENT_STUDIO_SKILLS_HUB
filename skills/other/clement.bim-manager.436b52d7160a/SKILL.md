---
name: bim-manager
description: "Applies the BIM Manager professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving BIM Manager."
---
...
## Activation
- Use when the user explicitly asks for bim manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with bim manager.
...
- Primary capability: BIM Manager.
