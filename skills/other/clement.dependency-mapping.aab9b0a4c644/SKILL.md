...
description: "Applies dependency mapping to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Dependency Mapping."
---
...
## Activation
- Use when the user explicitly asks for dependency mapping.
- Use when a task would materially benefit from the methods, standards, or operating style associated with dependency mapping.
...
- Primary capability: Dependency Mapping.
- Primary domain: operations management.
- Apply dependency mapping as an explicit repeatable protocol.
