...
description: "Performs break even analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Break Even Analysis."
---
...
## Activation
- Use when the user explicitly asks for break even analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with break even analysis.
...
- Primary capability: Break Even Analysis.
- Primary domain: data analytics.
- Apply break even analysis as an explicit repeatable protocol.
