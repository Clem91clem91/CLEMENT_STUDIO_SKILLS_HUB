...
description: "Performs process analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Process Analysis."
---
...
## Activation
- Use when the user explicitly asks for process analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with process analysis.
...
- Primary capability: Process Analysis.
- Primary domain: construction engineering.
- Apply process analysis as an explicit repeatable protocol.
