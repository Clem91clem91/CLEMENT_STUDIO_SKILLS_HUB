...
description: "Uses diagnostic reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Diagnostic Reasoning."
---
...
## Activation
- Use when the user explicitly asks for diagnostic reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with diagnostic reasoning.
...
- Primary capability: Diagnostic Reasoning.
- Primary domain: general.
- Apply diagnostic reasoning as an explicit repeatable protocol.
