...
description: "Uses audience adaptation to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Audience Adaptation."
---
...
## Activation
- Use when the user explicitly asks for audience adaptation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with audience adaptation.
...
- Primary capability: Audience Adaptation.
- Primary domain: communication people.
- Apply audience adaptation as an explicit repeatable protocol.
