...
description: "Uses analogical reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Analogical Reasoning."
---
...
## Activation
- Use when the user explicitly asks for analogical reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with analogical reasoning.
...
- Primary capability: Analogical Reasoning.
- Primary domain: general.
- Apply analogical reasoning as an explicit repeatable protocol.
