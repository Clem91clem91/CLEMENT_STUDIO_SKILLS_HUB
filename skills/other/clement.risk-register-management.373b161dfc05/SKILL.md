...
description: "Applies risk register management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Risk Register Management."
---
...
## Activation
- Use when the user explicitly asks for risk register management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with risk register management.
...
- Primary capability: Risk Register Management.
- Primary domain: operations management.
- Apply risk register management as an explicit repeatable protocol.
