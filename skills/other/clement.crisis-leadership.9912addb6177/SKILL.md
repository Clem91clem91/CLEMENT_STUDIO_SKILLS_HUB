...
description: "Uses crisis leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Crisis Leadership."
---
...
## Activation
- Use when the user explicitly asks for crisis leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with crisis leadership.
...
- Primary capability: Crisis Leadership.
- Primary domain: communication people.
- Apply crisis leadership as an explicit repeatable protocol.
