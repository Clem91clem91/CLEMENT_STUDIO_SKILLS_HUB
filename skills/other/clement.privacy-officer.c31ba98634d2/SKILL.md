...
description: "Applies the Privacy Officer professional role to plan, execute, review, and deliver reliable legal compliance work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Privacy Officer."
---
...
## Activation
- Use when the user explicitly asks for privacy officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with privacy officer.
...
- Primary capability: Privacy Officer.
