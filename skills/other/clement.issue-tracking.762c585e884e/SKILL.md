---
name: issue-tracking
description: "Applies issue tracking to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Issue Tracking."
---
...
## Activation
- Use when the user explicitly asks for issue tracking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with issue tracking.
...
- Primary capability: Issue Tracking.
- Primary domain: operations management.
- Apply issue tracking as an explicit repeatable protocol.
