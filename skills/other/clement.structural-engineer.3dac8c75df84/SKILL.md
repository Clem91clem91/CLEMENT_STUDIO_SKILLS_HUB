...
description: "Applies the Structural Engineer professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Structural Engineer."
---
...
## Activation
- Use when the user explicitly asks for structural engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with structural engineer.
...
- Primary capability: Structural Engineer.
