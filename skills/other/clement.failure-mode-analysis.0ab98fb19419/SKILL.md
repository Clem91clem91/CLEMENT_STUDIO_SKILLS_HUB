...
description: "Performs failure mode analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Failure Mode Analysis."
---
...
## Activation
- Use when the user explicitly asks for failure mode analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with failure mode analysis.
...
- Primary capability: Failure Mode Analysis.
- Primary domain: artificial intelligence.
- Apply failure mode analysis as an explicit repeatable protocol.
