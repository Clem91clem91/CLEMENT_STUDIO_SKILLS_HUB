...
description: "Applies the Customer Support Specialist professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Customer Support Specialist."
---
...
## Activation
- Use when the user explicitly asks for customer support specialist.
- Use when a task would materially benefit from the methods, standards, or operating style associated with customer support specialist.
...
- Primary capability: Customer Support Specialist.
