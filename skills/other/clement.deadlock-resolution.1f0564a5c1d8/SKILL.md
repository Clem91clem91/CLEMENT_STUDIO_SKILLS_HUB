...
description: "Applies deadlock resolution to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Deadlock Resolution."
---
...
## Activation
- Use when the user explicitly asks for deadlock resolution.
- Use when a task would materially benefit from the methods, standards, or operating style associated with deadlock resolution.
...
- Primary capability: Deadlock Resolution.
- Primary domain: negotiation deals.
- Apply deadlock resolution as an explicit repeatable protocol.
