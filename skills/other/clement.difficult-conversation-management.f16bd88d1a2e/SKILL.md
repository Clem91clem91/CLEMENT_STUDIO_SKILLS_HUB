---
name: difficult-conversation-management
description: "Uses difficult conversation management to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Difficult Conversation Management."
---
...
## Activation
- Use when the user explicitly asks for difficult conversation management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with difficult conversation management.
...
- Primary capability: Difficult Conversation Management.
- Primary domain: operations management.
- Apply difficult conversation management as an explicit repeatable protocol.
