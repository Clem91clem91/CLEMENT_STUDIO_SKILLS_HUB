...
description: "Applies release readiness check to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Release Readiness Check."
---
...
## Activation
- Use when the user explicitly asks for release readiness check.
- Use when a task would materially benefit from the methods, standards, or operating style associated with release readiness check.
...
- Primary capability: Release Readiness Check.
- Primary domain: software cloud.
- Apply release readiness check as an explicit repeatable protocol.
