...
description: "Applies task sequencing to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Task Sequencing."
---
...
## Activation
- Use when the user explicitly asks for task sequencing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with task sequencing.
...
- Primary capability: Task Sequencing.
- Primary domain: operations management.
- Apply task sequencing as an explicit repeatable protocol.
