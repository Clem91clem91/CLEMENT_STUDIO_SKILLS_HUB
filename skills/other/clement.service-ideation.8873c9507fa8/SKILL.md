...
description: "Uses service ideation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Service Ideation."
---
...
## Activation
- Use when the user explicitly asks for service ideation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with service ideation.
...
- Primary capability: Service Ideation.
- Primary domain: design media creative.
- Apply service ideation as an explicit repeatable protocol.
