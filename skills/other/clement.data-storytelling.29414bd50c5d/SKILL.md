...
description: "Uses data storytelling to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Data Storytelling."
---
...
## Activation
- Use when the user explicitly asks for data storytelling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with data storytelling.
...
- Primary capability: Data Storytelling.
- Primary domain: data analytics.
- Apply data storytelling as an explicit repeatable protocol.
