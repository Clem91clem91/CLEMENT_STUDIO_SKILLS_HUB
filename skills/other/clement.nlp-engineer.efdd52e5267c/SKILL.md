---
name: nlp-engineer
description: "Applies the NLP Engineer professional role to plan, execute, review, and deliver reliable artificial intelligence work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving NLP Engineer."
---
...
## Activation
- Use when the user explicitly asks for nlp engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with nlp engineer.
...
- Primary capability: NLP Engineer.
