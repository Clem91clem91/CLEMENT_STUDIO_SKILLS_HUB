...
description: "Applies the Insurance Underwriter professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Insurance Underwriter."
---
...
## Activation
- Use when the user explicitly asks for insurance underwriter.
- Use when a task would materially benefit from the methods, standards, or operating style associated with insurance underwriter.
...
- Primary capability: Insurance Underwriter.
- Primary domain: finance investment.
- Clarify audience and purpose.
- Create structured, accurate content.
- Edit for clarity, evidence, consistency, and rights.
