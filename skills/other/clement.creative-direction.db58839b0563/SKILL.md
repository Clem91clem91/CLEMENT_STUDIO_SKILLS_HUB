...
description: "Uses creative direction to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Creative Direction."
---
...
## Activation
- Use when the user explicitly asks for creative direction.
- Use when a task would materially benefit from the methods, standards, or operating style associated with creative direction.
...
- Primary capability: Creative Direction.
- Primary domain: design media creative.
- Apply creative direction as an explicit repeatable protocol.
