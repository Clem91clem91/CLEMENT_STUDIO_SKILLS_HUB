...
description: "Uses adversarial reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Adversarial Reasoning."
---
...
## Activation
- Use when the user explicitly asks for adversarial reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with adversarial reasoning.
...
- Primary capability: Adversarial Reasoning.
- Primary domain: general.
- Apply adversarial reasoning as an explicit repeatable protocol.
