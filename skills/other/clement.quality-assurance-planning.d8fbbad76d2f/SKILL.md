...
description: "Applies quality assurance planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Quality Assurance Planning."
---
...
## Activation
- Use when the user explicitly asks for quality assurance planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with quality assurance planning.
...
- Primary capability: Quality Assurance Planning.
- Primary domain: operations management.
- Apply quality assurance planning as an explicit repeatable protocol.
