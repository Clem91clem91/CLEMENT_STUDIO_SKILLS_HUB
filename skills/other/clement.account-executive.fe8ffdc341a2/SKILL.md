...
description: "Applies the Account Executive professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Account Executive."
---
...
## Activation
- Use when the user explicitly asks for account executive.
- Use when a task would materially benefit from the methods, standards, or operating style associated with account executive.
...
- Primary capability: Account Executive.
