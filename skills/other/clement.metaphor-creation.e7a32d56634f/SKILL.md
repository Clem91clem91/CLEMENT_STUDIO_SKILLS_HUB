...
description: "Uses metaphor creation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Metaphor Creation."
---
...
## Activation
- Use when the user explicitly asks for metaphor creation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with metaphor creation.
...
- Primary capability: Metaphor Creation.
- Primary domain: design media creative.
- Apply metaphor creation as an explicit repeatable protocol.
