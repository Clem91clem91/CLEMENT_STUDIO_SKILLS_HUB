...
description: "Uses rapid prototyping to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Rapid Prototyping."
---
...
## Activation
- Use when the user explicitly asks for rapid prototyping.
- Use when a task would materially benefit from the methods, standards, or operating style associated with rapid prototyping.
...
- Primary capability: Rapid Prototyping.
- Primary domain: design media creative.
- Apply rapid prototyping as an explicit repeatable protocol.
