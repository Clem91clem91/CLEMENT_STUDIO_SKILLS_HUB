...
description: "Applies scope management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Scope Management."
---
...
## Activation
- Use when the user explicitly asks for scope management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with scope management.
...
- Primary capability: Scope Management.
- Primary domain: operations management.
- Apply scope management as an explicit repeatable protocol.
