---
name: position-based-negotiation
description: "Applies position based negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Position Based Negotiation."
---
...
## Activation
- Use when the user explicitly asks for position based negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with position based negotiation.
...
- Primary capability: Position Based Negotiation.
- Primary domain: negotiation deals.
- Apply position based negotiation as an explicit repeatable protocol.
