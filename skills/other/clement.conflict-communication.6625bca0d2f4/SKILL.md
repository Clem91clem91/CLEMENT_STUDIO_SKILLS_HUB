...
description: "Uses conflict communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Conflict Communication."
---
...
## Activation
- Use when the user explicitly asks for conflict communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with conflict communication.
...
- Primary capability: Conflict Communication.
- Primary domain: communication people.
- Apply conflict communication as an explicit repeatable protocol.
