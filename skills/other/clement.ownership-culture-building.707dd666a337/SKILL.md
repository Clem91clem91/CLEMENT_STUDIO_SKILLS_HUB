---
name: ownership-culture-building
description: "Uses ownership culture building to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Ownership Culture Building."
---
...
## Activation
- Use when the user explicitly asks for ownership culture building.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ownership culture building.
...
- Primary capability: Ownership Culture Building.
- Primary domain: communication people.
- Apply ownership culture building as an explicit repeatable protocol.
