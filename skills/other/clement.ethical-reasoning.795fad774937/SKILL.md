...
description: "Uses ethical reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Ethical Reasoning."
---
...
## Activation
- Use when the user explicitly asks for ethical reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ethical reasoning.
...
- Primary capability: Ethical Reasoning.
- Primary domain: general.
- Apply ethical reasoning as an explicit repeatable protocol.
