---
name: anomaly-detection-thinking
description: "Uses anomaly detection thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Anomaly Detection Thinking."
---
...
## Activation
- Use when the user explicitly asks for anomaly detection thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with anomaly detection thinking.
...
- Primary capability: Anomaly Detection Thinking.
- Primary domain: general.
- Apply anomaly detection thinking as an explicit repeatable protocol.
