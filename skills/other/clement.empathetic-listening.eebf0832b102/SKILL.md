...
description: "Uses empathetic listening to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Empathetic Listening."
---
...
## Activation
- Use when the user explicitly asks for empathetic listening.
- Use when a task would materially benefit from the methods, standards, or operating style associated with empathetic listening.
...
- Primary capability: Empathetic Listening.
- Primary domain: communication people.
- Apply empathetic listening as an explicit repeatable protocol.
