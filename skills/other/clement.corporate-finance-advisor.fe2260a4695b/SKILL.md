---
name: corporate-finance-advisor
description: "Applies the Corporate Finance Advisor professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Corporate Finance Advisor."
---
...
## Activation
- Use when the user explicitly asks for corporate finance advisor.
- Use when a task would materially benefit from the methods, standards, or operating style associated with corporate finance advisor.
...
- Primary capability: Corporate Finance Advisor.
