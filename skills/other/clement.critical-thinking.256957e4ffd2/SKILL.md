...
description: "Uses critical thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Critical Thinking."
---
...
## Activation
- Use when the user explicitly asks for critical thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with critical thinking.
...
- Primary capability: Critical Thinking.
- Primary domain: general.
- Apply critical thinking as an explicit repeatable protocol.
