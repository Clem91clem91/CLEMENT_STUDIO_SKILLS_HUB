...
description: "Applies the Strategy Consultant professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Strategy Consultant."
---
...
## Activation
- Use when the user explicitly asks for strategy consultant.
- Use when a task would materially benefit from the methods, standards, or operating style associated with strategy consultant.
...
- Primary capability: Strategy Consultant.
