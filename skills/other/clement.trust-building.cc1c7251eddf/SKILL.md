---
name: trust-building
description: "Uses trust building to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Trust Building."
---
...
## Activation
- Use when the user explicitly asks for trust building.
- Use when a task would materially benefit from the methods, standards, or operating style associated with trust building.
...
- Primary capability: Trust Building.
- Primary domain: communication people.
- Apply trust building as an explicit repeatable protocol.
