---
name: board-advisor
description: "Applies the Board Advisor professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Board Advisor."
---
...
## Activation
- Use when the user explicitly asks for board advisor.
- Use when a task would materially benefit from the methods, standards, or operating style associated with board advisor.
...
- Primary capability: Board Advisor.
