---
name: rapid-learning
description: "Uses rapid learning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Rapid Learning."
---
...
## Activation
- Use when the user explicitly asks for rapid learning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with rapid learning.
...
- Primary capability: Rapid Learning.
- Primary domain: artificial intelligence.
- Apply rapid learning as an explicit repeatable protocol.
