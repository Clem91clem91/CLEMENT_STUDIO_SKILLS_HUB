---
name: failure-mode-imagination
description: "Uses failure mode imagination as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Failure Mode Imagination."
---
...
## Activation
- Use when the user explicitly asks for failure mode imagination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with failure mode imagination.
...
- Primary capability: Failure Mode Imagination.
- Primary domain: artificial intelligence.
- Apply failure mode imagination as an explicit repeatable protocol.
