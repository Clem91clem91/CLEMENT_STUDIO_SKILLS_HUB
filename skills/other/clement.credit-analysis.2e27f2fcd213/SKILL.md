...
description: "Performs credit analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Credit Analysis."
---
...
## Activation
- Use when the user explicitly asks for credit analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with credit analysis.
...
- Primary capability: Credit Analysis.
- Primary domain: finance investment.
- Apply credit analysis as an explicit repeatable protocol.
