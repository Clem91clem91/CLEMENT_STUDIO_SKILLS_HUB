...
description: "Uses product leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Product Leadership."
---
...
## Activation
- Use when the user explicitly asks for product leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with product leadership.
...
- Primary capability: Product Leadership.
- Primary domain: operations management.
- Apply product leadership as an explicit repeatable protocol.
