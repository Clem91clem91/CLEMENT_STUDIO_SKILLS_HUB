---
name: debriefing-facilitation
description: "Uses debriefing facilitation to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Debriefing Facilitation."
---
...
## Activation
- Use when the user explicitly asks for debriefing facilitation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with debriefing facilitation.
...
- Primary capability: Debriefing Facilitation.
- Primary domain: communication people.
- Apply debriefing facilitation as an explicit repeatable protocol.
