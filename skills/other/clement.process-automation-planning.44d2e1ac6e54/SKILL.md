---
name: process-automation-planning
description: "Applies process automation planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Process Automation Planning."
---
...
## Activation
- Use when the user explicitly asks for process automation planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with process automation planning.
...
- Primary capability: Process Automation Planning.
- Primary domain: operations management.
- Apply process automation planning as an explicit repeatable protocol.
