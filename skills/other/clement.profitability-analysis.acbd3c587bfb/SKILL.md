...
description: "Performs profitability analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Profitability Analysis."
---
...
## Activation
- Use when the user explicitly asks for profitability analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with profitability analysis.
...
- Primary capability: Profitability Analysis.
- Primary domain: finance investment.
- Apply profitability analysis as an explicit repeatable protocol.
