---
name: transfer-learning-thinking
description: "Uses transfer learning thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Transfer Learning Thinking."
---
...
## Activation
- Use when the user explicitly asks for transfer learning thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with transfer learning thinking.
...
- Primary capability: Transfer Learning Thinking.
- Primary domain: artificial intelligence.
- Apply transfer learning thinking as an explicit repeatable protocol.
