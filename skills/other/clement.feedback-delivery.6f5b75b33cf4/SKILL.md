...
description: "Uses feedback delivery to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Feedback Delivery."
---
...
## Activation
- Use when the user explicitly asks for feedback delivery.
- Use when a task would materially benefit from the methods, standards, or operating style associated with feedback delivery.
...
- Primary capability: Feedback Delivery.
- Primary domain: communication people.
- Apply feedback delivery as an explicit repeatable protocol.
