---
name: report-writing
description: "Uses report writing to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Report Writing."
---
...
## Activation
- Use when the user explicitly asks for report writing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with report writing.
...
- Primary capability: Report Writing.
- Primary domain: communication people.
- Apply report writing as an explicit repeatable protocol.
