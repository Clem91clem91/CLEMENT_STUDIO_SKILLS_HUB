...
description: "Applies the Quantity Surveyor professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Quantity Surveyor."
---
...
## Activation
- Use when the user explicitly asks for quantity surveyor.
- Use when a task would materially benefit from the methods, standards, or operating style associated with quantity surveyor.
...
- Primary capability: Quantity Surveyor.
