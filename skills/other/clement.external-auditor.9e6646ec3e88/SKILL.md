...
description: "Applies the External Auditor professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving External Auditor."
---
...
## Activation
- Use when the user explicitly asks for external auditor.
- Use when a task would materially benefit from the methods, standards, or operating style associated with external auditor.
...
- Primary capability: External Auditor.
