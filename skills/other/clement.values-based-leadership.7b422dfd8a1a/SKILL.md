...
description: "Uses values based leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Values Based Leadership."
---
...
## Activation
- Use when the user explicitly asks for values based leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with values based leadership.
...
- Primary capability: Values Based Leadership.
- Primary domain: communication people.
- Apply values based leadership as an explicit repeatable protocol.
