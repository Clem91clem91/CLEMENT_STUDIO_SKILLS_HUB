...
description: "Applies budget planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Budget Planning."
---
...
## Activation
- Use when the user explicitly asks for budget planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with budget planning.
...
- Primary capability: Budget Planning.
- Primary domain: finance investment.
- Apply budget planning as an explicit repeatable protocol.
