...
description: "Applies the Key Account Manager professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Key Account Manager."
---
...
## Activation
- Use when the user explicitly asks for key account manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with key account manager.
...
- Primary capability: Key Account Manager.
