---
name: high-performance-team-building
description: "Uses high performance team building to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving High Performance Team Building."
---
...
## Activation
- Use when the user explicitly asks for high performance team building.
- Use when a task would materially benefit from the methods, standards, or operating style associated with high performance team building.
...
- Primary capability: High Performance Team Building.
- Primary domain: communication people.
- Apply high performance team building as an explicit repeatable protocol.
