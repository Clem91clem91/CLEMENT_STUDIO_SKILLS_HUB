...
description: "Applies merger negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Merger Negotiation."
---
...
## Activation
- Use when the user explicitly asks for merger negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with merger negotiation.
...
- Primary capability: Merger Negotiation.
- Primary domain: negotiation deals.
- Apply merger negotiation as an explicit repeatable protocol.
