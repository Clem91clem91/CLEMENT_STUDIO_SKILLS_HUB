...
description: "Applies template standardization to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Template Standardization."
---
...
## Activation
- Use when the user explicitly asks for template standardization.
- Use when a task would materially benefit from the methods, standards, or operating style associated with template standardization.
...
- Primary capability: Template Standardization.
- Primary domain: operations management.
- Apply template standardization as an explicit repeatable protocol.
