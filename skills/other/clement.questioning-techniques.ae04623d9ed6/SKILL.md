...
description: "Uses questioning techniques to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Questioning Techniques."
---
...
## Activation
- Use when the user explicitly asks for questioning techniques.
- Use when a task would materially benefit from the methods, standards, or operating style associated with questioning techniques.
...
- Primary capability: Questioning Techniques.
- Primary domain: communication people.
- Apply questioning techniques as an explicit repeatable protocol.
