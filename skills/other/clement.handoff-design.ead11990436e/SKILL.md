---
name: handoff-design
description: "Applies handoff design to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Handoff Design."
---
...
## Activation
- Use when the user explicitly asks for handoff design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with handoff design.
...
- Primary capability: Handoff Design.
- Primary domain: design media creative.
- Apply handoff design as an explicit repeatable protocol.
