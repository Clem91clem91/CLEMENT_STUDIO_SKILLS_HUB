---
name: post-negotiation-review
description: "Applies post negotiation review to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Post Negotiation Review."
---
...
## Activation
- Use when the user explicitly asks for post negotiation review.
- Use when a task would materially benefit from the methods, standards, or operating style associated with post negotiation review.
...
- Primary capability: Post Negotiation Review.
- Primary domain: negotiation deals.
- Apply post negotiation review as an explicit repeatable protocol.
