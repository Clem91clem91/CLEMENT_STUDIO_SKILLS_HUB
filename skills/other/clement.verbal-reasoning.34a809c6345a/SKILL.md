...
description: "Uses verbal reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Verbal Reasoning."
---
...
## Activation
- Use when the user explicitly asks for verbal reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with verbal reasoning.
...
- Primary capability: Verbal Reasoning.
- Primary domain: general.
- Apply verbal reasoning as an explicit repeatable protocol.
