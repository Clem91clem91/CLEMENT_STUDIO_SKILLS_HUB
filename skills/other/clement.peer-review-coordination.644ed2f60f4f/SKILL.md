...
description: "Applies peer review coordination to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Peer Review Coordination."
---
...
## Activation
- Use when the user explicitly asks for peer review coordination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with peer review coordination.
...
- Primary capability: Peer Review Coordination.
- Primary domain: operations management.
- Apply peer review coordination as an explicit repeatable protocol.
