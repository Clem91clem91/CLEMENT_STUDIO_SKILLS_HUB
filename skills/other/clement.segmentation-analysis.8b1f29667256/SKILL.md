...
description: "Performs segmentation analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Segmentation Analysis."
---
...
## Activation
- Use when the user explicitly asks for segmentation analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with segmentation analysis.
...
- Primary capability: Segmentation Analysis.
- Primary domain: data analytics.
- Apply segmentation analysis as an explicit repeatable protocol.
