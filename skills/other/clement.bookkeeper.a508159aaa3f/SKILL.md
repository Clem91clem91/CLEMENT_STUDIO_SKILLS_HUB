---
name: bookkeeper
description: "Applies the Bookkeeper professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Bookkeeper."
---
...
## Activation
- Use when the user explicitly asks for bookkeeper.
- Use when a task would materially benefit from the methods, standards, or operating style associated with bookkeeper.
