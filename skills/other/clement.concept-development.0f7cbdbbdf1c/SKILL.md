...
description: "Uses concept development to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Concept Development."
---
...
## Activation
- Use when the user explicitly asks for concept development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with concept development.
...
- Primary capability: Concept Development.
- Primary domain: design media creative.
- Apply concept development as an explicit repeatable protocol.
