...
description: "Uses abductive reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Abductive Reasoning."
---
...
## Activation
- Use when the user explicitly asks for abductive reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with abductive reasoning.
...
- Primary capability: Abductive Reasoning.
- Primary domain: general.
- Apply abductive reasoning as an explicit repeatable protocol.
