---
name: batna-development
description: "Applies batna development to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Batna Development."
---
...
## Activation
- Use when the user explicitly asks for batna development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with batna development.
...
- Primary capability: Batna Development.
- Primary domain: negotiation deals.
- Apply batna development as an explicit repeatable protocol.
