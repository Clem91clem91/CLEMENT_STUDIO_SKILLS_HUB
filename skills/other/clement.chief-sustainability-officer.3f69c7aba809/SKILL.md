...
description: "Applies the Chief Sustainability Officer professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Chief Sustainability Officer."
---
...
## Activation
- Use when the user explicitly asks for chief sustainability officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with chief sustainability officer.
...
- Primary capability: Chief Sustainability Officer.
