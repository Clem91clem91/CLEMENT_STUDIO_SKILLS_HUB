...
description: "Applies calendar management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Calendar Management."
---
...
## Activation
- Use when the user explicitly asks for calendar management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with calendar management.
...
- Primary capability: Calendar Management.
- Primary domain: operations management.
- Apply calendar management as an explicit repeatable protocol.
