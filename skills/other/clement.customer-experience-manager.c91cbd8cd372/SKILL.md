...
description: "Applies the Customer Experience Manager professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Customer Experience Manager."
---
...
## Activation
- Use when the user explicitly asks for customer experience manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with customer experience manager.
...
- Primary capability: Customer Experience Manager.
