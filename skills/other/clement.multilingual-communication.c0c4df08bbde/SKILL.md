...
description: "Uses multilingual communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Multilingual Communication."
---
...
## Activation
- Use when the user explicitly asks for multilingual communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with multilingual communication.
...
- Primary capability: Multilingual Communication.
- Primary domain: communication people.
- Apply multilingual communication as an explicit repeatable protocol.
