...
description: "Uses contextual understanding as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Contextual Understanding."
---
...
## Activation
- Use when the user explicitly asks for contextual understanding.
- Use when a task would materially benefit from the methods, standards, or operating style associated with contextual understanding.
...
- Primary capability: Contextual Understanding.
- Primary domain: general.
- Apply contextual understanding as an explicit repeatable protocol.
