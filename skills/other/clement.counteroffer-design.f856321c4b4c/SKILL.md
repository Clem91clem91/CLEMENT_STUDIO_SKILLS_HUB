---
name: counteroffer-design
description: "Applies counteroffer design to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Counteroffer Design."
---
...
## Activation
- Use when the user explicitly asks for counteroffer design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with counteroffer design.
...
- Primary capability: Counteroffer Design.
- Primary domain: negotiation deals.
- Apply counteroffer design as an explicit repeatable protocol.
