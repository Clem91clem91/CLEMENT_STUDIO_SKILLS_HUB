...
description: "Uses leadership coaching to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Leadership Coaching."
---
...
## Activation
- Use when the user explicitly asks for leadership coaching.
- Use when a task would materially benefit from the methods, standards, or operating style associated with leadership coaching.
...
- Primary capability: Leadership Coaching.
- Primary domain: communication people.
- Apply leadership coaching as an explicit repeatable protocol.
