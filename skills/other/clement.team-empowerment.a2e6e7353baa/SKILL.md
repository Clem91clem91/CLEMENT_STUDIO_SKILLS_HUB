...
description: "Uses team empowerment to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Team Empowerment."
---
...
## Activation
- Use when the user explicitly asks for team empowerment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with team empowerment.
...
- Primary capability: Team Empowerment.
- Primary domain: communication people.
- Apply team empowerment as an explicit repeatable protocol.
