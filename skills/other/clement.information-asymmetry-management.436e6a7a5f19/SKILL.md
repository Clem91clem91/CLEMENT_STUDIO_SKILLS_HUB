---
name: information-asymmetry-management
description: "Applies information asymmetry management to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Information Asymmetry Management."
---
...
## Activation
- Use when the user explicitly asks for information asymmetry management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with information asymmetry management.
...
- Primary capability: Information Asymmetry Management.
- Primary domain: operations management.
- Apply information asymmetry management as an explicit repeatable protocol.
