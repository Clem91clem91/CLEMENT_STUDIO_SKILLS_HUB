---
name: video-editor
description: "Applies the Video Editor professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Video Editor."
---
...
## Activation
- Use when the user explicitly asks for video editor.
- Use when a task would materially benefit from the methods, standards, or operating style associated with video editor.
...
- Primary capability: Video Editor.
