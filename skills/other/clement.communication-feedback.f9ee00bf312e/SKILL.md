...
description: "Uses communication feedback to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Communication Feedback."
---
...
## Activation
- Use when the user explicitly asks for communication feedback.
- Use when a task would materially benefit from the methods, standards, or operating style associated with communication feedback.
...
- Primary capability: Communication Feedback.
- Primary domain: communication people.
- Apply communication feedback as an explicit repeatable protocol.
