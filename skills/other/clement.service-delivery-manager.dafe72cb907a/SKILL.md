...
description: "Applies the Service Delivery Manager professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Service Delivery Manager."
---
...
## Activation
- Use when the user explicitly asks for service delivery manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with service delivery manager.
...
- Primary capability: Service Delivery Manager.
