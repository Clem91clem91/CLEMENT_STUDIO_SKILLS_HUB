---
name: empathy-in-negotiation
description: "Applies empathy in negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Empathy In Negotiation."
---
...
## Activation
- Use when the user explicitly asks for empathy in negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with empathy in negotiation.
...
- Primary capability: Empathy In Negotiation.
- Primary domain: negotiation deals.
- Apply empathy in negotiation as an explicit repeatable protocol.
