...
description: "Uses quantitative reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Quantitative Reasoning."
---
...
## Activation
- Use when the user explicitly asks for quantitative reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with quantitative reasoning.
...
- Primary capability: Quantitative Reasoning.
- Primary domain: finance investment.
- Apply quantitative reasoning as an explicit repeatable protocol.
