---
name: metacognition
description: "Uses metacognition as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Metacognition."
---
...
## Activation
- Use when the user explicitly asks for metacognition.
- Use when a task would materially benefit from the methods, standards, or operating style associated with metacognition.
...
- Primary capability: Metacognition.
- Primary domain: general.
- Apply metacognition as an explicit repeatable protocol.
