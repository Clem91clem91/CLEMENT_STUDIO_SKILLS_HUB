---
name: reservation-value-definition
description: "Applies reservation value definition to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Reservation Value Definition."
---
...
## Activation
- Use when the user explicitly asks for reservation value definition.
- Use when a task would materially benefit from the methods, standards, or operating style associated with reservation value definition.
...
- Primary capability: Reservation Value Definition.
- Primary domain: negotiation deals.
- Apply reservation value definition as an explicit repeatable protocol.
