...
description: "Uses executive communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Executive Communication."
---
...
## Activation
- Use when the user explicitly asks for executive communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with executive communication.
...
- Primary capability: Executive Communication.
- Primary domain: communication people.
- Apply executive communication as an explicit repeatable protocol.
