...
description: "Uses conference presenting to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Conference Presenting."
---
...
## Activation
- Use when the user explicitly asks for conference presenting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with conference presenting.
...
- Primary capability: Conference Presenting.
- Primary domain: communication people.
- Apply conference presenting as an explicit repeatable protocol.
