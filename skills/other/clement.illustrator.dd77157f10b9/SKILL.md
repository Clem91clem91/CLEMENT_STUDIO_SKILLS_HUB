---
name: illustrator
description: "Applies the Illustrator professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Illustrator."
---
...
## Activation
- Use when the user explicitly asks for illustrator.
- Use when a task would materially benefit from the methods, standards, or operating style associated with illustrator.
...
- Primary capability: Illustrator.
