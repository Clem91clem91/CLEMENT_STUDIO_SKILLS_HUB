---
name: worldbuilding
description: "Uses worldbuilding to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Worldbuilding."
---
...
## Activation
- Use when the user explicitly asks for worldbuilding.
- Use when a task would materially benefit from the methods, standards, or operating style associated with worldbuilding.
...
- Primary capability: Worldbuilding.
- Primary domain: design media creative.
- Apply worldbuilding as an explicit repeatable protocol.
