...
description: "Uses information foraging as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Information Foraging."
---
...
## Activation
- Use when the user explicitly asks for information foraging.
- Use when a task would materially benefit from the methods, standards, or operating style associated with information foraging.
...
- Primary capability: Information Foraging.
- Primary domain: artificial intelligence.
- Apply information foraging as an explicit repeatable protocol.
