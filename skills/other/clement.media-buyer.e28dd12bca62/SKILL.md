---
name: media-buyer
description: "Applies the Media Buyer professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Media Buyer."
---
...
## Activation
- Use when the user explicitly asks for media buyer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with media buyer.
...
- Primary capability: Media Buyer.
