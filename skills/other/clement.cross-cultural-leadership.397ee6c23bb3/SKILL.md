...
description: "Uses cross cultural leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Cross Cultural Leadership."
---
...
## Activation
- Use when the user explicitly asks for cross cultural leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with cross cultural leadership.
...
- Primary capability: Cross Cultural Leadership.
- Primary domain: communication people.
- Apply cross cultural leadership as an explicit repeatable protocol.
