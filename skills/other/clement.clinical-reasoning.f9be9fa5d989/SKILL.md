...
description: "Uses clinical reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Clinical Reasoning."
---
...
## Activation
- Use when the user explicitly asks for clinical reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with clinical reasoning.
...
- Primary capability: Clinical Reasoning.
- Primary domain: general.
- Apply clinical reasoning as an explicit repeatable protocol.
