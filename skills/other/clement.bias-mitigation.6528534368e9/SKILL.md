...
description: "Uses bias mitigation as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Bias Mitigation."
---
...
## Activation
- Use when the user explicitly asks for bias mitigation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with bias mitigation.
...
- Primary capability: Bias Mitigation.
- Primary domain: general.
- Apply bias mitigation as an explicit repeatable protocol.
