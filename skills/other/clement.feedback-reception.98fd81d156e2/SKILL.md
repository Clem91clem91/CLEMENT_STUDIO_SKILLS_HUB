...
description: "Uses feedback reception to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Feedback Reception."
---
...
## Activation
- Use when the user explicitly asks for feedback reception.
- Use when a task would materially benefit from the methods, standards, or operating style associated with feedback reception.
...
- Primary capability: Feedback Reception.
- Primary domain: communication people.
- Apply feedback reception as an explicit repeatable protocol.
