...
description: "Applies the Facility Manager professional role to plan, execute, review, and deliver reliable construction engineering work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Facility Manager."
---
...
## Activation
- Use when the user explicitly asks for facility manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with facility manager.
...
- Primary capability: Facility Manager.
