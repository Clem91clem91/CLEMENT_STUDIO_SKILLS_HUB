...
description: "Uses leadership resilience to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Leadership Resilience."
---
...
## Activation
- Use when the user explicitly asks for leadership resilience.
- Use when a task would materially benefit from the methods, standards, or operating style associated with leadership resilience.
...
- Primary capability: Leadership Resilience.
- Primary domain: communication people.
- Apply leadership resilience as an explicit repeatable protocol.
