...
description: "Uses message structuring to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Message Structuring."
---
...
## Activation
- Use when the user explicitly asks for message structuring.
- Use when a task would materially benefit from the methods, standards, or operating style associated with message structuring.
...
- Primary capability: Message Structuring.
- Primary domain: communication people.
- Apply message structuring as an explicit repeatable protocol.
