...
description: "Uses commercial leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Commercial Leadership."
---
...
## Activation
- Use when the user explicitly asks for commercial leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with commercial leadership.
...
- Primary capability: Commercial Leadership.
- Primary domain: communication people.
- Apply commercial leadership as an explicit repeatable protocol.
