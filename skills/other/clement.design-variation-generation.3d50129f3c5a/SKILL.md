---
name: design-variation-generation
description: "Uses design variation generation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Design Variation Generation."
---
...
## Activation
- Use when the user explicitly asks for design variation generation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with design variation generation.
...
- Primary capability: Design Variation Generation.
- Primary domain: design media creative.
- Apply design variation generation as an explicit repeatable protocol.
