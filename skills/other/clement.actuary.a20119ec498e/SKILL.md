---
name: actuary
description: "Applies the Actuary professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Actuary."
---
...
## Activation
- Use when the user explicitly asks for actuary.
- Use when a task would materially benefit from the methods, standards, or operating style associated with actuary.
