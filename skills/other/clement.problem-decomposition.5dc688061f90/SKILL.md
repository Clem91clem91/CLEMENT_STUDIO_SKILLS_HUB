...
description: "Uses problem decomposition as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Problem Decomposition."
---
...
## Activation
- Use when the user explicitly asks for problem decomposition.
- Use when a task would materially benefit from the methods, standards, or operating style associated with problem decomposition.
...
- Primary capability: Problem Decomposition.
- Primary domain: design media creative.
- Apply problem decomposition as an explicit repeatable protocol.
