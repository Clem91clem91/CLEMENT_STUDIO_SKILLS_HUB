---
name: vision-setting
description: "Uses vision setting to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Vision Setting."
---
...
## Activation
- Use when the user explicitly asks for vision setting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with vision setting.
...
- Primary capability: Vision Setting.
- Primary domain: artificial intelligence.
- Apply vision setting as an explicit repeatable protocol.
