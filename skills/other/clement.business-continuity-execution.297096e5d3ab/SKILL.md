---
name: business-continuity-execution
description: "Applies business continuity execution to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Business Continuity Execution."
---
...
## Activation
- Use when the user explicitly asks for business continuity execution.
- Use when a task would materially benefit from the methods, standards, or operating style associated with business continuity execution.
...
- Primary capability: Business Continuity Execution.
- Primary domain: operations management.
- Apply business continuity execution as an explicit repeatable protocol.
