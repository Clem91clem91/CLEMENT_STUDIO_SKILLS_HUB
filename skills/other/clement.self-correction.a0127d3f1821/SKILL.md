...
description: "Uses self correction as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Self Correction."
---
...
## Activation
- Use when the user explicitly asks for self correction.
- Use when a task would materially benefit from the methods, standards, or operating style associated with self correction.
...
- Primary capability: Self Correction.
- Primary domain: general.
- Apply self correction as an explicit repeatable protocol.
