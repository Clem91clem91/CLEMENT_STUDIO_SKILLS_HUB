...
description: "Uses hypothesis generation as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Hypothesis Generation."
---
...
## Activation
- Use when the user explicitly asks for hypothesis generation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with hypothesis generation.
...
- Primary capability: Hypothesis Generation.
- Primary domain: general.
- Apply hypothesis generation as an explicit repeatable protocol.
