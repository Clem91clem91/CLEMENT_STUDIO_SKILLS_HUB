...
description: "Applies the Graphic Designer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Graphic Designer."
---
...
## Activation
- Use when the user explicitly asks for graphic designer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with graphic designer.
...
- Primary capability: Graphic Designer.
