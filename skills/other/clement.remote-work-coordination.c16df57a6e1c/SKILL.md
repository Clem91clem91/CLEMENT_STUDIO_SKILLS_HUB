---
name: remote-work-coordination
description: "Applies remote work coordination to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Remote Work Coordination."
---
...
## Activation
- Use when the user explicitly asks for remote work coordination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with remote work coordination.
...
- Primary capability: Remote Work Coordination.
- Primary domain: operations management.
- Apply remote work coordination as an explicit repeatable protocol.
