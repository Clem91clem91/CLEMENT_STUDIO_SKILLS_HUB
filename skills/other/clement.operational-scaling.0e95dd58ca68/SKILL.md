...
description: "Applies operational scaling to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Operational Scaling."
---
...
## Activation
- Use when the user explicitly asks for operational scaling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with operational scaling.
...
- Primary capability: Operational Scaling.
- Primary domain: operations management.
- Apply operational scaling as an explicit repeatable protocol.
