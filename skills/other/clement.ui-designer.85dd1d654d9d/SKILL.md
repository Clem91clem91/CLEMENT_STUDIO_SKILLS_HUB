---
name: ui-designer
description: "Applies the UI Designer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving UI Designer."
---
...
## Activation
- Use when the user explicitly asks for ui designer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ui designer.
...
- Primary capability: UI Designer.
