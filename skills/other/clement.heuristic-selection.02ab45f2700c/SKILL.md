...
description: "Uses heuristic selection as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Heuristic Selection."
---
...
## Activation
- Use when the user explicitly asks for heuristic selection.
- Use when a task would materially benefit from the methods, standards, or operating style associated with heuristic selection.
...
- Primary capability: Heuristic Selection.
- Primary domain: general.
- Apply heuristic selection as an explicit repeatable protocol.
