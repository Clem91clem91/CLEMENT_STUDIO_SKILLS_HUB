...
description: "Uses divergent thinking to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Divergent Thinking."
---
...
## Activation
- Use when the user explicitly asks for divergent thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with divergent thinking.
...
- Primary capability: Divergent Thinking.
- Primary domain: design media creative.
- Apply divergent thinking as an explicit repeatable protocol.
