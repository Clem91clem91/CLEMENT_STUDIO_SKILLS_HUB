...
description: "Uses rule based reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Rule Based Reasoning."
---
...
## Activation
- Use when the user explicitly asks for rule based reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with rule based reasoning.
...
- Primary capability: Rule Based Reasoning.
- Primary domain: general.
- Apply rule based reasoning as an explicit repeatable protocol.
