---
name: accountant
description: "Applies the Accountant professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Accountant."
---
...
## Activation
- Use when the user explicitly asks for accountant.
- Use when a task would materially benefit from the methods, standards, or operating style associated with accountant.
