...
description: "Applies workload balancing to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Workload Balancing."
---
...
## Activation
- Use when the user explicitly asks for workload balancing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with workload balancing.
...
- Primary capability: Workload Balancing.
- Primary domain: operations management.
- Apply workload balancing as an explicit repeatable protocol.
