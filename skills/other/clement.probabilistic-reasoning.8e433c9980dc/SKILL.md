...
description: "Uses probabilistic reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Probabilistic Reasoning."
---
...
## Activation
- Use when the user explicitly asks for probabilistic reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with probabilistic reasoning.
...
- Primary capability: Probabilistic Reasoning.
- Primary domain: general.
- Apply probabilistic reasoning as an explicit repeatable protocol.
