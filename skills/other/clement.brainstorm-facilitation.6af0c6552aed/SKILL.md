...
description: "Uses brainstorm facilitation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Brainstorm Facilitation."
---
...
## Activation
- Use when the user explicitly asks for brainstorm facilitation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with brainstorm facilitation.
...
- Primary capability: Brainstorm Facilitation.
- Primary domain: artificial intelligence.
- Apply brainstorm facilitation as an explicit repeatable protocol.
