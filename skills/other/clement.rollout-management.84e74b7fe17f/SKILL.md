...
description: "Applies rollout management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Rollout Management."
---
...
## Activation
- Use when the user explicitly asks for rollout management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with rollout management.
...
- Primary capability: Rollout Management.
- Primary domain: operations management.
- Apply rollout management as an explicit repeatable protocol.
