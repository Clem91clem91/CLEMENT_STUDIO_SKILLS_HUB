...
description: "Uses feedback loop reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Feedback Loop Reasoning."
---
...
## Activation
- Use when the user explicitly asks for feedback loop reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with feedback loop reasoning.
...
- Primary capability: Feedback Loop Reasoning.
- Primary domain: communication people.
- Apply feedback loop reasoning as an explicit repeatable protocol.
