...
description: "Uses uncertainty management as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Uncertainty Management."
---
...
## Activation
- Use when the user explicitly asks for uncertainty management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with uncertainty management.
...
- Primary capability: Uncertainty Management.
- Primary domain: operations management.
- Apply uncertainty management as an explicit repeatable protocol.
