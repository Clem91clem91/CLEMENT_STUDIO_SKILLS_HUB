...
description: "Applies multi team coordination to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Multi Team Coordination."
---
...
## Activation
- Use when the user explicitly asks for multi team coordination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with multi team coordination.
...
- Primary capability: Multi Team Coordination.
- Primary domain: operations management.
- Apply multi team coordination as an explicit repeatable protocol.
