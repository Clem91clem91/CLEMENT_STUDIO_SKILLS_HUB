...
description: "Uses technical storytelling to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Technical Storytelling."
---
...
## Activation
- Use when the user explicitly asks for technical storytelling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with technical storytelling.
...
- Primary capability: Technical Storytelling.
- Primary domain: communication people.
- Apply technical storytelling as an explicit repeatable protocol.
