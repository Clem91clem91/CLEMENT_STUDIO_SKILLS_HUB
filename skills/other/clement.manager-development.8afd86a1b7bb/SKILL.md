...
description: "Uses manager development to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Manager Development."
---
...
## Activation
- Use when the user explicitly asks for manager development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with manager development.
...
- Primary capability: Manager Development.
- Primary domain: operations management.
- Apply manager development as an explicit repeatable protocol.
