---
name: stakeholder-update-cadence
description: "Applies stakeholder update cadence to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Stakeholder Update Cadence."
---
...
## Activation
- Use when the user explicitly asks for stakeholder update cadence.
- Use when a task would materially benefit from the methods, standards, or operating style associated with stakeholder update cadence.
...
- Primary capability: Stakeholder Update Cadence.
- Primary domain: operations management.
- Apply stakeholder update cadence as an explicit repeatable protocol.
