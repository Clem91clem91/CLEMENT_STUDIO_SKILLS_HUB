...
description: "Uses root cause reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Root Cause Reasoning."
---
...
## Activation
- Use when the user explicitly asks for root cause reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with root cause reasoning.
...
- Primary capability: Root Cause Reasoning.
- Primary domain: general.
- Apply root cause reasoning as an explicit repeatable protocol.
