---
name: web-designer
description: "Applies the Web Designer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Web Designer."
---
...
## Activation
- Use when the user explicitly asks for web designer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with web designer.
...
- Primary capability: Web Designer.
