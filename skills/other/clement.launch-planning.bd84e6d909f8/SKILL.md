...
description: "Applies launch planning to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Launch Planning."
---
...
## Activation
- Use when the user explicitly asks for launch planning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with launch planning.
...
- Primary capability: Launch Planning.
- Primary domain: operations management.
- Apply launch planning as an explicit repeatable protocol.
