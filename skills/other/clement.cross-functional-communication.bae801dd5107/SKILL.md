...
description: "Uses cross functional communication to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Cross Functional Communication."
---
...
## Activation
- Use when the user explicitly asks for cross functional communication.
- Use when a task would materially benefit from the methods, standards, or operating style associated with cross functional communication.
...
- Primary capability: Cross Functional Communication.
- Primary domain: communication people.
- Apply cross functional communication as an explicit repeatable protocol.
