---
name: zopa-identification
description: "Applies zopa identification to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Zopa Identification."
---
...
## Activation
- Use when the user explicitly asks for zopa identification.
- Use when a task would materially benefit from the methods, standards, or operating style associated with zopa identification.
...
- Primary capability: Zopa Identification.
- Primary domain: negotiation deals.
- Apply zopa identification as an explicit repeatable protocol.
