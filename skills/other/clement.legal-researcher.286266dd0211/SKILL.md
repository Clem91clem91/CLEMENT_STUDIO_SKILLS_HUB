...
description: "Applies the Legal Researcher professional role to plan, execute, review, and deliver reliable legal compliance work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Legal Researcher."
---
...
## Activation
- Use when the user explicitly asks for legal researcher.
- Use when a task would materially benefit from the methods, standards, or operating style associated with legal researcher.
...
- Primary capability: Legal Researcher.
