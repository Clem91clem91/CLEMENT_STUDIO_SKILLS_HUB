...
description: "Applies cross cultural negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Cross Cultural Negotiation."
---
...
## Activation
- Use when the user explicitly asks for cross cultural negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with cross cultural negotiation.
...
- Primary capability: Cross Cultural Negotiation.
- Primary domain: negotiation deals.
- Apply cross cultural negotiation as an explicit repeatable protocol.
