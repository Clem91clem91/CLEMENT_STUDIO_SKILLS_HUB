---
name: long-horizon-thinking
description: "Uses long horizon thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Long Horizon Thinking."
---
...
## Activation
- Use when the user explicitly asks for long horizon thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with long horizon thinking.
...
- Primary capability: Long Horizon Thinking.
- Primary domain: general.
- Apply long horizon thinking as an explicit repeatable protocol.
