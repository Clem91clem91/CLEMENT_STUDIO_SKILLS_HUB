---
name: question-led-negotiation
description: "Applies question led negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Question Led Negotiation."
---

# Question Led Negotiation
...
## Activation
- Use when the user explicitly asks for question led negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with question led negotiation.
...
- Primary capability: Question Led Negotiation.
- Primary domain: negotiation deals.
- Apply question led negotiation as an explicit repeatable protocol.
