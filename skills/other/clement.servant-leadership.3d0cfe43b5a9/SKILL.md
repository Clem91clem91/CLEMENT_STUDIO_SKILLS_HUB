...
description: "Uses servant leadership to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Servant Leadership."
---
...
## Activation
- Use when the user explicitly asks for servant leadership.
- Use when a task would materially benefit from the methods, standards, or operating style associated with servant leadership.
...
- Primary capability: Servant Leadership.
- Primary domain: communication people.
- Apply servant leadership as an explicit repeatable protocol.
