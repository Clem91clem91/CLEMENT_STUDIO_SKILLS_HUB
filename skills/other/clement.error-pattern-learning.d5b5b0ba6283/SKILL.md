...
description: "Uses error pattern learning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Error Pattern Learning."
---
...
## Activation
- Use when the user explicitly asks for error pattern learning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with error pattern learning.
...
- Primary capability: Error Pattern Learning.
- Primary domain: artificial intelligence.
- Apply error pattern learning as an explicit repeatable protocol.
