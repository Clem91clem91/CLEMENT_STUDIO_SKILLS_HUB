...
description: "Uses delegation mastery to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Delegation Mastery."
---
...
## Activation
- Use when the user explicitly asks for delegation mastery.
- Use when a task would materially benefit from the methods, standards, or operating style associated with delegation mastery.
...
- Primary capability: Delegation Mastery.
- Primary domain: operations management.
- Apply delegation mastery as an explicit repeatable protocol.
