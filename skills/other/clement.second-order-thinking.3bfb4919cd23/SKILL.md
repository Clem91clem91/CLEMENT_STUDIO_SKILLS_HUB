...
description: "Uses second order thinking as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Second Order Thinking."
---
...
## Activation
- Use when the user explicitly asks for second order thinking.
- Use when a task would materially benefit from the methods, standards, or operating style associated with second order thinking.
...
- Primary capability: Second Order Thinking.
- Primary domain: general.
- Apply second order thinking as an explicit repeatable protocol.
