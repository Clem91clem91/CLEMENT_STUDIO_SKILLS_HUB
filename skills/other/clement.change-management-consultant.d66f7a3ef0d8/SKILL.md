...
description: "Applies the Change Management Consultant professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Change Management Consultant."
---
...
## Activation
- Use when the user explicitly asks for change management consultant.
- Use when a task would materially benefit from the methods, standards, or operating style associated with change management consultant.
...
- Primary capability: Change Management Consultant.
