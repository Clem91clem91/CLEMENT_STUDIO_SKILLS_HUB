...
description: "Applies the Program Manager professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Program Manager."
---
...
## Activation
- Use when the user explicitly asks for program manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with program manager.
...
- Primary capability: Program Manager.
