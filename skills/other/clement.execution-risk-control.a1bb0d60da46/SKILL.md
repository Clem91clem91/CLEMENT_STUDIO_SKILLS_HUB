---
name: execution-risk-control
description: "Applies execution risk control to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Execution Risk Control."
---
...
## Activation
- Use when the user explicitly asks for execution risk control.
- Use when a task would materially benefit from the methods, standards, or operating style associated with execution risk control.
...
- Primary capability: Execution Risk Control.
- Primary domain: operations management.
- Apply execution risk control as an explicit repeatable protocol.
