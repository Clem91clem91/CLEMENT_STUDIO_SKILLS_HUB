...
description: "Applies the Systems Administrator professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Systems Administrator."
---
...
## Activation
- Use when the user explicitly asks for systems administrator.
- Use when a task would materially benefit from the methods, standards, or operating style associated with systems administrator.
...
- Primary capability: Systems Administrator.
- Primary domain: software cloud.
- Maintain reliable systems, permissions, configuration, records, and continuity.
- Automate repeatable operations safely.
- Document recovery and support.
