...
description: "Performs investment analysis through traceable evidence, appropriate methods, robustness checks, calibrated findings, and decision-ready recommendations. Use for tasks explicitly involving Investment Analysis."
---
...
## Activation
- Use when the user explicitly asks for investment analysis.
- Use when a task would materially benefit from the methods, standards, or operating style associated with investment analysis.
...
- Primary capability: Investment Analysis.
- Primary domain: finance investment.
- Apply investment analysis as an explicit repeatable protocol.
