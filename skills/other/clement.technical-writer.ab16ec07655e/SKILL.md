...
description: "Applies the Technical Writer professional role to plan, execute, review, and deliver reliable design media creative work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Technical Writer."
---
...
## Activation
- Use when the user explicitly asks for technical writer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with technical writer.
...
- Primary capability: Technical Writer.
