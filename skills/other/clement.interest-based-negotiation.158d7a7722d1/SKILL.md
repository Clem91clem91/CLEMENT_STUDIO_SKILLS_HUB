...
description: "Applies interest based negotiation to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Interest Based Negotiation."
---
...
## Activation
- Use when the user explicitly asks for interest based negotiation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with interest based negotiation.
...
- Primary capability: Interest Based Negotiation.
- Primary domain: software cloud.
- Apply interest based negotiation as an explicit repeatable protocol.
