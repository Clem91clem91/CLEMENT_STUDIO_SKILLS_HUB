---
name: campaign-concept-creation
description: "Uses campaign concept creation to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Campaign Concept Creation."
---
...
## Activation
- Use when the user explicitly asks for campaign concept creation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with campaign concept creation.
...
- Primary capability: Campaign Concept Creation.
- Primary domain: sales marketing customer.
- Apply campaign concept creation as an explicit repeatable protocol.
