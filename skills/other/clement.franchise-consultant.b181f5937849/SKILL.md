...
description: "Applies the Franchise Consultant professional role to plan, execute, review, and deliver reliable operations management work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Franchise Consultant."
---
...
## Activation
- Use when the user explicitly asks for franchise consultant.
- Use when a task would materially benefit from the methods, standards, or operating style associated with franchise consultant.
...
- Primary capability: Franchise Consultant.
