...
description: "Uses professional email writing to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Professional Email Writing."
---
...
## Activation
- Use when the user explicitly asks for professional email writing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with professional email writing.
...
- Primary capability: Professional Email Writing.
- Primary domain: sales marketing customer.
- Apply professional email writing as an explicit repeatable protocol.
