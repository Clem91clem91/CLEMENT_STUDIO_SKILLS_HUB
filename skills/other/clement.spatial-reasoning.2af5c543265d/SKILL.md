...
description: "Uses spatial reasoning as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Spatial Reasoning."
---
...
## Activation
- Use when the user explicitly asks for spatial reasoning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with spatial reasoning.
...
- Primary capability: Spatial Reasoning.
- Primary domain: general.
- Apply spatial reasoning as an explicit repeatable protocol.
