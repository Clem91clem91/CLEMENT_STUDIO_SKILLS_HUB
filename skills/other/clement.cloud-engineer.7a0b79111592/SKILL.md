---
name: cloud-engineer
description: "Applies the Cloud Engineer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Cloud Engineer."
---
...
## Activation
- Use when the user explicitly asks for cloud engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with cloud engineer.
...
- Primary capability: Cloud Engineer.
