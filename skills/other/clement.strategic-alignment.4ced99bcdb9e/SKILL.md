...
description: "Uses strategic alignment to align mission, people, ownership, decisions, operating cadence, culture, and measurable outcomes. Use for tasks explicitly involving Strategic Alignment."
---
...
## Activation
- Use when the user explicitly asks for strategic alignment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with strategic alignment.
...
- Primary capability: Strategic Alignment.
- Primary domain: operations management.
- Apply strategic alignment as an explicit repeatable protocol.
