---
name: sales-manager
description: "Applies the Sales Manager professional role to plan, execute, review, and deliver reliable sales marketing customer work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Sales Manager."
---
...
## Activation
- Use when the user explicitly asks for sales manager.
- Use when a task would materially benefit from the methods, standards, or operating style associated with sales manager.
...
- Primary capability: Sales Manager.
