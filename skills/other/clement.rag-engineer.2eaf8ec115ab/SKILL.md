---
name: rag-engineer
description: "Applies the RAG Engineer professional role to plan, execute, review, and deliver reliable artificial intelligence work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving RAG Engineer."
---
...
## Activation
- Use when the user explicitly asks for rag engineer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with rag engineer.
...
- Primary capability: RAG Engineer.
