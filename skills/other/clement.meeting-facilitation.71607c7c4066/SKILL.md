...
description: "Uses meeting facilitation to create clear, accurate, audience-aware communication with an explicit objective, channel, tone, action, and feedback loop. Use for tasks explicitly involving Meeting Facilitation."
---
...
## Activation
- Use when the user explicitly asks for meeting facilitation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with meeting facilitation.
...
- Primary capability: Meeting Facilitation.
- Primary domain: operations management.
- Apply meeting facilitation as an explicit repeatable protocol.
