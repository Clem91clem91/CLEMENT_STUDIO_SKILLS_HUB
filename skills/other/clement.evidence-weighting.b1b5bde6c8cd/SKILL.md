...
description: "Uses evidence weighting as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Evidence Weighting."
---
...
## Activation
- Use when the user explicitly asks for evidence weighting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with evidence weighting.
...
- Primary capability: Evidence Weighting.
- Primary domain: general.
- Apply evidence weighting as an explicit repeatable protocol.
