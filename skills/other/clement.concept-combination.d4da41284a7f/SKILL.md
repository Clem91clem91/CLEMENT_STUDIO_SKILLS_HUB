---
name: concept-combination
description: "Uses concept combination to generate, select, develop, and test original concepts that fit the brief, audience, rights, and execution constraints. Use for tasks explicitly involving Concept Combination."
---
...
## Activation
- Use when the user explicitly asks for concept combination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with concept combination.
...
- Primary capability: Concept Combination.
- Primary domain: design media creative.
- Apply concept combination as an explicit repeatable protocol.
