...
description: "Applies follow up management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Follow Up Management."
---
...
## Activation
- Use when the user explicitly asks for follow up management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with follow up management.
...
- Primary capability: Follow Up Management.
- Primary domain: operations management.
- Apply follow up management as an explicit repeatable protocol.
