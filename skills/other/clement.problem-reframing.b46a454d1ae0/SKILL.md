...
description: "Uses problem reframing as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Problem Reframing."
---
...
## Activation
- Use when the user explicitly asks for problem reframing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with problem reframing.
...
- Primary capability: Problem Reframing.
- Primary domain: general.
- Apply problem reframing as an explicit repeatable protocol.
