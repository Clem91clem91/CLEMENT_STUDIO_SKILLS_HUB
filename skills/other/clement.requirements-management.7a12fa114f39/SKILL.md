...
description: "Applies requirements management to convert objectives into structured work, clear ownership, measurable progress, quality control, and documented completion. Use for tasks explicitly involving Requirements Management."
---
...
## Activation
- Use when the user explicitly asks for requirements management.
- Use when a task would materially benefit from the methods, standards, or operating style associated with requirements management.
...
- Primary capability: Requirements Management.
- Primary domain: operations management.
- Apply requirements management as an explicit repeatable protocol.
