---
name: data-analyst
description: "Applies the Data Analyst professional role to plan, execute, review, and deliver reliable data analytics work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Data Analyst."
---
...
## Activation
- Use when the user explicitly asks for data analyst.
- Use when a task would materially benefit from the methods, standards, or operating style associated with data analyst.
...
- Primary capability: Data Analyst.
