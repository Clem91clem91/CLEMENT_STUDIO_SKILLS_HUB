...
description: "Applies negotiation strategy design to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Negotiation Strategy Design."
---
...
## Activation
- Use when the user explicitly asks for negotiation strategy design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with negotiation strategy design.
...
- Primary capability: Negotiation Strategy Design.
- Primary domain: design media creative.
- Apply negotiation strategy design as an explicit repeatable protocol.
