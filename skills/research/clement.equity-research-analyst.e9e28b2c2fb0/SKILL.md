...
description: "Applies the Equity Research Analyst professional role to plan, execute, review, and deliver reliable finance investment work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Equity Research Analyst."
---
...
## Activation
- Use when the user explicitly asks for equity research analyst.
- Use when a task would materially benefit from the methods, standards, or operating style associated with equity research analyst.
...
- Primary capability: Equity Research Analyst.
