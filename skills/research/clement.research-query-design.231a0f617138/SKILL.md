---
name: research-query-design
description: "Uses research query design as a structured reasoning protocol to improve framing, evidence use, alternatives, uncertainty calibration, and decision quality. Use for tasks explicitly involving Research Query Design."
---
...
## Activation
- Use when the user explicitly asks for research query design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with research query design.
...
- Primary capability: Research Query Design.
- Primary domain: design media creative.
- Apply research query design as an explicit repeatable protocol.
