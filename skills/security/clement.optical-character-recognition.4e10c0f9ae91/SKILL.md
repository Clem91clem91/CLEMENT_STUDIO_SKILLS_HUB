...
description: "Designs, implements, tests, documents, and operates solutions using Optical Character Recognition, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Optical Character Recognition."
---
...
## Activation
- Use when the user explicitly asks for optical character recognition.
- Use when a task would materially benefit from the methods, standards, or operating style associated with optical character recognition.
...
- Primary capability: Optical Character Recognition.
- Primary domain: design media creative.
- Use Optical Character Recognition only after confirming environment and version compatibility.
