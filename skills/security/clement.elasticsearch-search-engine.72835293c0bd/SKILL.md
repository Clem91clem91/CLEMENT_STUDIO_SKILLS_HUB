...
description: "Designs, implements, tests, documents, and operates solutions using Elasticsearch Search Engine, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Elasticsearch Search Engine."
---
...
## Activation
- Use when the user explicitly asks for elasticsearch search engine.
- Use when a task would materially benefit from the methods, standards, or operating style associated with elasticsearch search engine.
...
- Primary capability: Elasticsearch Search Engine.
- Primary domain: software cloud.
- Use Elasticsearch Search Engine only after confirming environment and version compatibility.
