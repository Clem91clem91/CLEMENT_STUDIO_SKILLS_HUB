...
description: "Designs, implements, tests, documents, and operates solutions using Figma Interface Design, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Figma Interface Design."
---
...
## Activation
- Use when the user explicitly asks for figma interface design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with figma interface design.
...
- Primary capability: Figma Interface Design.
- Primary domain: design media creative.
- Use Figma Interface Design only after confirming environment and version compatibility.
