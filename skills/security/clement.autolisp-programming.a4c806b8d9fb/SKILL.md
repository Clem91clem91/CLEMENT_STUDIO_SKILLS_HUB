---
name: autolisp-programming
description: "Designs, implements, tests, documents, and operates solutions using Autolisp Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Autolisp Programming."
---
...
## Activation
- Use when the user explicitly asks for autolisp programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with autolisp programming.
...
- Primary capability: Autolisp Programming.
- Primary domain: operations management.
- Use Autolisp Programming only after confirming environment and version compatibility.
