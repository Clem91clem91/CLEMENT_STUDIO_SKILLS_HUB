...
description: "Designs, implements, tests, documents, and operates solutions using Google Cloud Platform, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Google Cloud Platform."
---
...
## Activation
- Use when the user explicitly asks for google cloud platform.
- Use when a task would materially benefit from the methods, standards, or operating style associated with google cloud platform.
...
- Primary capability: Google Cloud Platform.
- Primary domain: software cloud.
- Use Google Cloud Platform only after confirming environment and version compatibility.
