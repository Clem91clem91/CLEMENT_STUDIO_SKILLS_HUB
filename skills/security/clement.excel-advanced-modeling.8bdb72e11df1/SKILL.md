...
description: "Designs, implements, tests, documents, and operates solutions using Excel Advanced Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Excel Advanced Modeling."
---
...
## Activation
- Use when the user explicitly asks for excel advanced modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with excel advanced modeling.
...
- Primary capability: Excel Advanced Modeling.
- Primary domain: artificial intelligence.
- Use Excel Advanced Modeling only after confirming environment and version compatibility.
