...
description: "Designs, implements, tests, documents, and operates solutions using AWS Cloud Services, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving AWS Cloud Services."
---
...
## Activation
- Use when the user explicitly asks for aws cloud services.
- Use when a task would materially benefit from the methods, standards, or operating style associated with aws cloud services.
...
- Primary capability: AWS Cloud Services.
- Primary domain: software cloud.
- Use AWS Cloud Services only after confirming environment and version compatibility.
