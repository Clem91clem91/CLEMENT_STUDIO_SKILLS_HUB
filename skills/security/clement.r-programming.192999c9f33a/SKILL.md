---
name: r-programming
description: "Designs, implements, tests, documents, and operates solutions using R Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving R Programming."
---
...
## Activation
- Use when the user explicitly asks for r programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with r programming.
...
- Primary capability: R Programming.
- Primary domain: operations management.
- Use R Programming only after confirming environment and version compatibility.
