...
description: "Designs, implements, tests, documents, and operates solutions using Next.js Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Next.js Development."
---
...
## Activation
- Use when the user explicitly asks for next.js development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with next.js development.
...
- Primary capability: Next.js Development.
- Primary domain: software cloud.
- Use Next.js Development only after confirming environment and version compatibility.
