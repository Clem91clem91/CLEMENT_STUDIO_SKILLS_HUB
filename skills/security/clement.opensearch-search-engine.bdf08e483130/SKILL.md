...
description: "Designs, implements, tests, documents, and operates solutions using Opensearch Search Engine, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Opensearch Search Engine."
---
...
## Activation
- Use when the user explicitly asks for opensearch search engine.
- Use when a task would materially benefit from the methods, standards, or operating style associated with opensearch search engine.
...
- Primary capability: Opensearch Search Engine.
- Primary domain: software cloud.
- Use Opensearch Search Engine only after confirming environment and version compatibility.
