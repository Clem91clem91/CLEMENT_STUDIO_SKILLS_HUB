...
description: "Designs, implements, tests, documents, and operates solutions using Laravel Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Laravel Development."
---
...
## Activation
- Use when the user explicitly asks for laravel development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with laravel development.
...
- Primary capability: Laravel Development.
- Primary domain: software cloud.
- Use Laravel Development only after confirming environment and version compatibility.
