...
description: "Designs, implements, tests, documents, and operates solutions using Adobe Illustrator, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Adobe Illustrator."
---
...
## Activation
- Use when the user explicitly asks for adobe illustrator.
- Use when a task would materially benefit from the methods, standards, or operating style associated with adobe illustrator.
...
- Primary capability: Adobe Illustrator.
- Primary domain: design media creative.
- Use Adobe Illustrator only after confirming environment and version compatibility.
