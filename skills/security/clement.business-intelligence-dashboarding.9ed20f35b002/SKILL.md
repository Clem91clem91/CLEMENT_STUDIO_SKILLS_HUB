...
description: "Designs, implements, tests, documents, and operates solutions using Business Intelligence Dashboarding, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Business Intelligence Dashboarding."
---
...
## Activation
- Use when the user explicitly asks for business intelligence dashboarding.
- Use when a task would materially benefit from the methods, standards, or operating style associated with business intelligence dashboarding.
...
- Primary capability: Business Intelligence Dashboarding.
- Primary domain: software cloud.
- Use Business Intelligence Dashboarding only after confirming environment and version compatibility.
