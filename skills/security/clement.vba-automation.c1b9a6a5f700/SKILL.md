---
name: vba-automation
description: "Designs, implements, tests, documents, and operates solutions using VBA Automation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving VBA Automation."
---
...
## Activation
- Use when the user explicitly asks for vba automation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with vba automation.
...
- Primary capability: VBA Automation.
- Primary domain: software cloud.
- Use VBA Automation only after confirming environment and version compatibility.
