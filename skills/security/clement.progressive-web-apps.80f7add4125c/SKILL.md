...
description: "Designs, implements, tests, documents, and operates solutions using Progressive Web Apps, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Progressive Web Apps."
---
...
## Activation
- Use when the user explicitly asks for progressive web apps.
- Use when a task would materially benefit from the methods, standards, or operating style associated with progressive web apps.
...
- Primary capability: Progressive Web Apps.
- Primary domain: design media creative.
- Use Progressive Web Apps only after confirming environment and version compatibility.
