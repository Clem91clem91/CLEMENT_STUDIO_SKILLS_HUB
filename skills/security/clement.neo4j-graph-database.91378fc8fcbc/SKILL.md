...
description: "Designs, implements, tests, documents, and operates solutions using Neo4j Graph Database, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Neo4j Graph Database."
---
...
## Activation
- Use when the user explicitly asks for neo4j graph database.
- Use when a task would materially benefit from the methods, standards, or operating style associated with neo4j graph database.
...
- Primary capability: Neo4j Graph Database.
- Primary domain: data analytics.
- Use Neo4j Graph Database only after confirming environment and version compatibility.
