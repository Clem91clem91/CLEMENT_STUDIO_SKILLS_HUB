...
description: "Designs, implements, tests, documents, and operates solutions using Weaviate Vector Database, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Weaviate Vector Database."
---
...
## Activation
- Use when the user explicitly asks for weaviate vector database.
- Use when a task would materially benefit from the methods, standards, or operating style associated with weaviate vector database.
...
- Primary capability: Weaviate Vector Database.
- Primary domain: data analytics.
- Use Weaviate Vector Database only after confirming environment and version compatibility.
