---
name: apache-kafka
description: "Designs, implements, tests, documents, and operates solutions using Apache Kafka, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Apache Kafka."
---
...
## Activation
- Use when the user explicitly asks for apache kafka.
- Use when a task would materially benefit from the methods, standards, or operating style associated with apache kafka.
...
- Primary capability: Apache Kafka.
- Primary domain: data analytics.
- Use Apache Kafka only after confirming environment and version compatibility.
