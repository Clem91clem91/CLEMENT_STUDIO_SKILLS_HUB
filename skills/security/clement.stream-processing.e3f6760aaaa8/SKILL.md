...
description: "Designs, implements, tests, documents, and operates solutions using Stream Processing, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Stream Processing."
---
...
## Activation
- Use when the user explicitly asks for stream processing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with stream processing.
...
- Primary capability: Stream Processing.
- Primary domain: construction engineering.
- Use Stream Processing only after confirming environment and version compatibility.
