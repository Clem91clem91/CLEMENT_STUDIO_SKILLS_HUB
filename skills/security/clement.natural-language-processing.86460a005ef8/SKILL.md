...
description: "Designs, implements, tests, documents, and operates solutions using Natural Language Processing, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Natural Language Processing."
---
...
## Activation
- Use when the user explicitly asks for natural language processing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with natural language processing.
...
- Primary capability: Natural Language Processing.
- Primary domain: construction engineering.
- Use Natural Language Processing only after confirming environment and version compatibility.
