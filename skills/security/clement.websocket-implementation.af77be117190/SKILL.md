...
description: "Designs, implements, tests, documents, and operates solutions using Websocket Implementation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Websocket Implementation."
---
...
## Activation
- Use when the user explicitly asks for websocket implementation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with websocket implementation.
...
- Primary capability: Websocket Implementation.
- Primary domain: software cloud.
- Use Websocket Implementation only after confirming environment and version compatibility.
