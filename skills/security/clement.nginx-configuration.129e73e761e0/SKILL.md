...
description: "Designs, implements, tests, documents, and operates solutions using Nginx Configuration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Nginx Configuration."
---
...
## Activation
- Use when the user explicitly asks for nginx configuration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with nginx configuration.
...
- Primary capability: Nginx Configuration.
- Primary domain: software cloud.
- Use Nginx Configuration only after confirming environment and version compatibility.
