...
description: "Designs, implements, tests, documents, and operates solutions using Data Warehouse Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Data Warehouse Modeling."
---
...
## Activation
- Use when the user explicitly asks for data warehouse modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with data warehouse modeling.
...
- Primary capability: Data Warehouse Modeling.
- Primary domain: data analytics.
- Use Data Warehouse Modeling only after confirming environment and version compatibility.
