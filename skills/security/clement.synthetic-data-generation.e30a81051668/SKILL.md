...
description: "Designs, implements, tests, documents, and operates solutions using Synthetic Data Generation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Synthetic Data Generation."
---
...
## Activation
- Use when the user explicitly asks for synthetic data generation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with synthetic data generation.
...
- Primary capability: Synthetic Data Generation.
- Primary domain: artificial intelligence.
- Use Synthetic Data Generation only after confirming environment and version compatibility.
