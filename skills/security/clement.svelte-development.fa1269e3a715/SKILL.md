...
description: "Designs, implements, tests, documents, and operates solutions using Svelte Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Svelte Development."
---
...
## Activation
- Use when the user explicitly asks for svelte development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with svelte development.
...
- Primary capability: Svelte Development.
- Primary domain: software cloud.
- Use Svelte Development only after confirming environment and version compatibility.
