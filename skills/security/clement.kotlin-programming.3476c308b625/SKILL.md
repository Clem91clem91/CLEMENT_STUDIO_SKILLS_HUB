...
description: "Designs, implements, tests, documents, and operates solutions using Kotlin Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Kotlin Programming."
---
...
## Activation
- Use when the user explicitly asks for kotlin programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with kotlin programming.
...
- Primary capability: Kotlin Programming.
- Primary domain: software cloud.
- Use Kotlin Programming only after confirming environment and version compatibility.
