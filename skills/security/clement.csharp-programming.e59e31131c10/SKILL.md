---
name: csharp-programming
description: "Designs, implements, tests, documents, and operates solutions using C# Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving C# Programming."
---
...
## Activation
- Use when the user explicitly asks for c# programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with c# programming.
...
- Primary capability: C# Programming.
- Primary domain: software cloud.
- Use C# Programming only after confirming environment and version compatibility.
