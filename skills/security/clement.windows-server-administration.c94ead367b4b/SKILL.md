...
description: "Designs, implements, tests, documents, and operates solutions using Windows Server Administration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Windows Server Administration."
---
...
## Activation
- Use when the user explicitly asks for windows server administration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with windows server administration.
...
- Primary capability: Windows Server Administration.
- Primary domain: software cloud.
- Use Windows Server Administration only after confirming environment and version compatibility.
