...
description: "Designs, implements, tests, documents, and operates solutions using Angular Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Angular Development."
---
...
## Activation
- Use when the user explicitly asks for angular development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with angular development.
...
- Primary capability: Angular Development.
- Primary domain: software cloud.
- Use Angular Development only after confirming environment and version compatibility.
