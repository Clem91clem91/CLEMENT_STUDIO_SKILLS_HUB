---
name: speech-to-text
description: "Designs, implements, tests, documents, and operates solutions using Speech To Text, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Speech To Text."
---
...
## Activation
- Use when the user explicitly asks for speech to text.
- Use when a task would materially benefit from the methods, standards, or operating style associated with speech to text.
...
- Primary capability: Speech To Text.
- Primary domain: software cloud.
- Use Speech To Text only after confirming environment and version compatibility.
