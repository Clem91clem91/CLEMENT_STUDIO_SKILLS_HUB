...
description: "Designs, implements, tests, documents, and operates solutions using Observability Implementation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Observability Implementation."
---
...
## Activation
- Use when the user explicitly asks for observability implementation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with observability implementation.
...
- Primary capability: Observability Implementation.
- Primary domain: software cloud.
- Use Observability Implementation only after confirming environment and version compatibility.
