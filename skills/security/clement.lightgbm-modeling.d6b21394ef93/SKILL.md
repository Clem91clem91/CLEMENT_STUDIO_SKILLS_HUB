...
description: "Designs, implements, tests, documents, and operates solutions using LightGBM Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving LightGBM Modeling."
---
...
## Activation
- Use when the user explicitly asks for lightgbm modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with lightgbm modeling.
...
- Primary capability: LightGBM Modeling.
- Primary domain: artificial intelligence.
- Use LightGBM Modeling only after confirming environment and version compatibility.
