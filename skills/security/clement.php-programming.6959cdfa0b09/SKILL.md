...
description: "Designs, implements, tests, documents, and operates solutions using PHP Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving PHP Programming."
---
...
## Activation
- Use when the user explicitly asks for php programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with php programming.
...
- Primary capability: PHP Programming.
- Primary domain: software cloud.
- Use PHP Programming only after confirming environment and version compatibility.
