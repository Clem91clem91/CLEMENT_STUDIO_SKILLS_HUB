...
description: "Applies the Chief Security Officer professional role to plan, execute, review, and deliver reliable cybersecurity work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Chief Security Officer."
---
...
## Activation
- Use when the user explicitly asks for chief security officer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with chief security officer.
...
- Primary capability: Chief Security Officer.
