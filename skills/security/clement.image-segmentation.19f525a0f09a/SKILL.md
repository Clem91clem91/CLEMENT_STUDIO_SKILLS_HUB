...
description: "Designs, implements, tests, documents, and operates solutions using Image Segmentation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Image Segmentation."
---
...
## Activation
- Use when the user explicitly asks for image segmentation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with image segmentation.
...
- Primary capability: Image Segmentation.
- Primary domain: software cloud.
- Use Image Segmentation only after confirming environment and version compatibility.
