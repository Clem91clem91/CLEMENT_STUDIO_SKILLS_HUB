...
description: "Designs, implements, tests, documents, and operates solutions using SQL Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving SQL Programming."
---
...
## Activation
- Use when the user explicitly asks for sql programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with sql programming.
...
- Primary capability: SQL Programming.
- Primary domain: data analytics.
- Use SQL Programming only after confirming environment and version compatibility.
