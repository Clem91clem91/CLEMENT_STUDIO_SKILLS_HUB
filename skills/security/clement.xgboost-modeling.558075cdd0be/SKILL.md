...
description: "Designs, implements, tests, documents, and operates solutions using XGBoost Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving XGBoost Modeling."
---
...
## Activation
- Use when the user explicitly asks for xgboost modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with xgboost modeling.
...
- Primary capability: XGBoost Modeling.
- Primary domain: artificial intelligence.
- Use XGBoost Modeling only after confirming environment and version compatibility.
