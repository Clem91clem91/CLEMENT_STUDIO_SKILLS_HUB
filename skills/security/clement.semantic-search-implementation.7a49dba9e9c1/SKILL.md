...
description: "Designs, implements, tests, documents, and operates solutions using Semantic Search Implementation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Semantic Search Implementation."
---
...
## Activation
- Use when the user explicitly asks for semantic search implementation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with semantic search implementation.
...
- Primary capability: Semantic Search Implementation.
- Primary domain: sales marketing customer.
- Use Semantic Search Implementation only after confirming environment and version compatibility.
...
- $customer-obsessed-creator
- $market-sensing-entrepreneur
- $rapid-experimenter
- $perspective-taking
- $pattern-recognition
