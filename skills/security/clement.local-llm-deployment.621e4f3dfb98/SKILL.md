...
description: "Designs, implements, tests, documents, and operates solutions using Local LLM Deployment, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Local LLM Deployment."
---
...
## Activation
- Use when the user explicitly asks for local llm deployment.
- Use when a task would materially benefit from the methods, standards, or operating style associated with local llm deployment.
...
- Primary capability: Local LLM Deployment.
- Primary domain: artificial intelligence.
- Use Local LLM Deployment only after confirming environment and version compatibility.
