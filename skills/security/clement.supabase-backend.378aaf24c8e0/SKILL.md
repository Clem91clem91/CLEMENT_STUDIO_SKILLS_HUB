...
description: "Designs, implements, tests, documents, and operates solutions using Supabase Backend, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Supabase Backend."
---
...
## Activation
- Use when the user explicitly asks for supabase backend.
- Use when a task would materially benefit from the methods, standards, or operating style associated with supabase backend.
...
- Primary capability: Supabase Backend.
- Primary domain: software cloud.
- Use Supabase Backend only after confirming environment and version compatibility.
