...
description: "Designs, implements, tests, documents, and operates solutions using Adobe After Effects, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Adobe After Effects."
---
...
## Activation
- Use when the user explicitly asks for adobe after effects.
- Use when a task would materially benefit from the methods, standards, or operating style associated with adobe after effects.
...
- Primary capability: Adobe After Effects.
- Primary domain: design media creative.
- Use Adobe After Effects only after confirming environment and version compatibility.
