...
description: "Designs, implements, tests, documents, and operates solutions using Dart Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Dart Programming."
---
...
## Activation
- Use when the user explicitly asks for dart programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with dart programming.
...
- Primary capability: Dart Programming.
- Primary domain: software cloud.
- Use Dart Programming only after confirming environment and version compatibility.
