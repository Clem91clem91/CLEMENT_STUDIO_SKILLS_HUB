...
description: "Designs, implements, tests, documents, and operates solutions using React Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving React Development."
---
...
## Activation
- Use when the user explicitly asks for react development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with react development.
...
- Primary capability: React Development.
- Primary domain: software cloud.
- Use React Development only after confirming environment and version compatibility.
