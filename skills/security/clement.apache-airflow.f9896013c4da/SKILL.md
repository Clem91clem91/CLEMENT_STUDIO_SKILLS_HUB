---
name: apache-airflow
description: "Designs, implements, tests, documents, and operates solutions using Apache Airflow, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Apache Airflow."
---
...
## Activation
- Use when the user explicitly asks for apache airflow.
- Use when a task would materially benefit from the methods, standards, or operating style associated with apache airflow.
...
- Primary capability: Apache Airflow.
- Primary domain: data analytics.
- Use Apache Airflow only after confirming environment and version compatibility.
