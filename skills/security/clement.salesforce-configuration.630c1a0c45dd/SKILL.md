...
description: "Designs, implements, tests, documents, and operates solutions using Salesforce Configuration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Salesforce Configuration."
---
...
## Activation
- Use when the user explicitly asks for salesforce configuration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with salesforce configuration.
...
- Primary capability: Salesforce Configuration.
- Primary domain: sales marketing customer.
- Use Salesforce Configuration only after confirming environment and version compatibility.
