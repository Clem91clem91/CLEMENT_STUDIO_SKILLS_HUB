...
description: "Designs, implements, tests, documents, and operates solutions using Prometheus Monitoring, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Prometheus Monitoring."
---
...
## Activation
- Use when the user explicitly asks for prometheus monitoring.
- Use when a task would materially benefit from the methods, standards, or operating style associated with prometheus monitoring.
...
- Primary capability: Prometheus Monitoring.
- Primary domain: software cloud.
- Use Prometheus Monitoring only after confirming environment and version compatibility.
