...
description: "Designs, implements, tests, documents, and operates solutions using Postgresql Database, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Postgresql Database."
---
...
## Activation
- Use when the user explicitly asks for postgresql database.
- Use when a task would materially benefit from the methods, standards, or operating style associated with postgresql database.
...
- Primary capability: Postgresql Database.
- Primary domain: data analytics.
- Use Postgresql Database only after confirming environment and version compatibility.
