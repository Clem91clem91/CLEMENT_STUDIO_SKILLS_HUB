...
description: "Designs, implements, tests, documents, and operates solutions using Scikit Learn Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Scikit Learn Modeling."
---
...
## Activation
- Use when the user explicitly asks for scikit learn modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with scikit learn modeling.
...
- Primary capability: Scikit Learn Modeling.
- Primary domain: artificial intelligence.
- Use Scikit Learn Modeling only after confirming environment and version compatibility.
