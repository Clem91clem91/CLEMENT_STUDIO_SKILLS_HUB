...
description: "Designs, implements, tests, documents, and operates solutions using Rest API Design, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Rest API Design."
---
...
## Activation
- Use when the user explicitly asks for rest api design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with rest api design.
...
- Primary capability: Rest API Design.
- Primary domain: software cloud.
- Use Rest API Design only after confirming environment and version compatibility.
