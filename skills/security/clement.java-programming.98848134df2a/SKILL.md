...
description: "Designs, implements, tests, documents, and operates solutions using Java Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Java Programming."
---
...
## Activation
- Use when the user explicitly asks for java programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with java programming.
...
- Primary capability: Java Programming.
- Primary domain: software cloud.
- Use Java Programming only after confirming environment and version compatibility.
