...
description: "Designs, implements, tests, documents, and operates solutions using Hubspot Configuration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Hubspot Configuration."
---
...
## Activation
- Use when the user explicitly asks for hubspot configuration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with hubspot configuration.
...
- Primary capability: Hubspot Configuration.
- Primary domain: software cloud.
- Use Hubspot Configuration only after confirming environment and version compatibility.
