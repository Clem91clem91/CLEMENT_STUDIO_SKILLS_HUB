...
description: "Designs, implements, tests, documents, and operates solutions using Adobe Premiere Pro, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Adobe Premiere Pro."
---
...
## Activation
- Use when the user explicitly asks for adobe premiere pro.
- Use when a task would materially benefit from the methods, standards, or operating style associated with adobe premiere pro.
...
- Primary capability: Adobe Premiere Pro.
- Primary domain: design media creative.
- Use Adobe Premiere Pro only after confirming environment and version compatibility.
