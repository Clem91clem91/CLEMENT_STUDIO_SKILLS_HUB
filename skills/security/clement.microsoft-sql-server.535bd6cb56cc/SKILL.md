...
description: "Designs, implements, tests, documents, and operates solutions using Microsoft SQL Server, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Microsoft SQL Server."
---
...
## Activation
- Use when the user explicitly asks for microsoft sql server.
- Use when a task would materially benefit from the methods, standards, or operating style associated with microsoft sql server.
...
- Primary capability: Microsoft SQL Server.
- Primary domain: data analytics.
- Use Microsoft SQL Server only after confirming environment and version compatibility.
