...
description: "Designs, implements, tests, documents, and operates solutions using Tool Calling Design, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Tool Calling Design."
---
...
## Activation
- Use when the user explicitly asks for tool calling design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with tool calling design.
...
- Primary capability: Tool Calling Design.
- Primary domain: design media creative.
- Use Tool Calling Design only after confirming environment and version compatibility.
