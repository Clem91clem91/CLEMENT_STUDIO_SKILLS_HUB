...
description: "Designs, implements, tests, documents, and operates solutions using Infrastructure Cost Optimization, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Infrastructure Cost Optimization."
---
...
## Activation
- Use when the user explicitly asks for infrastructure cost optimization.
- Use when a task would materially benefit from the methods, standards, or operating style associated with infrastructure cost optimization.
...
- Primary capability: Infrastructure Cost Optimization.
- Primary domain: finance investment.
- Use Infrastructure Cost Optimization only after confirming environment and version compatibility.
...
- Use qualified human review for material, safety-critical, regulated, or financially consequential decisions.
- Validate calculations, definitions, assumptions, applicable standards, and source dates.
