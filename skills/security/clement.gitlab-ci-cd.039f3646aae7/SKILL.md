---
name: gitlab-ci-cd
description: "Designs, implements, tests, documents, and operates solutions using Gitlab Ci Cd, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Gitlab Ci Cd."
---
...
## Activation
- Use when the user explicitly asks for gitlab ci cd.
- Use when a task would materially benefit from the methods, standards, or operating style associated with gitlab ci cd.
...
- Primary capability: Gitlab Ci Cd.
- Primary domain: software cloud.
- Use Gitlab Ci Cd only after confirming environment and version compatibility.
