---
name: css3-development
description: "Designs, implements, tests, documents, and operates solutions using CSS3 Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving CSS3 Development."
---
...
## Activation
- Use when the user explicitly asks for css3 development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with css3 development.
...
- Primary capability: CSS3 Development.
- Primary domain: software cloud.
- Use CSS3 Development only after confirming environment and version compatibility.
