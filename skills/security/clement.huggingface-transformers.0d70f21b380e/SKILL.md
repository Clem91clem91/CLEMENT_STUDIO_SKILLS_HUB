...
description: "Designs, implements, tests, documents, and operates solutions using Huggingface Transformers, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Huggingface Transformers."
---
...
## Activation
- Use when the user explicitly asks for huggingface transformers.
- Use when a task would materially benefit from the methods, standards, or operating style associated with huggingface transformers.
...
- Primary capability: Huggingface Transformers.
- Primary domain: artificial intelligence.
- Use Huggingface Transformers only after confirming environment and version compatibility.
