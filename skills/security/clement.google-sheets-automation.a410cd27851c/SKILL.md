...
description: "Designs, implements, tests, documents, and operates solutions using Google Sheets Automation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Google Sheets Automation."
---
...
## Activation
- Use when the user explicitly asks for google sheets automation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with google sheets automation.
...
- Primary capability: Google Sheets Automation.
- Primary domain: software cloud.
- Use Google Sheets Automation only after confirming environment and version compatibility.
