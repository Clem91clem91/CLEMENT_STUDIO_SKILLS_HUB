...
description: "Designs, implements, tests, documents, and operates solutions using Navisworks Coordination, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Navisworks Coordination."
---
...
## Activation
- Use when the user explicitly asks for navisworks coordination.
- Use when a task would materially benefit from the methods, standards, or operating style associated with navisworks coordination.
...
- Primary capability: Navisworks Coordination.
- Primary domain: construction engineering.
- Use Navisworks Coordination only after confirming environment and version compatibility.
