...
description: "Designs, implements, tests, documents, and operates solutions using Rust Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Rust Programming."
---
...
## Activation
- Use when the user explicitly asks for rust programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with rust programming.
...
- Primary capability: Rust Programming.
- Primary domain: software cloud.
- Use Rust Programming only after confirming environment and version compatibility.
