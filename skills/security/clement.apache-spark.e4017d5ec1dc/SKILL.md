---
name: apache-spark
description: "Designs, implements, tests, documents, and operates solutions using Apache Spark, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Apache Spark."
---
...
## Activation
- Use when the user explicitly asks for apache spark.
- Use when a task would materially benefit from the methods, standards, or operating style associated with apache spark.
...
- Primary capability: Apache Spark.
- Primary domain: data analytics.
- Use Apache Spark only after confirming environment and version compatibility.
