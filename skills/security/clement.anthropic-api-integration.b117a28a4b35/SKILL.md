...
description: "Designs, implements, tests, documents, and operates solutions using Anthropic API Integration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Anthropic API Integration."
---
...
## Activation
- Use when the user explicitly asks for anthropic api integration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with anthropic api integration.
...
- Primary capability: Anthropic API Integration.
- Primary domain: software cloud.
- Use Anthropic API Integration only after confirming environment and version compatibility.
