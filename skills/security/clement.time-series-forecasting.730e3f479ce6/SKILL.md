...
description: "Designs, implements, tests, documents, and operates solutions using Time Series Forecasting, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Time Series Forecasting."
---
...
## Activation
- Use when the user explicitly asks for time series forecasting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with time series forecasting.
...
- Primary capability: Time Series Forecasting.
- Primary domain: data analytics.
- Use Time Series Forecasting only after confirming environment and version compatibility.
