...
description: "Designs, implements, tests, documents, and operates solutions using Microsoft Azure Services, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Microsoft Azure Services."
---
...
## Activation
- Use when the user explicitly asks for microsoft azure services.
- Use when a task would materially benefit from the methods, standards, or operating style associated with microsoft azure services.
...
- Primary capability: Microsoft Azure Services.
- Primary domain: software cloud.
- Use Microsoft Azure Services only after confirming environment and version compatibility.
