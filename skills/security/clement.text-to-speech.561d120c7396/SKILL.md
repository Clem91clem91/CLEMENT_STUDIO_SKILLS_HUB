---
name: text-to-speech
description: "Designs, implements, tests, documents, and operates solutions using Text To Speech, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Text To Speech."
---
...
## Activation
- Use when the user explicitly asks for text to speech.
- Use when a task would materially benefit from the methods, standards, or operating style associated with text to speech.
...
- Primary capability: Text To Speech.
- Primary domain: software cloud.
- Use Text To Speech only after confirming environment and version compatibility.
