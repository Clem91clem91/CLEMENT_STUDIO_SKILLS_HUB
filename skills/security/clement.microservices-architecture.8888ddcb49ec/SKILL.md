...
description: "Designs, implements, tests, documents, and operates solutions using Microservices Architecture, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Microservices Architecture."
---
...
## Activation
- Use when the user explicitly asks for microservices architecture.
- Use when a task would materially benefit from the methods, standards, or operating style associated with microservices architecture.
...
- Primary capability: Microservices Architecture.
- Primary domain: software cloud.
- Use Microservices Architecture only after confirming environment and version compatibility.
