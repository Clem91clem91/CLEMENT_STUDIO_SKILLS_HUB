...
description: "Designs, implements, tests, documents, and operates solutions using Terraform Infrastructure, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Terraform Infrastructure."
---
...
## Activation
- Use when the user explicitly asks for terraform infrastructure.
- Use when a task would materially benefit from the methods, standards, or operating style associated with terraform infrastructure.
...
- Primary capability: Terraform Infrastructure.
- Primary domain: software cloud.
- Use Terraform Infrastructure only after confirming environment and version compatibility.
