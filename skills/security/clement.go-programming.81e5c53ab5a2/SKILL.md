---
name: go-programming
description: "Designs, implements, tests, documents, and operates solutions using Go Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Go Programming."
---
...
## Activation
- Use when the user explicitly asks for go programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with go programming.
...
- Primary capability: Go Programming.
- Primary domain: software cloud.
- Use Go Programming only after confirming environment and version compatibility.
