...
description: "Designs, implements, tests, documents, and operates solutions using Microsoft Power Automate, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Microsoft Power Automate."
---
...
## Activation
- Use when the user explicitly asks for microsoft power automate.
- Use when a task would materially benefit from the methods, standards, or operating style associated with microsoft power automate.
...
- Primary capability: Microsoft Power Automate.
- Primary domain: software cloud.
- Use Microsoft Power Automate only after confirming environment and version compatibility.
