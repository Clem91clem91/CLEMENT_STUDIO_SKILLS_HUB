...
description: "Designs, implements, tests, documents, and operates solutions using Retrieval Augmented Generation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Retrieval Augmented Generation."
---
...
## Activation
- Use when the user explicitly asks for retrieval augmented generation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with retrieval augmented generation.
...
- Primary capability: Retrieval Augmented Generation.
- Primary domain: software cloud.
- Use Retrieval Augmented Generation only after confirming environment and version compatibility.
