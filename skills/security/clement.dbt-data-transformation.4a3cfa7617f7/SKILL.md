...
description: "Designs, implements, tests, documents, and operates solutions using dbt Data Transformation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving dbt Data Transformation."
---
...
## Activation
- Use when the user explicitly asks for dbt data transformation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with dbt data transformation.
...
- Primary capability: dbt Data Transformation.
- Primary domain: data analytics.
- Use dbt Data Transformation only after confirming environment and version compatibility.
