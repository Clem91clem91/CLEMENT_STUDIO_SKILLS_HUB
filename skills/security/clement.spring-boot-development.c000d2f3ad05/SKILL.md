...
description: "Designs, implements, tests, documents, and operates solutions using Spring Boot Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Spring Boot Development."
---
...
## Activation
- Use when the user explicitly asks for spring boot development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with spring boot development.
...
- Primary capability: Spring Boot Development.
- Primary domain: software cloud.
- Use Spring Boot Development only after confirming environment and version compatibility.
