---
name: mysql-database
description: "Designs, implements, tests, documents, and operates solutions using Mysql Database, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Mysql Database."
---
...
## Activation
- Use when the user explicitly asks for mysql database.
- Use when a task would materially benefit from the methods, standards, or operating style associated with mysql database.
...
- Primary capability: Mysql Database.
- Primary domain: data analytics.
- Use Mysql Database only after confirming environment and version compatibility.
