...
description: "Designs, implements, tests, documents, and operates solutions using Tableau Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Tableau Development."
---
...
## Activation
- Use when the user explicitly asks for tableau development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with tableau development.
...
- Primary capability: Tableau Development.
- Primary domain: data analytics.
- Use Tableau Development only after confirming environment and version compatibility.
