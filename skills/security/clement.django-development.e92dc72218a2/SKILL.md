...
description: "Designs, implements, tests, documents, and operates solutions using Django Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Django Development."
---
...
## Activation
- Use when the user explicitly asks for django development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with django development.
...
- Primary capability: Django Development.
- Primary domain: software cloud.
- Use Django Development only after confirming environment and version compatibility.
