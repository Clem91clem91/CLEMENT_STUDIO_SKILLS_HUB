...
description: "Designs, implements, tests, documents, and operates solutions using Object Detection, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Object Detection."
---
...
## Activation
- Use when the user explicitly asks for object detection.
- Use when a task would materially benefit from the methods, standards, or operating style associated with object detection.
...
- Primary capability: Object Detection.
- Primary domain: software cloud.
- Use Object Detection only after confirming environment and version compatibility.
