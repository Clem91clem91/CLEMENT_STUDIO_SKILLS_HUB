...
description: "Designs, implements, tests, documents, and operates solutions using N8n Workflow Automation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving N8n Workflow Automation."
---
...
## Activation
- Use when the user explicitly asks for n8n workflow automation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with n8n workflow automation.
...
- Primary capability: N8n Workflow Automation.
- Primary domain: operations management.
- Use N8n Workflow Automation only after confirming environment and version compatibility.
