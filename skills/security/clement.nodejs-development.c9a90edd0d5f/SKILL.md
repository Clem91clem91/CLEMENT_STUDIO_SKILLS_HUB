...
description: "Designs, implements, tests, documents, and operates solutions using Node.js Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Node.js Development."
---
...
## Activation
- Use when the user explicitly asks for node.js development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with node.js development.
...
- Primary capability: Node.js Development.
- Primary domain: software cloud.
- Use Node.js Development only after confirming environment and version compatibility.
