...
description: "Designs, implements, tests, documents, and operates solutions using Sqlite Database, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Sqlite Database."
---
...
## Activation
- Use when the user explicitly asks for sqlite database.
- Use when a task would materially benefit from the methods, standards, or operating style associated with sqlite database.
...
- Primary capability: Sqlite Database.
- Primary domain: data analytics.
- Use Sqlite Database only after confirming environment and version compatibility.
