...
description: "Designs, implements, tests, documents, and operates solutions using Docker Containerization, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Docker Containerization."
---
...
## Activation
- Use when the user explicitly asks for docker containerization.
- Use when a task would materially benefit from the methods, standards, or operating style associated with docker containerization.
...
- Primary capability: Docker Containerization.
- Primary domain: software cloud.
- Use Docker Containerization only after confirming environment and version compatibility.
