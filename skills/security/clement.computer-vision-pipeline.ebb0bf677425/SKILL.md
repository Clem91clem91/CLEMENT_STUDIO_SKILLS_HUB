...
description: "Designs, implements, tests, documents, and operates solutions using Computer Vision Pipeline, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Computer Vision Pipeline."
---
...
## Activation
- Use when the user explicitly asks for computer vision pipeline.
- Use when a task would materially benefit from the methods, standards, or operating style associated with computer vision pipeline.
...
- Primary capability: Computer Vision Pipeline.
- Primary domain: artificial intelligence.
- Use Computer Vision Pipeline only after confirming environment and version compatibility.
