...
description: "Designs, implements, tests, documents, and operates solutions using Zapier Workflow Automation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Zapier Workflow Automation."
---
...
## Activation
- Use when the user explicitly asks for zapier workflow automation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with zapier workflow automation.
...
- Primary capability: Zapier Workflow Automation.
- Primary domain: operations management.
- Use Zapier Workflow Automation only after confirming environment and version compatibility.
