...
description: "Designs, implements, tests, documents, and operates solutions using Model Evaluation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Model Evaluation."
---
...
## Activation
- Use when the user explicitly asks for model evaluation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with model evaluation.
...
- Primary capability: Model Evaluation.
- Primary domain: artificial intelligence.
- Use Model Evaluation only after confirming environment and version compatibility.
