...
description: "Designs, implements, tests, documents, and operates solutions using Twilio Communications Integration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Twilio Communications Integration."
---
...
## Activation
- Use when the user explicitly asks for twilio communications integration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with twilio communications integration.
...
- Primary capability: Twilio Communications Integration.
- Primary domain: communication people.
- Use Twilio Communications Integration only after confirming environment and version compatibility.
