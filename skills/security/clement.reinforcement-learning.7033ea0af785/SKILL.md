...
description: "Designs, implements, tests, documents, and operates solutions using Reinforcement Learning, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Reinforcement Learning."
---
...
## Activation
- Use when the user explicitly asks for reinforcement learning.
- Use when a task would materially benefit from the methods, standards, or operating style associated with reinforcement learning.
...
- Primary capability: Reinforcement Learning.
- Primary domain: artificial intelligence.
- Use Reinforcement Learning only after confirming environment and version compatibility.
