...
description: "Designs, implements, tests, documents, and operates solutions using Solidworks Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Solidworks Modeling."
---
...
## Activation
- Use when the user explicitly asks for solidworks modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with solidworks modeling.
...
- Primary capability: Solidworks Modeling.
- Primary domain: construction engineering.
- Use Solidworks Modeling only after confirming environment and version compatibility.
