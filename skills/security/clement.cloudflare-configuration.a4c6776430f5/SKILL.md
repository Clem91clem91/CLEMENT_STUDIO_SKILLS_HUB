...
description: "Designs, implements, tests, documents, and operates solutions using Cloudflare Configuration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Cloudflare Configuration."
---
...
## Activation
- Use when the user explicitly asks for cloudflare configuration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with cloudflare configuration.
...
- Primary capability: Cloudflare Configuration.
- Primary domain: software cloud.
- Use Cloudflare Configuration only after confirming environment and version compatibility.
