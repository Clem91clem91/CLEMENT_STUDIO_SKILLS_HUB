...
description: "Designs, implements, tests, documents, and operates solutions using Ruby Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Ruby Programming."
---
...
## Activation
- Use when the user explicitly asks for ruby programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ruby programming.
...
- Primary capability: Ruby Programming.
- Primary domain: software cloud.
- Use Ruby Programming only after confirming environment and version compatibility.
