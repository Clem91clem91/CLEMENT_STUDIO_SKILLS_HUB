---
name: gis-mapping
description: "Designs, implements, tests, documents, and operates solutions using GIS Mapping, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving GIS Mapping."
---
...
## Activation
- Use when the user explicitly asks for gis mapping.
- Use when a task would materially benefit from the methods, standards, or operating style associated with gis mapping.
...
- Primary capability: GIS Mapping.
- Primary domain: construction engineering.
- Use GIS Mapping only after confirming environment and version compatibility.
