...
description: "Designs, implements, tests, documents, and operates solutions using Dynamo Visual Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Dynamo Visual Programming."
---
...
## Activation
- Use when the user explicitly asks for dynamo visual programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with dynamo visual programming.
...
- Primary capability: Dynamo Visual Programming.
- Primary domain: construction engineering.
- Use Dynamo Visual Programming only after confirming environment and version compatibility.
