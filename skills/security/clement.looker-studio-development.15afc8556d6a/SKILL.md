---
name: looker-studio-development
description: "Designs, implements, tests, documents, and operates solutions using Looker Studio Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Looker Studio Development."
---
...
## Activation
- Use when the user explicitly asks for looker studio development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with looker studio development.
...
- Primary capability: Looker Studio Development.
- Primary domain: data analytics.
- Use Looker Studio Development only after confirming environment and version compatibility.
