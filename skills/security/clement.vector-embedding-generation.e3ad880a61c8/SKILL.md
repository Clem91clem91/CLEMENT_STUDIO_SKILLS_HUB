...
description: "Designs, implements, tests, documents, and operates solutions using Vector Embedding Generation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Vector Embedding Generation."
---
...
## Activation
- Use when the user explicitly asks for vector embedding generation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with vector embedding generation.
...
- Primary capability: Vector Embedding Generation.
- Primary domain: software cloud.
- Use Vector Embedding Generation only after confirming environment and version compatibility.
