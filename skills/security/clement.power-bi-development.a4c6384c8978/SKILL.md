...
description: "Designs, implements, tests, documents, and operates solutions using Power BI Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Power BI Development."
---
...
## Activation
- Use when the user explicitly asks for power bi development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with power bi development.
...
- Primary capability: Power BI Development.
- Primary domain: data analytics.
- Use Power BI Development only after confirming environment and version compatibility.
