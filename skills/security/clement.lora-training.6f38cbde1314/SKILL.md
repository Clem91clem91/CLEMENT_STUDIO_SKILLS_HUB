---
name: lora-training
description: "Designs, implements, tests, documents, and operates solutions using Lora Training, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Lora Training."
---
...
## Activation
- Use when the user explicitly asks for lora training.
- Use when a task would materially benefit from the methods, standards, or operating style associated with lora training.
...
- Primary capability: Lora Training.
- Primary domain: artificial intelligence.
- Use Lora Training only after confirming environment and version compatibility.
