...
description: "Designs, implements, tests, documents, and operates solutions using Adobe Photoshop, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Adobe Photoshop."
---
...
## Activation
- Use when the user explicitly asks for adobe photoshop.
- Use when a task would materially benefit from the methods, standards, or operating style associated with adobe photoshop.
...
- Primary capability: Adobe Photoshop.
- Primary domain: design media creative.
- Use Adobe Photoshop only after confirming environment and version compatibility.
