...
description: "Designs, implements, tests, documents, and operates solutions using Data Lake Architecture, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Data Lake Architecture."
---
...
## Activation
- Use when the user explicitly asks for data lake architecture.
- Use when a task would materially benefit from the methods, standards, or operating style associated with data lake architecture.
...
- Primary capability: Data Lake Architecture.
- Primary domain: data analytics.
- Use Data Lake Architecture only after confirming environment and version compatibility.
