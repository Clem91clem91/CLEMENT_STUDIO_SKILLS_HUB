...
description: "Designs, implements, tests, documents, and operates solutions using Expressjs Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Expressjs Development."
---
...
## Activation
- Use when the user explicitly asks for expressjs development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with expressjs development.
...
- Primary capability: Expressjs Development.
- Primary domain: software cloud.
- Use Expressjs Development only after confirming environment and version compatibility.
