...
description: "Designs, implements, tests, documents, and operates solutions using HTML5 Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving HTML5 Development."
---
...
## Activation
- Use when the user explicitly asks for html5 development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with html5 development.
...
- Primary capability: HTML5 Development.
- Primary domain: software cloud.
- Use HTML5 Development only after confirming environment and version compatibility.
