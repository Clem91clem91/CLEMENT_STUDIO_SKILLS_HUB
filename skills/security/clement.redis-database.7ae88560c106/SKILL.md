---
name: redis-database
description: "Designs, implements, tests, documents, and operates solutions using Redis Database, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Redis Database."
---
...
## Activation
- Use when the user explicitly asks for redis database.
- Use when a task would materially benefit from the methods, standards, or operating style associated with redis database.
...
- Primary capability: Redis Database.
- Primary domain: data analytics.
- Use Redis Database only after confirming environment and version compatibility.
