...
description: "Designs, implements, tests, documents, and operates solutions using Pgvector Extension, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Pgvector Extension."
---
...
## Activation
- Use when the user explicitly asks for pgvector extension.
- Use when a task would materially benefit from the methods, standards, or operating style associated with pgvector extension.
...
- Primary capability: Pgvector Extension.
- Primary domain: software cloud.
- Use Pgvector Extension only after confirming environment and version compatibility.
