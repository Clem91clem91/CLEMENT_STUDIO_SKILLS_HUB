---
name: airtable-database-design
description: "Designs, implements, tests, documents, and operates solutions using Airtable Database Design, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Airtable Database Design."
---
...
## Activation
- Use when the user explicitly asks for airtable database design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with airtable database design.
...
- Primary capability: Airtable Database Design.
- Primary domain: data analytics.
- Use Airtable Database Design only after confirming environment and version compatibility.
