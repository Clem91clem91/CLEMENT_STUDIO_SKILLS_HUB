...
description: "Designs, implements, tests, documents, and operates solutions using Openai API Integration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Openai API Integration."
---
...
## Activation
- Use when the user explicitly asks for openai api integration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with openai api integration.
...
- Primary capability: Openai API Integration.
- Primary domain: artificial intelligence.
- Use Openai API Integration only after confirming environment and version compatibility.
