...
description: "Designs, implements, tests, documents, and operates solutions using Kubernetes Orchestration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Kubernetes Orchestration."
---
...
## Activation
- Use when the user explicitly asks for kubernetes orchestration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with kubernetes orchestration.
...
- Primary capability: Kubernetes Orchestration.
- Primary domain: software cloud.
- Use Kubernetes Orchestration only after confirming environment and version compatibility.
