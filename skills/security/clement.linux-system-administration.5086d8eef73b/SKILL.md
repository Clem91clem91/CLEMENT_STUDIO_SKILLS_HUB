...
description: "Designs, implements, tests, documents, and operates solutions using Linux System Administration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Linux System Administration."
---
...
## Activation
- Use when the user explicitly asks for linux system administration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with linux system administration.
...
- Primary capability: Linux System Administration.
- Primary domain: software cloud.
- Use Linux System Administration only after confirming environment and version compatibility.
