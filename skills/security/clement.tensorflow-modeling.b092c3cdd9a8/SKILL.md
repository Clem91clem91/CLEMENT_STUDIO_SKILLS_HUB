...
description: "Designs, implements, tests, documents, and operates solutions using Tensorflow Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Tensorflow Modeling."
---
...
## Activation
- Use when the user explicitly asks for tensorflow modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with tensorflow modeling.
...
- Primary capability: Tensorflow Modeling.
- Primary domain: artificial intelligence.
- Use Tensorflow Modeling only after confirming environment and version compatibility.
