...
description: "Designs, implements, tests, documents, and operates solutions using Firebase Backend, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Firebase Backend."
---
...
## Activation
- Use when the user explicitly asks for firebase backend.
- Use when a task would materially benefit from the methods, standards, or operating style associated with firebase backend.
...
- Primary capability: Firebase Backend.
- Primary domain: software cloud.
- Use Firebase Backend only after confirming environment and version compatibility.
