...
description: "Designs, implements, tests, documents, and operates solutions using Numpy Computing, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Numpy Computing."
---
...
## Activation
- Use when the user explicitly asks for numpy computing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with numpy computing.
...
- Primary capability: Numpy Computing.
- Primary domain: data analytics.
- Use Numpy Computing only after confirming environment and version compatibility.
