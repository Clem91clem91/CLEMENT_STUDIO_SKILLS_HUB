---
name: bash-scripting
description: "Designs, implements, tests, documents, and operates solutions using Bash Scripting, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Bash Scripting."
---
...
## Activation
- Use when the user explicitly asks for bash scripting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with bash scripting.
...
- Primary capability: Bash Scripting.
- Primary domain: software cloud.
- Use Bash Scripting only after confirming environment and version compatibility.
