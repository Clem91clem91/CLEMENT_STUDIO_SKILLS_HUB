...
description: "Designs, implements, tests, documents, and operates solutions using ETL Pipeline Design, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving ETL Pipeline Design."
---
...
## Activation
- Use when the user explicitly asks for etl pipeline design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with etl pipeline design.
...
- Primary capability: ETL Pipeline Design.
- Primary domain: data analytics.
- Use ETL Pipeline Design only after confirming environment and version compatibility.
