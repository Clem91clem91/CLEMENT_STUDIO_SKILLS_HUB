...
description: "Applies the Threat Intelligence Analyst professional role to plan, execute, review, and deliver reliable cybersecurity work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Threat Intelligence Analyst."
---
...
## Activation
- Use when the user explicitly asks for threat intelligence analyst.
- Use when a task would materially benefit from the methods, standards, or operating style associated with threat intelligence analyst.
...
- Primary capability: Threat Intelligence Analyst.
