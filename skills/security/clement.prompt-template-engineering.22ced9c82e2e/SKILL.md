...
description: "Designs, implements, tests, documents, and operates solutions using Prompt Template Engineering, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Prompt Template Engineering."
---
...
## Activation
- Use when the user explicitly asks for prompt template engineering.
- Use when a task would materially benefit from the methods, standards, or operating style associated with prompt template engineering.
...
- Primary capability: Prompt Template Engineering.
- Primary domain: artificial intelligence.
- Use Prompt Template Engineering only after confirming environment and version compatibility.
