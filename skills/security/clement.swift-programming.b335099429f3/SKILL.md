...
description: "Designs, implements, tests, documents, and operates solutions using Swift Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Swift Programming."
---
...
## Activation
- Use when the user explicitly asks for swift programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with swift programming.
...
- Primary capability: Swift Programming.
- Primary domain: software cloud.
- Use Swift Programming only after confirming environment and version compatibility.
