...
description: "Designs, implements, tests, documents, and operates solutions using Ansible Automation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Ansible Automation."
---
...
## Activation
- Use when the user explicitly asks for ansible automation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ansible automation.
...
- Primary capability: Ansible Automation.
- Primary domain: software cloud.
- Use Ansible Automation only after confirming environment and version compatibility.
