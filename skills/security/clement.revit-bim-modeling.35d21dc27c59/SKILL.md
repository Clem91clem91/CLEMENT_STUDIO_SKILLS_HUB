---
name: revit-bim-modeling
description: "Designs, implements, tests, documents, and operates solutions using Revit BIM Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Revit BIM Modeling."
---
...
## Activation
- Use when the user explicitly asks for revit bim modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with revit bim modeling.
...
- Primary capability: Revit BIM Modeling.
- Primary domain: construction engineering.
- Use Revit BIM Modeling only after confirming environment and version compatibility.
