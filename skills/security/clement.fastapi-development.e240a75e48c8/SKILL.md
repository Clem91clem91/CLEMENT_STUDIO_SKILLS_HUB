...
description: "Designs, implements, tests, documents, and operates solutions using Fastapi Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Fastapi Development."
---
...
## Activation
- Use when the user explicitly asks for fastapi development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with fastapi development.
...
- Primary capability: Fastapi Development.
- Primary domain: software cloud.
- Use Fastapi Development only after confirming environment and version compatibility.
