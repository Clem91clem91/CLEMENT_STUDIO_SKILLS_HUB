...
description: "Designs, implements, tests, documents, and operates solutions using Autocad Drafting, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Autocad Drafting."
---
...
## Activation
- Use when the user explicitly asks for autocad drafting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with autocad drafting.
...
- Primary capability: Autocad Drafting.
- Primary domain: construction engineering.
- Use Autocad Drafting only after confirming environment and version compatibility.
