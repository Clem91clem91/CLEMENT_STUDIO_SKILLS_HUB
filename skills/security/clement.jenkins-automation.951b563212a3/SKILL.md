...
description: "Designs, implements, tests, documents, and operates solutions using Jenkins Automation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Jenkins Automation."
---
...
## Activation
- Use when the user explicitly asks for jenkins automation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with jenkins automation.
...
- Primary capability: Jenkins Automation.
- Primary domain: software cloud.
- Use Jenkins Automation only after confirming environment and version compatibility.
