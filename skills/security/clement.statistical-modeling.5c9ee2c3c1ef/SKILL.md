...
description: "Designs, implements, tests, documents, and operates solutions using Statistical Modeling, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Statistical Modeling."
---
...
## Activation
- Use when the user explicitly asks for statistical modeling.
- Use when a task would materially benefit from the methods, standards, or operating style associated with statistical modeling.
...
- Primary capability: Statistical Modeling.
- Primary domain: artificial intelligence.
- Use Statistical Modeling only after confirming environment and version compatibility.
