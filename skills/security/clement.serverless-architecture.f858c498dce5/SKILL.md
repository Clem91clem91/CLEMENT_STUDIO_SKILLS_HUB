...
description: "Designs, implements, tests, documents, and operates solutions using Serverless Architecture, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Serverless Architecture."
---
...
## Activation
- Use when the user explicitly asks for serverless architecture.
- Use when a task would materially benefit from the methods, standards, or operating style associated with serverless architecture.
...
- Primary capability: Serverless Architecture.
- Primary domain: software cloud.
- Use Serverless Architecture only after confirming environment and version compatibility.
