...
description: "Designs, implements, tests, documents, and operates solutions using Geospatial Data Processing, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Geospatial Data Processing."
---
...
## Activation
- Use when the user explicitly asks for geospatial data processing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with geospatial data processing.
...
- Primary capability: Geospatial Data Processing.
- Primary domain: data analytics.
- Use Geospatial Data Processing only after confirming environment and version compatibility.
