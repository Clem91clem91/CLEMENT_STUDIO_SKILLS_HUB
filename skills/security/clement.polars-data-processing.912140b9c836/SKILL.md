...
description: "Designs, implements, tests, documents, and operates solutions using Polars Data Processing, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Polars Data Processing."
---
...
## Activation
- Use when the user explicitly asks for polars data processing.
- Use when a task would materially benefit from the methods, standards, or operating style associated with polars data processing.
...
- Primary capability: Polars Data Processing.
- Primary domain: data analytics.
- Use Polars Data Processing only after confirming environment and version compatibility.
