...
description: "Designs, implements, tests, documents, and operates solutions using Powershell Scripting, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Powershell Scripting."
---
...
## Activation
- Use when the user explicitly asks for powershell scripting.
- Use when a task would materially benefit from the methods, standards, or operating style associated with powershell scripting.
...
- Primary capability: Powershell Scripting.
- Primary domain: software cloud.
- Use Powershell Scripting only after confirming environment and version compatibility.
