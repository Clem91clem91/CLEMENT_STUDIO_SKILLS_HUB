...
description: "Designs, implements, tests, documents, and operates solutions using Make Workflow Automation, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Make Workflow Automation."
---
...
## Activation
- Use when the user explicitly asks for make workflow automation.
- Use when a task would materially benefit from the methods, standards, or operating style associated with make workflow automation.
...
- Primary capability: Make Workflow Automation.
- Primary domain: operations management.
- Use Make Workflow Automation only after confirming environment and version compatibility.
