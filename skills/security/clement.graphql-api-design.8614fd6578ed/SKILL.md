...
description: "Designs, implements, tests, documents, and operates solutions using Graphql API Design, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Graphql API Design."
---
...
## Activation
- Use when the user explicitly asks for graphql api design.
- Use when a task would materially benefit from the methods, standards, or operating style associated with graphql api design.
...
- Primary capability: Graphql API Design.
- Primary domain: software cloud.
- Use Graphql API Design only after confirming environment and version compatibility.
