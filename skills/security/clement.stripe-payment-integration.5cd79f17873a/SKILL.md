...
description: "Designs, implements, tests, documents, and operates solutions using Stripe Payment Integration, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Stripe Payment Integration."
---
...
## Activation
- Use when the user explicitly asks for stripe payment integration.
- Use when a task would materially benefit from the methods, standards, or operating style associated with stripe payment integration.
...
- Primary capability: Stripe Payment Integration.
- Primary domain: software cloud.
- Use Stripe Payment Integration only after confirming environment and version compatibility.
