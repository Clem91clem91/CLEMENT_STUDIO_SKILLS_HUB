...
description: "Designs, implements, tests, documents, and operates solutions using .NET Development, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving .NET Development."
---
...
## Activation
- Use when the user explicitly asks for .net development.
- Use when a task would materially benefit from the methods, standards, or operating style associated with .net development.
...
- Primary capability: .NET Development.
- Primary domain: software cloud.
- Use .NET Development only after confirming environment and version compatibility.
