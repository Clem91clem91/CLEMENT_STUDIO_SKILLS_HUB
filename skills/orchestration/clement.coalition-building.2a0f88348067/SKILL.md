...
description: "Applies coalition building to prepare interests, alternatives, leverage, packages, concessions, risk controls, and implementable ethical agreements. Use for tasks explicitly involving Coalition Building."
---
...
## Activation
- Use when the user explicitly asks for coalition building.
- Use when a task would materially benefit from the methods, standards, or operating style associated with coalition building.
...
- Primary capability: Coalition Building.
- Primary domain: negotiation deals.
- Apply coalition building as an explicit repeatable protocol.
