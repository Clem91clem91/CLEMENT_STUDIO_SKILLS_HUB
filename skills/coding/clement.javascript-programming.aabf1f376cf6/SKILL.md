...
description: "Designs, implements, tests, documents, and operates solutions using Javascript Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Javascript Programming."
---
...
## Activation
- Use when the user explicitly asks for javascript programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with javascript programming.
...
- Primary capability: Javascript Programming.
- Primary domain: software cloud.
- Use Javascript Programming only after confirming environment and version compatibility.
