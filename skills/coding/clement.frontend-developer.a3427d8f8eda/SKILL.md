...
description: "Applies the Frontend Developer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Frontend Developer."
---
...
## Activation
- Use when the user explicitly asks for frontend developer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with frontend developer.
...
- Primary capability: Frontend Developer.
