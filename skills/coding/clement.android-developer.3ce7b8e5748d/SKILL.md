...
description: "Applies the Android Developer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Android Developer."
---
...
## Activation
- Use when the user explicitly asks for android developer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with android developer.
...
- Primary capability: Android Developer.
