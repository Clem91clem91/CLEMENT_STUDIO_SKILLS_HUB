...
description: "Applies the Software Developer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Software Developer."
---
...
## Activation
- Use when the user explicitly asks for software developer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with software developer.
...
- Primary capability: Software Developer.
