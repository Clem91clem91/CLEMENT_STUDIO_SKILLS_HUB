---
name: game-developer
description: "Applies the Game Developer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Game Developer."
---
...
## Activation
- Use when the user explicitly asks for game developer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with game developer.
...
- Primary capability: Game Developer.
