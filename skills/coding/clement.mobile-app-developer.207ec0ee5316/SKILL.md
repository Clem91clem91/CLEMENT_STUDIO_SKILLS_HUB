...
description: "Applies the Mobile App Developer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Mobile App Developer."
---
...
## Activation
- Use when the user explicitly asks for mobile app developer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with mobile app developer.
...
- Primary capability: Mobile App Developer.
- Primary domain: software cloud.
- Turn requirements into working, tested, documented artifacts.
- Handle errors, edge cases, integration, and deployment.
