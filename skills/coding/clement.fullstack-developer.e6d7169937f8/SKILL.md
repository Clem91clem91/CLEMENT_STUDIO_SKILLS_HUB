...
description: "Applies the Fullstack Developer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving Fullstack Developer."
---
...
## Activation
- Use when the user explicitly asks for fullstack developer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with fullstack developer.
...
- Primary capability: Fullstack Developer.
