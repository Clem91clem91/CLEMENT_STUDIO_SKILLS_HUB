---
name: ios-developer
description: "Applies the iOS Developer professional role to plan, execute, review, and deliver reliable software cloud work with explicit assumptions, controls, and human escalation where required. Use for tasks explicitly involving iOS Developer."
---
...
## Activation
- Use when the user explicitly asks for ios developer.
- Use when a task would materially benefit from the methods, standards, or operating style associated with ios developer.
...
- Primary capability: iOS Developer.
