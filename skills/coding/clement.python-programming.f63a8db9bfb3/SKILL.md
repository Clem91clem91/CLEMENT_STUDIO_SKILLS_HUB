...
description: "Designs, implements, tests, documents, and operates solutions using Python Programming, with reproducibility, security, maintainability, and verification built in. Use for tasks explicitly involving Python Programming."
---
...
## Activation
- Use when the user explicitly asks for python programming.
- Use when a task would materially benefit from the methods, standards, or operating style associated with python programming.
...
- Primary capability: Python Programming.
- Primary domain: software cloud.
- Use Python Programming only after confirming environment and version compatibility.
